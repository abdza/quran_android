...
class WordByWordDatabaseProvider @Inject constructor(
  ...
  private fun ensureRootMeaningsTable(db: androidx.sqlite.db.SupportSQLiteDatabase) {
    try {
      ...
      if (!tableExists) {
        ...
        // Check if we need to update existing data (if new roots were added to seed)
        val countCursor = db.query("SELECT COUNT(*) FROM root_meanings")
  ...
  private fun seedRootMeanings(db: androidx.sqlite.db.SupportSQLiteDatabase) {
    val rootMeanings = listOf(
      ...
      // === FREQUENTLY USED ROOTS (HIGH OCCURRENCE) ===
      RootMeaningData(
        root = "أ-ي-ي",
        primaryMeaning = "sign, verse, miracle, evidence",
        extendedMeaning = "A sign that points to something greater. Can refer to verses of the Quran, miracles, or natural phenomena that indicate Allah's existence.",
        quranUsage = "Ayah (آية) refers to verses of the Quran and also to signs/miracles. 'In the creation of heavens and earth are signs (ayat) for people of understanding.'",
        notes = "Each verse of the Quran is called an 'ayah' because it serves as a sign pointing to truth."
      ),
      RootMeaningData(
        root = "ش-ي-أ",
        primaryMeaning = "thing, matter, will, to want",
        extendedMeaning = "Anything that exists or can be conceived. Also related to willing or wanting something.",
        quranUsage = "Shay' (شيء) means 'thing' - one of the most common words. 'Allah is over all things (shay') capable.' Also mashi'ah (will).",
        notes = "The divine will (mashee'ah) determines all things."
      ),
      RootMeaningData(
        root = "ج-ي-أ",
        primaryMeaning = "to come, to bring, arrival",
        extendedMeaning = "Coming, arriving, or bringing something. Movement towards.",
        quranUsage = "'When the help of Allah comes (ja'a).' Ji'ah is coming. Maji' is arrival or the one who comes.",
        notes = "Often used for the coming of truth, prophets, and the Day of Judgment."
      ),
      RootMeaningData(
        root = "ع-ن-د",
        primaryMeaning = "at, with, near, in the presence of",
        extendedMeaning = "Being in someone's presence or possession. Nearness and proximity.",
        quranUsage = "'Inda Allah' (عند الله) means 'with Allah' or 'in Allah's sight.' 'Whatever is with (inda) you will perish, and what is with Allah will remain.'",
        notes = "Indicates possession, presence, or being in one's custody."
      ),
      RootMeaningData(
        root = "س-و-أ",
        primaryMeaning = "evil, bad, harm, ugliness",
        extendedMeaning = "What is evil, harmful, or ugly. The opposite of good (husn).",
        quranUsage = "Su' (سوء) is evil or harm. Sayyi'ah is a bad deed. 'Whoever does evil (su') will be recompensed for it.'",
        notes = "Contrasts with hasanah (good deed)."
      ),
      RootMeaningData(
        root = "ن-ب-أ",
        primaryMeaning = "news, tidings, to inform",
        extendedMeaning = "Important news or information, especially of significant matters.",
        quranUsage = "Naba' (نبأ) is important news. Anba' are tidings. 'We relate to you the news (naba') of Musa and Fir'awn.' Nabiy (prophet) is 'one who brings news.'",
        notes = "Prophet (nabiy) derives from this root - one who delivers divine news."
      ),
      RootMeaningData(
        root = "ر-و-د",
        primaryMeaning = "to go back and forth, seek, desire",
        extendedMeaning = "Moving to and fro, seeking something, or having a desire for something.",
        quranUsage = "Rawada means to seek or desire. 'She sought to seduce him (rawadathu).' Murad is what is desired or sought.",
        notes = "Iradah (will/intention) is related to this root."
      ),
      RootMeaningData(
        root = "د-و-ن",
        primaryMeaning = "below, without, other than, inferior",
        extendedMeaning = "What is below, beneath, or other than something. Also means to record.",
        quranUsage = "'They took gods other than (min duni) Allah.' Dun indicates inferiority or being besides/other than.",
        notes = "Diwan (register/record) derives from this root."
      ),
      RootMeaningData(
        root = "د-ن-و",
        primaryMeaning = "near, close, lowly, world",
        extendedMeaning = "Nearness in distance or time. Also lowliness. The world (dunya) is 'near' compared to the afterlife.",
        quranUsage = "Dunya (الدنيا) means 'the nearer life' - this world. Adna means nearer or lower. 'The near (adna) heaven we adorned with stars.'",
        notes = "This world is called 'dunya' because it is nearer (in time) than the akhirah."
      ),
      RootMeaningData(
        root = "ي-د-ي",
        primaryMeaning = "hand, power, possession",
        extendedMeaning = "Hand, both literal and metaphorical (power, control, possession).",
        quranUsage = "Yad (يد) is hand. 'The hand (yad) of Allah is over their hands.' Yadayn is two hands. Aydi is hands (plural).",
        notes = "Hand symbolizes power, action, and blessing in Arabic."
      ),
      RootMeaningData(
        root = "ل-ي-س",
        primaryMeaning = "not to be, is not",
        extendedMeaning = "Negation of existence or a state. To not be something.",
        quranUsage = "Laysa (ليس) is the verb of negation. 'There is nothing (laysa) like Him.' 'Is not (alaysa) Allah the wisest of judges?'",
        notes = "One of the essential negation words in Arabic."
      ),
      RootMeaningData(
        root = "أ-ح-د",
        primaryMeaning = "one, unique, someone",
        extendedMeaning = "Oneness, uniqueness, individuality. Also means 'anyone' or 'someone.'",
        quranUsage = "Ahad (أحد) is 'One' - Allah's unique oneness. 'Say: He is Allah, the One (Ahad).' Also 'la ahad' means no one.",
        notes = "Ahad emphasizes absolute uniqueness, different from wahid (numerical one)."
      ),
      RootMeaningData(
        root = "ك-ي-ف",
        primaryMeaning = "how, in what manner, condition",
        extendedMeaning = "Asking about manner, method, or condition of something.",
        quranUsage = "Kayfa (كيف) means 'how.' 'How (kayfa) can you disbelieve?' Kayfiyyah is quality or manner.",
        notes = "Used rhetorically to express amazement or rebuke."
      ),
      RootMeaningData(
        root = "ب-ل-غ",
        primaryMeaning = "to reach, convey, attain, mature",
        extendedMeaning = "Reaching a destination, conveying a message, or attaining maturity.",
        quranUsage = "Baligh means reaching. 'When they reach (balaghu) maturity.' Tabligh is conveying the message. Balagh is proclamation.",
        notes = "The Prophet's duty was tabligh - conveying the message."
      ),
      RootMeaningData(
        root = "ب-أ-س",
        primaryMeaning = "strength, distress, severity, courage",
        extendedMeaning = "Military strength, hardship, or severity. Also courage in battle.",
        quranUsage = "Ba's (بأس) is might or punishment. 'Our ba's (punishment) came upon them.' Basir is brave. 'They have no ba's (power).'",
        notes = "Often refers to Allah's severe punishment or military might."
      ),
      RootMeaningData(
        root = "ر-ض-و",
        primaryMeaning = "pleasure, satisfaction, acceptance",
        extendedMeaning = "Being pleased, satisfied, or content with something.",
        quranUsage = "Ridwan (رضوان) is Allah's pleasure/acceptance. 'Allah is pleased (radiya) with them and they with Him.' Rida is contentment.",
        notes = "Seeking Allah's ridwan is the highest goal."
      ),
      RootMeaningData(
        root = "ج-ر-م",
        primaryMeaning = "sin, crime, to cut off",
        extendedMeaning = "Committing a crime or sin. Originally meant cutting something off.",
        quranUsage = "Mujrim is criminal/sinner. 'The mujrimun (criminals) will be in punishment.' Jurm is crime.",
        notes = "Ijram is criminality, cutting oneself off from good."
      ),
      RootMeaningData(
        root = "س-ح-ر",
        primaryMeaning = "magic, sorcery, early morning",
        extendedMeaning = "Magic, sorcery, or the time before dawn (sahar).",
        quranUsage = "Sihr (سحر) is magic. 'They followed what the devils recited of magic (sihr).' Sahir is magician. Sahar is pre-dawn.",
        notes = "Magic is forbidden; Musa's staff defeated the magicians' sihr."
      ),
      RootMeaningData(
        root = "ع-و-د",
        primaryMeaning = "to return, repeat, custom",
        extendedMeaning = "Returning, going back, or repeating. Also habit or custom.",
        quranUsage = "'Aud means return. 'Then if they return (adu).' 'Adah is habit/custom. Ma'ad is the place of return (afterlife).",
        notes = "Al-Ma'ad is one of the names for the Day of Judgment."
      ),
      RootMeaningData(
        root = "ف-ر-ي",
        primaryMeaning = "to fabricate, invent, create",
        extendedMeaning = "Creating something new, fabricating, or inventing (often falsehood).",
        quranUsage = "Iftira' is fabrication/lying. 'Who fabricates (iftara) lies against Allah.' Also faray - to create or originate.",
        notes = "Often used for fabricating lies against Allah."
      ),
      RootMeaningData(
        root = "ر-د-د",
        primaryMeaning = "to return, reply, reject",
        extendedMeaning = "Returning something, replying, or rejecting.",
        quranUsage = "Radda means to return or reject. 'Return (ruddu) it to Allah and the Messenger.' Radd is reply/refutation.",
        notes = "Murtadd is one who returns from Islam (apostate)."
      ),
      RootMeaningData(
        root = "ن-س-و",
        primaryMeaning = "to forget, women",
        extendedMeaning = "Forgetting something. Also the word for women (nisa').",
        quranUsage = "Nasiya means to forget. 'They forgot Allah, so He forgot them.' Nisa' (نساء) means women.",
        notes = "Some say women are called nisa' because people forget their troubles with them."
      ),
      RootMeaningData(
        root = "ق-ر-ي",
        primaryMeaning = "village, town, to receive guests",
        extendedMeaning = "A settlement or town. Also hospitality and receiving guests.",
        quranUsage = "Qaryah (قرية) is village/town. 'Ask the town (qaryah) we were in.' Qura is villages (plural).",
        notes = "Umm al-Qura (Mother of Towns) is Makkah."
      ),
      RootMeaningData(
        root = "أ-ج-ل",
        primaryMeaning = "term, appointed time, deadline",
        extendedMeaning = "A fixed term or appointed time, especially for death.",
        quranUsage = "Ajal (أجل) is appointed term. 'Every ummah has an ajal.' 'When their ajal comes, they cannot delay it.'",
        notes = "Everyone has a fixed ajal (time of death) known only to Allah."
      ),
      RootMeaningData(
        root = "خ-ب-ر",
        primaryMeaning = "news, experience, to know",
        extendedMeaning = "News, information, or having knowledge/experience of something.",
        quranUsage = "Khabir (خبير) is the All-Aware - Allah's name. Khabar is news. 'Allah is Khabir (fully aware) of what you do.'",
        notes = "Al-Khabir knows the inner reality of all things."
      ),
      RootMeaningData(
        root = "أ-ث-م",
        primaryMeaning = "sin, guilt, wrongdoing",
        extendedMeaning = "Sin that brings guilt or punishment. A transgression.",
        quranUsage = "Ithm (إثم) is sin. 'Avoid much ithm.' Athim is sinful. 'In them is great ithm and some benefit.'",
        notes = "Often paired with 'udwan (transgression)."
      ),
      RootMeaningData(
        root = "خ-ش-ي",
        primaryMeaning = "to fear, be in awe, reverence",
        extendedMeaning = "Fear mixed with reverence and respect, especially fear of Allah.",
        quranUsage = "Khashyah (خشية) is reverential fear. 'Only those who have knowledge truly fear (yakhsha) Allah.' Khashi' is humble/fearful.",
        notes = "Khashyah is higher than khawf - it includes knowledge and reverence."
      ),
      RootMeaningData(
        root = "ك-ر-م",
        primaryMeaning = "noble, generous, honor",
        extendedMeaning = "Nobility, generosity, and honor. Being precious and valuable.",
        quranUsage = "Karim (كريم) is noble/generous. 'This is a noble (karim) Quran.' Al-Karim is Allah's name. Ikram is honoring.",
        notes = "The Quran is described as Karim (noble)."
      ),
      RootMeaningData(
        root = "و-ذ-ر",
        primaryMeaning = "to leave, let alone, warn",
        extendedMeaning = "Leaving something, letting alone, or warning against.",
        quranUsage = "Dhar means to leave. 'Leave (dhar) them to eat and enjoy.' Nadhir is warner. Indhaar is warning.",
        notes = "The Prophet was a nadhir (warner) to his people."
      ),
      RootMeaningData(
        root = "ي-س-ر",
        primaryMeaning = "easy, prosperity, left side",
        extendedMeaning = "Ease, facility, and prosperity. Also the left side.",
        quranUsage = "Yusr (يسر) is ease. 'With hardship comes ease (yusr).' Taysir is facilitation. Maysur is easy.",
        notes = "Islam is described as the religion of yusr (ease)."
      ),
      RootMeaningData(
        root = "ص-د-د",
        primaryMeaning = "to turn away, prevent, obstruct",
        extendedMeaning = "Turning away from something or preventing others.",
        quranUsage = "Sadda means to obstruct. 'They prevent (yasudduun) from the path of Allah.' Suduud is turning away.",
        notes = "A major sin is preventing people from Allah's path."
      ),
      RootMeaningData(
        root = "م-ل-أ",
        primaryMeaning = "to fill, assembly, chiefs",
        extendedMeaning = "Filling something, or an assembly of chiefs/leaders.",
        quranUsage = "Mala' (ملأ) is the assembly of leaders/chiefs. 'The mala' of his people said.' Mal'a also means to fill.",
        notes = "Mala' often refers to the arrogant elite who opposed prophets."
      ),
      RootMeaningData(
        root = "ط-غ-ي",
        primaryMeaning = "to transgress, exceed limits, rebel",
        extendedMeaning = "Exceeding proper limits, transgression, and rebellion against Allah.",
        quranUsage = "Taghut (طاغوت) is false deity/tyrant. Tughyan is transgression. 'Fir'awn transgressed (tagha).'",
        notes = "Taghut refers to anything worshipped besides Allah."
      ),
      RootMeaningData(
        root = "م-ر-أ",
        primaryMeaning = "man, person, to be wholesome",
        extendedMeaning = "A man or person. Also wholesomeness and being beneficial.",
        quranUsage = "Imra' (امرؤ) is a man/person. 'Every person (imri') for what he earned.' Mar'ah is woman.",
        notes = "Imru'ul-Qays was a famous pre-Islamic poet."
      ),
      RootMeaningData(
        root = "ه-و-ي",
        primaryMeaning = "desire, passion, to fall",
        extendedMeaning = "Vain desire, passion, or falling from a height.",
        quranUsage = "Hawa (هوى) is vain desire. 'Do not follow hawa (vain desires).' Hawa also means to fall/descend.",
        notes = "Following hawa leads astray from Allah's path."
      ),
      RootMeaningData(
        root = "أ-ل-و",
        primaryMeaning = "to fall short, withhold, oath",
        extendedMeaning = "Falling short in effort or withholding something.",
        quranUsage = "'They will not fall short (ya'luuna) in corrupting you.' Also related to ilah (deity).",
        notes = null
      ),
      RootMeaningData(
        root = "أ-و-ي",
        primaryMeaning = "to shelter, take refuge, return",
        extendedMeaning = "Taking shelter or refuge, returning to a place.",
        quranUsage = "Awa means to shelter. 'When the youths took refuge (awaw) in the cave.' Ma'wa is shelter/abode.",
        notes = "Jannatul-Ma'wa is one of the names of Paradise."
      ),
      RootMeaningData(
        root = "ك-ي-د",
        primaryMeaning = "plot, scheme, stratagem",
        extendedMeaning = "Planning or scheming, often with negative connotation.",
        quranUsage = "Kayd (كيد) is plot/scheme. 'Their kayd (plot) will go astray.' 'Surely My kayd is firm.'",
        notes = "Allah's kayd against plotters is just retribution."
      ),
      RootMeaningData(
        root = "ج-ن-ح",
        primaryMeaning = "to incline, wing, side",
        extendedMeaning = "Inclining toward something. Also wing or flank.",
        quranUsage = "Janah (جناح) is wing. 'Lower your wing (janah) to the believers.' Junah is sin/harm.",
        notes = "Lowering the wing symbolizes humility and kindness."
      ),
      RootMeaningData(
        root = "ه-ز-أ",
        primaryMeaning = "to mock, ridicule, jest",
        extendedMeaning = "Mocking, ridiculing, or treating something as a joke.",
        quranUsage = "Istahza'a is to mock. 'They mocked (yastahzi'uun) the messengers.' Huzuw is mockery.",
        notes = "Mocking religion or prophets is a grave sin."
      ),
      RootMeaningData(
        root = "و-ث-ق",
        primaryMeaning = "trust, covenant, bond",
        extendedMeaning = "Trust, firm bond, or covenant. Being reliable and trustworthy.",
        quranUsage = "Mithaq (ميثاق) is covenant. 'We took their mithaq (covenant).' Wathiq is firm/trustworthy.",
        notes = "Allah took covenants from the prophets and believers."
      ),
      RootMeaningData(
        root = "ج-ن-ب",
        primaryMeaning = "side, to avoid, foreign",
        extendedMeaning = "The side of something, or avoiding and staying away.",
        quranUsage = "Janb (جنب) is side. 'What my hands have sent forth for Allah's side.' Ijtinab is avoiding. Junub is in state of impurity.",
        notes = "Junub requires ghusl (ritual bath) before prayer."
      ),
      RootMeaningData(
        root = "ع-ر-ش",
        primaryMeaning = "throne, canopy, trellis",
        extendedMeaning = "Throne, elevated structure, or canopy.",
        quranUsage = "'Arsh (عرش) is the Throne. 'The Most Merciful rose over the Throne ('Arsh).' Also trellises for grapes.",
        notes = "Allah's 'Arsh is the greatest of creations."
      ),
      RootMeaningData(
        root = "ن-ص-ب",
        primaryMeaning = "to set up, toil, idol",
        extendedMeaning = "Setting something upright, toil and fatigue, or an idol.",
        quranUsage = "Nasab (نصب) is toil/fatigue. Nusub are idols. 'Forbidden is what is slaughtered on nusub (altar stones).'",
        notes = "Pre-Islamic Arabs sacrificed on stone altars."
      ),
      RootMeaningData(
        root = "ب-د-و",
        primaryMeaning = "to appear, become clear, desert",
        extendedMeaning = "Appearing, becoming manifest. Also desert and Bedouin life.",
        quranUsage = "Bada means to appear. 'There appeared (bada) to them the evil of what they did.' Badw are desert dwellers.",
        notes = "Badawah is Bedouin/nomadic life."
      ),
      RootMeaningData(
        root = "ب-ر-أ",
        primaryMeaning = "to create, be free from, innocent",
        extendedMeaning = "Creating from nothing, or being free/innocent of something.",
        quranUsage = "Bari' (بارئ) is the Creator - Allah's name. Bara'ah is innocence. 'I am free (bari') of what you associate.'",
        notes = "Al-Bari' creates things from nothing."
      ),
      RootMeaningData(
        root = "ح-ي-ث",
        primaryMeaning = "where, wherever, place",
        extendedMeaning = "Refers to place, location, or whereabouts.",
        quranUsage = "Haythu (حيث) means 'where.' 'Enter the gate wherever (haythu) you wish.' Min haythu means 'from where.'",
        notes = "Common locative particle in Arabic."
      ),
      RootMeaningData(
        root = "خ-ل-ص",
        primaryMeaning = "pure, sincere, to be free",
        extendedMeaning = "Purity, sincerity, and being free from impurities or attachments.",
        quranUsage = "Ikhlas (إخلاص) is sincerity. 'Worship Allah with ikhlas (sincere devotion).' Mukhlis is sincere. Khalas is pure.",
        notes = "Surah Al-Ikhlas emphasizes pure monotheism."
      ),
      RootMeaningData(
        root = "ل-ب-ث",
        primaryMeaning = "to stay, remain, tarry",
        extendedMeaning = "Staying, remaining, or lingering in a place for a period.",
        quranUsage = "Labitha means to remain. 'How long did you stay (labithtum)?' Lubth is duration of stay.",
        notes = "Often used asking about duration in the grave or afterlife."
      ),
      RootMeaningData(
        root = "أ-ف-ك",
        primaryMeaning = "to lie, turn away, slander",
        extendedMeaning = "Turning something from its proper direction, lying, or slandering.",
        quranUsage = "Ifk (إفك) is a great lie/slander. 'Those who brought the ifk (slander).' Mu'tafik are those turned away from truth.",
        notes = "The ifk incident refers to the slander against Aisha."
      ),
      RootMeaningData(
        root = "ص-ر-ف",
        primaryMeaning = "to turn, divert, spend",
        extendedMeaning = "Turning away, diverting, or spending/using something.",
        quranUsage = "Sarafa means to turn. 'We turn away (nasrifu) the ayat.' Tasrif is directing/explaining repeatedly.",
        notes = "Sarf also means morphology - changing word forms."
      ),
      RootMeaningData(
        root = "ع-س-ي",
        primaryMeaning = "perhaps, maybe, to be hard",
        extendedMeaning = "Expressing possibility or hope. Also hardness or difficulty.",
        quranUsage = "'Asa (عسى) means 'perhaps/maybe.' ''Asa that you dislike something and it is good for you.'",
        notes = "When Allah says 'asa,' it indicates certainty of occurrence."
      ),
      RootMeaningData(
        root = "ه-و-د",
        primaryMeaning = "to be Jewish, to repent, guide",
        extendedMeaning = "Being Jewish, or returning/repenting to Allah.",
        quranUsage = "Yahud (يهود) are Jews. Hud is a prophet's name. 'We have repented (hudna) to You.'",
        notes = "Prophet Hud was sent to the people of 'Ad."
      ),
      RootMeaningData(
        root = "ج-د-ل",
        primaryMeaning = "to argue, dispute, debate",
        extendedMeaning = "Argumentation, disputation, and debate.",
        quranUsage = "Jidal (جدال) is argumentation. 'Argue (jadilhum) with them in the best way.' Mujadalah is debate.",
        notes = "Arguing with good manners is permitted for dawah."
      ),
      RootMeaningData(
        root = "ص-ي-ر",
        primaryMeaning = "to become, end up, destination",
        extendedMeaning = "Becoming something, ending up somewhere, final destination.",
        quranUsage = "Sara/yasiru means to become. Masir (مصير) is destination/fate. 'To Allah is the masir (final return).'",
        notes = "Everyone's masir is ultimately to Allah."
      ),
      RootMeaningData(
        root = "غ-ش-و",
        primaryMeaning = "to cover, overwhelm, envelope",
        extendedMeaning = "Covering or enveloping something completely.",
        quranUsage = "Ghashiya means to cover/overwhelm. 'Al-Ghashiyah' is the Overwhelming (Day of Judgment). Ghishawah is a covering.",
        notes = "Surah Al-Ghashiyah describes the overwhelming Day."
      ),
      RootMeaningData(
        root = "ح-و-ط",
        primaryMeaning = "to surround, guard, encompass",
        extendedMeaning = "Surrounding, guarding, or encompassing something.",
        quranUsage = "Ahata means to encompass. 'Allah encompasses (muhit) all things.' Muhit is surrounding.",
        notes = "Allah's knowledge encompasses everything."
      ),
      RootMeaningData(
        root = "خ-ل-و",
        primaryMeaning = "to be empty, alone, pass away",
        extendedMeaning = "Being empty, alone, or past generations that have passed.",
        quranUsage = "Khala means to pass/be alone. 'Nations that have passed (khalat) before.' Khalwah is seclusion.",
        notes = "Past nations serve as warnings for current ones."
      ),
      RootMeaningData(
        root = "ن-ش-أ",
        primaryMeaning = "to grow, originate, create",
        extendedMeaning = "Growing, originating, or bringing something into existence.",
        quranUsage = "Ansha'a means to originate/create. 'We originated (ansha'na) them as a creation.' Nash'ah is growth.",
        notes = "Al-Munshi' is one who originates creation."
      ),
      RootMeaningData(
        root = "م-د-ن",
        primaryMeaning = "city, civilization",
        extendedMeaning = "City or urban settlement. Also civilization.",
        quranUsage = "Madinah (مدينة) is city. 'The people of the Madinah.' Al-Madinah refers to the Prophet's city.",
        notes = "Madinah was called Yathrib before the Prophet's migration."
      ),
      RootMeaningData(
        root = "م-س-ك",
        primaryMeaning = "to hold, grasp, withhold",
        extendedMeaning = "Holding firmly, grasping, or withholding.",
        quranUsage = "Amsaka means to hold/withhold. 'Hold (amsik) your wife.' Mustamsik is one who holds firmly.",
        notes = "Holding firmly to the Quran is commanded."
      ),
      RootMeaningData(
        root = "ج-ح-م",
        primaryMeaning = "blazing fire, Hell",
        extendedMeaning = "Intensely blazing fire, one of the names of Hell.",
        quranUsage = "Jahim (جحيم) is blazing Hellfire. 'Surely the Jahim is lying in wait.' One of Hell's names.",
        notes = "Jahim describes the intense blazing of Hell's fire."
      ),
      RootMeaningData(
        root = "خ-ز-ي",
        primaryMeaning = "disgrace, humiliation, shame",
        extendedMeaning = "Disgrace, humiliation, and shame.",
        quranUsage = "Khizyi (خزي) is disgrace. 'They will have disgrace (khizy) in this world.' Akhza is to disgrace.",
        notes = "Disbelievers face khizy in both worlds."
      ),
      RootMeaningData(
        root = "ه-و-ن",
        primaryMeaning = "easy, light, humiliation",
        extendedMeaning = "Being easy or light. Also humiliation and disgrace.",
        quranUsage = "Hawn is ease/humiliation. 'Walk with humility (hawnan).' Muhaanat is contempt.",
        notes = "Walking with hawn means calmly, without arrogance."
      ),
      RootMeaningData(
        root = "أ-د-م",
        primaryMeaning = "Adam, skin, brown",
        extendedMeaning = "Adam (first human), skin, or brownish color.",
        quranUsage = "Adam (آدم) is the first human. 'We created Adam.' Adim is skin/surface.",
        notes = "Adam is called so possibly due to his brown earth origin."
      ),
      RootMeaningData(
        root = "و-ع-ظ",
        primaryMeaning = "to admonish, advise, preach",
        extendedMeaning = "Admonishing, giving advice, or preaching.",
        quranUsage = "Wa'z (وعظ) is admonition. 'Admonish (i'z) them.' Maw'izah is good advice/sermon.",
        notes = "The Quran is called a maw'izah for mankind."
      ),
      RootMeaningData(
        root = "و-ه-ب",
        primaryMeaning = "to grant, bestow, gift",
        extendedMeaning = "Granting or bestowing something as a gift without exchange.",
        quranUsage = "Al-Wahhab (الوهاب) is the Bestower - Allah's name. 'Grant us (hab lana) from You mercy.' Hibah is gift.",
        notes = "Allah grants without expecting anything in return."
      ),
      RootMeaningData(
        root = "ذ-ل-ل",
        primaryMeaning = "humility, lowliness, ease",
        extendedMeaning = "Humility, being low, or being made easy and manageable.",
        quranUsage = "Dhull (ذل) is humility/lowliness. 'Lower (dhull) your wing to believers.' Mudhalal is made easy.",
        notes = "Dhull before Allah is praiseworthy; before others is blame."
      ),
      RootMeaningData(
        root = "ر-ق-ب",
        primaryMeaning = "to watch, observe, neck, slave",
        extendedMeaning = "Watching, observing. Also neck, and by extension, freeing slaves.",
        quranUsage = "Raqib (رقيب) is the Watchful - Allah's name. Raqabah is freeing a slave (neck). 'Allah is Raqib over you.'",
        notes = "Freeing raqabah (slave) is expiation for sins."
      ),
      RootMeaningData(
        root = "و-ق-ع",
        primaryMeaning = "to fall, occur, happen",
        extendedMeaning = "Falling, occurring, or happening.",
        quranUsage = "Waqa'a means to occur/fall. 'When the Event (waqi'ah) occurs.' Waqi' is happening/reality.",
        notes = "Al-Waqi'ah (The Event) is a name for Day of Judgment."
      ),
      RootMeaningData(
        root = "س-ر-ف",
        primaryMeaning = "excess, extravagance, waste",
        extendedMeaning = "Exceeding proper limits, extravagance, and wastefulness.",
        quranUsage = "Israf (إسراف) is extravagance. 'Do not be extravagant (musrifin).' Musrif is wasteful person.",
        notes = "Allah does not love the musrifin (wasteful)."
      ),
      RootMeaningData(
        root = "خ-ط-أ",
        primaryMeaning = "error, mistake, sin",
        extendedMeaning = "Making a mistake, erring, or sinning.",
        quranUsage = "Khata' (خطأ) is mistake/sin. Khati'ah is a sin. 'Do not kill your children - that is a great khit' (sin).'",
        notes = "Khata' can be unintentional; khatee'ah is more deliberate."
      ),
      RootMeaningData(
        root = "ع-ر-ب",
        primaryMeaning = "Arab, Arabic, clear",
        extendedMeaning = "Arab people, Arabic language, or being clear and eloquent.",
        quranUsage = "Arabi (عربي) means Arabic. 'A Quran in Arabic (Arabiyyan).' A'rab are Bedouin Arabs.",
        notes = "Arabic was chosen for the Quran's clear expression."
      ),
      RootMeaningData(
        root = "م-ن-ي",
        primaryMeaning = "to wish, desire, sperm",
        extendedMeaning = "Wishing, desiring, or reproductive fluid.",
        quranUsage = "Taman means to wish. Umniyah is wish/desire. Maniy is sperm. 'From a drop of maniy (sperm) emitted.'",
        notes = "Amaniy (wishes) without action lead nowhere."
      ),
      RootMeaningData(
        root = "أ-ث-ر",
        primaryMeaning = "trace, effect, to prefer",
        extendedMeaning = "A trace, mark, or effect. Also preferring something.",
        quranUsage = "Athar (أثر) is trace/effect. 'Follow the traces (athar) of Allah's mercy.' Ithaar is preferring others.",
        notes = "The Ansar showed ithaar (preferring others over themselves)."
      ),
      RootMeaningData(
        root = "ح-ذ-ر",
        primaryMeaning = "to beware, caution, guard",
        extendedMeaning = "Being cautious, taking precautions, and guarding against.",
        quranUsage = "Hadhira means to beware. 'Beware (uhdhar) of them.' Hidhr is caution.",
        notes = "Taking precautions is wisdom, not lack of trust."
      ),
      RootMeaningData(
        root = "ف-ت-ي",
        primaryMeaning = "youth, young man, to give ruling",
        extendedMeaning = "Youth, young man, or giving a legal ruling (fatwa).",
        quranUsage = "Fata (فتى) is young man. 'The youths (fityah) believed.' Fatwa is legal ruling. Mufti gives fatwa.",
        notes = "The people of the cave were youths who believed."
      ),
      RootMeaningData(
        root = "ك-ت-م",
        primaryMeaning = "to conceal, hide, suppress",
        extendedMeaning = "Concealing, hiding, or suppressing something.",
        quranUsage = "Katama means to conceal. 'Do not conceal (taktumu) testimony.' Kitman is concealment.",
        notes = "Concealing knowledge is condemned."
      ),
      RootMeaningData(
        root = "د-ر-ج",
        primaryMeaning = "degree, rank, step",
        extendedMeaning = "Degrees, ranks, or gradual steps.",
        quranUsage = "Darajah (درجة) is degree/rank. 'They have degrees (darajat) with Allah.' Tadarruj is gradual progression.",
        notes = "People have different darajat based on their deeds."
      ),
      RootMeaningData(
        root = "س-ن-و",
        primaryMeaning = "year, age",
        extendedMeaning = "Year, or a long period of time.",
        quranUsage = "Sanah (سنة) is year. Sinin is years. 'We punished them with years (sinin) of famine.'",
        notes = "Sanah is year; 'am is also year but more general."
      ),
      RootMeaningData(
        root = "ل-ع-ب",
        primaryMeaning = "play, sport, jest",
        extendedMeaning = "Playing, sporting, or treating something as a jest.",
        quranUsage = "La'ib is play/sport. 'This worldly life is but play (la'ib) and amusement.' La'ib contrasts with serious matters.",
        notes = "Life should not be taken merely as play."
      ),
      RootMeaningData(
        root = "م-ر-ي",
        primaryMeaning = "doubt, dispute, to pass by",
        extendedMeaning = "Doubt, disputation, or passing by something.",
        quranUsage = "Miryah (مرية) is doubt. 'Do not be in doubt (miryah) about it.' Marra means to pass by.",
        notes = "No miryah should exist about meeting Allah."
      ),
      RootMeaningData(
        root = "س-و-ع",
        primaryMeaning = "hour, moment",
        extendedMeaning = "An hour, moment, or a short period of time.",
        quranUsage = "Sa'ah (ساعة) is hour/moment. Al-Sa'ah is the Hour (Day of Judgment). 'The Sa'ah is coming.'",
        notes = "The exact time of Al-Sa'ah is known only to Allah."
      ),
      RootMeaningData(
        root = "م-و-ه",
        primaryMeaning = "water",
        extendedMeaning = "Water, the essential element of life.",
        quranUsage = "Ma' (ماء) is water. 'We made from water every living thing.' Related to م-ء-ء.",
        notes = "Variant root form for water."
      ),
      RootMeaningData(
        root = "ك-و-د",
        primaryMeaning = "to almost, nearly",
        extendedMeaning = "Being on the verge of, almost doing something.",
        quranUsage = "Kada/yakadu means 'almost.' 'They almost (yakadu) cannot see.' Related to ك-ي-د.",
        notes = null
      ),
      RootMeaningData(
        root = "ق-ر-أ",
        primaryMeaning = "to read, recite",
        extendedMeaning = "Reading, reciting. Variant spelling of ق-ر-ء.",
        quranUsage = "Qara'a means to read/recite. 'Read (iqra') in the name of your Lord.' Quran means 'the recitation.'",
        notes = "The first revelation began with 'Iqra' (Read!)."
      ),
      RootMeaningData(
        root = "و-ر-ي",
        primaryMeaning = "behind, to hide, kindle fire",
        extendedMeaning = "What is behind, hidden, or kindling fire.",
        quranUsage = "Wara' (وراء) means behind. 'From behind (wara'i) a wall.' Also fire kindling.",
        notes = null
      ),
      RootMeaningData(
        root = "ب-ل-د",
        primaryMeaning = "country, land, town",
        extendedMeaning = "A country, land, or town.",
        quranUsage = "Balad (بلد) is country/town. 'This is a secure balad (town).' Bilad is countries.",
        notes = "Al-Balad is Surah 90, referring to Makkah."
      ),
      RootMeaningData(
        root = "س-ع-ر",
        primaryMeaning = "blaze, fire, hell, price",
        extendedMeaning = "Blazing fire, one of the names of Hell. Also price.",
        quranUsage = "Sa'ir (سعير) is blazing fire - a name of Hell. 'They will be in the Sa'ir.' Su'r is price/rate.",
        notes = "Sa'ir emphasizes the blazing intensity of Hell."
      ),
      RootMeaningData(
        root = "ف-ك-ه",
        primaryMeaning = "fruit, to enjoy",
        extendedMeaning = "Fruit, or enjoying and delighting in something.",
        quranUsage = "Fakihah (فاكهة) is fruit. 'Fruits (fawakihu) of what they desire.' Fakihin is enjoying.",
        notes = "Paradise has abundant fruits."
      ),
      RootMeaningData(
        root = "ح-ص-ن",
        primaryMeaning = "fortress, chaste, protect",
        extendedMeaning = "Fortress, being chaste, or protection.",
        quranUsage = "Husn is fortress. Muhsanah is chaste woman. 'Protected (muhsanat) women.' Hisn is fortress.",
        notes = "Ihsan also relates to fortifying oneself with marriage."
      ),
      RootMeaningData(
        root = "خ-ص-م",
        primaryMeaning = "opponent, dispute, argue",
        extendedMeaning = "Opponent, disputing, or arguing.",
        quranUsage = "Khasm (خصم) is opponent/disputant. 'Has the story of the disputants (khasim) reached you?'",
        notes = "Referring to angels who visited Prophet Dawud."
      ),
      RootMeaningData(
        root = "ر-أ-س",
        primaryMeaning = "head, chief, top",
        extendedMeaning = "Head, chief, or top of something.",
        quranUsage = "Ra's (رأس) is head. 'You will have your ra's (principal) of your wealth.' Also top/chief.",
        notes = "Ra's al-mal is principal/capital in finance."
      ),
      RootMeaningData(
        root = "ل-د-ن",
        primaryMeaning = "near, at, from",
        extendedMeaning = "Nearness, being at or from someone's presence.",
        quranUsage = "Ladun (لدن) means 'at/from.' 'A mercy from Us (min ladunna).' Indicates direct presence.",
        notes = "'Ilm ladunni is knowledge directly from Allah."
      ),
      RootMeaningData(
        root = "م-ل-ل",
        primaryMeaning = "religion, creed, to dictate",
        extendedMeaning = "Religion, creed, or way. Also to dictate.",
        quranUsage = "Millah (ملة) is religion/creed. 'The millah (religion) of Ibrahim.' Imlal is dictation.",
        notes = "Millah Ibrahim is the pure monotheistic religion."
      ),
      RootMeaningData(
        root = "ن-ف-ر",
        primaryMeaning = "to flee, march forth, aversion",
        extendedMeaning = "Fleeing, marching forth, or having aversion.",
        quranUsage = "Nafara means to flee/march. 'March forth (infiru) light or heavy.' Nafar is group of people.",
        notes = "Believers should march forth in Allah's cause."
      ),
      RootMeaningData(
        root = "ن-و-ب",
        primaryMeaning = "to turn, repent, substitute",
        extendedMeaning = "Turning, repentance, or taking turns.",
        quranUsage = "Anaba means to turn (to Allah). 'Turn (anibu) to your Lord.' Munib is one who turns back.",
        notes = "Related to tawbah but emphasizes returning fully."
      ),
      RootMeaningData(
        root = "أ-و-ب",
        primaryMeaning = "to return, repent",
        extendedMeaning = "Returning, going back, especially repentance.",
        quranUsage = "Awwab (أواب) is frequently returning. 'Indeed he was awwab (oft-returning).' Describes prophets.",
        notes = "Prophet Dawud and Sulayman were called awwab."
      ),
      RootMeaningData(
        root = "ب-و-أ",
        primaryMeaning = "to settle, prepare place, return",
        extendedMeaning = "Settling in a place, preparing a place, or returning with something.",
        quranUsage = "Tabawwa'a means to settle. 'We settled (bawwa'na) Ibrahim at the House.' Ba'a is to return (often with sin).",
        notes = null
      ),
      RootMeaningData(
        root = "ر-ب-ص",
        primaryMeaning = "to wait, watch, lie in wait",
        extendedMeaning = "Waiting, watching, or lying in wait.",
        quranUsage = "Tarabbasa means to wait. 'Wait (tarabbasu), indeed we are waiting.' Mutarabbis waits.",
        notes = "Used for both patient waiting and lying in ambush."
      ),
      RootMeaningData(
        root = "ز-ع-م",
        primaryMeaning = "to claim, assert, think",
        extendedMeaning = "Claiming, asserting, or thinking something to be true.",
        quranUsage = "Za'ama means to claim. 'They claim (yaz'umun) they believe.' Za'm is claim (often false).",
        notes = "Often used for false or unsubstantiated claims."
      ),
      RootMeaningData(
        root = "س-و-ق",
        primaryMeaning = "to drive, leg, market",
        extendedMeaning = "Driving forward, leg, or marketplace.",
        quranUsage = "Saqa means to drive. 'We drive (suqna) it to a dead land.' Saq is leg. Suq is market.",
        notes = "Clouds are 'driven' to bring rain."
      ),
      RootMeaningData(
        root = "ع-و-ذ",
        primaryMeaning = "to seek refuge, shelter",
        extendedMeaning = "Seeking refuge, protection, or shelter.",
        quranUsage = "'Audhu billah means 'I seek refuge in Allah.' A'udhu is seeking protection. Ma'adh is refuge.",
        notes = "Seeking refuge in Allah is the ultimate protection."
      ),
      RootMeaningData(
        root = "ن-ق-م",
        primaryMeaning = "to take revenge, punish",
        extendedMeaning = "Taking revenge, punishing, or avenging.",
        quranUsage = "Intaqama means to take revenge. 'We took vengeance (intaqamna) from them.' Niqmah is retribution.",
        notes = "Allah's punishment is just retribution."
      ),
      RootMeaningData(
        root = "ح-ب-ط",
        primaryMeaning = "to be in vain, nullify",
        extendedMeaning = "Deeds becoming void, nullified, or in vain.",
        quranUsage = "Habita means to become void. 'Their deeds have become void (habitat).' Ihbat is nullification.",
        notes = "Disbelief nullifies good deeds."
      ),

      // === ADDITIONAL ROOTS FOR 100% COVERAGE (Part 1) ===
      RootMeaningData(
        root = "ع-ت-د",
        primaryMeaning = "to prepare, make ready",
        extendedMeaning = "Preparing, making ready, or having something prepared.",
        quranUsage = "A'tadna means We have prepared. 'We have prepared ('atadna) for the disbelievers a painful punishment.'",
        notes = null
      ),
      RootMeaningData(
        root = "غ-د-و",
        primaryMeaning = "morning, to go early",
        extendedMeaning = "Morning time, or going out early in the morning.",
        quranUsage = "Ghuduww is morning. 'Glorify Him morning (ghuduwwan) and evening.' Ghada means to go early.",
        notes = null
      ),
      RootMeaningData(
        root = "ف-أ-د",
        primaryMeaning = "heart, mind",
        extendedMeaning = "The heart as seat of emotions and intellect.",
        quranUsage = "Fu'ad (فؤاد) is heart. 'The fu'ad (heart) of Musa's mother became empty.' Af'idah is hearts (plural).",
        notes = "Fu'ad emphasizes the emotional aspect of the heart."
      ),
      RootMeaningData(
        root = "ل-ه-و",
        primaryMeaning = "amusement, distraction, play",
        extendedMeaning = "Idle amusement, distraction from serious matters.",
        quranUsage = "Lahw (لهو) is amusement/distraction. 'This worldly life is but play and lahw (amusement).'",
        notes = "Lahw distracts from remembrance of Allah."
      ),
      RootMeaningData(
        root = "م-ه-د",
        primaryMeaning = "cradle, bed, to prepare",
        extendedMeaning = "A cradle, bed, or preparing/spreading something.",
        quranUsage = "Mahd (مهد) is cradle/bed. 'Who made the earth a mahd (bed) for you.' Also the cradle of Isa.",
        notes = null
      ),
      RootMeaningData(
        root = "ب-د-أ",
        primaryMeaning = "to begin, start, originate",
        extendedMeaning = "Beginning, starting, or originating something.",
        quranUsage = "Bada'a means to begin. 'As He originated (bada'a) you, so you will return.' Bad' is beginning.",
        notes = null
      ),
      RootMeaningData(
        root = "ح-ر-ج",
        primaryMeaning = "difficulty, tightness, sin",
        extendedMeaning = "Difficulty, constriction, or embarrassment.",
        quranUsage = "Haraj (حرج) is difficulty. 'There is no haraj (difficulty) on you.' Also narrow/constricted.",
        notes = "Islam removes haraj (hardship) from people."
      ),
      RootMeaningData(
        root = "س-و-م",
        primaryMeaning = "to pasture, mark, inflict",
        extendedMeaning = "Pasturing animals, or marking/branding. Also inflicting punishment.",
        quranUsage = "Sawwama means to inflict. 'They inflicted (yasumunakum) upon you the worst punishment.'",
        notes = null
      ),
      RootMeaningData(
        root = "ث-و-ي",
        primaryMeaning = "to stay, settle, abode",
        extendedMeaning = "Staying, settling, or an abode.",
        quranUsage = "Mathwa (مثوى) is abode. 'Hell is the mathwa (abode) of the arrogant.'",
        notes = null
      ),
      RootMeaningData(
        root = "ر-ج-م",
        primaryMeaning = "to stone, curse, conjecture",
        extendedMeaning = "Stoning, cursing, or speaking based on conjecture.",
        quranUsage = "Rajm is stoning/cursing. 'Accursed (rajim) Satan.' Rajm bil-ghayb is speaking without knowledge.",
        notes = "Shaytan is called 'rajim' (accursed/stoned)."
      ),
      RootMeaningData(
        root = "ص-ف-ف",
        primaryMeaning = "row, line, to arrange",
        extendedMeaning = "Arranging in rows or lines.",
        quranUsage = "Saff (صف) is row. 'Indeed Allah loves those who fight in rows (saffan).' Saffat are those arranged in rows.",
        notes = "Angels and believers stand in rows."
      ),
      RootMeaningData(
        root = "ع-ش-و",
        primaryMeaning = "evening, blindness, night",
        extendedMeaning = "Evening time, or night blindness.",
        quranUsage = "'Ashiyy (عشي) is evening. 'Glorify Him evening ('ashiyyan) and morning.' 'Isha is nightfall.",
        notes = null
      ),
      RootMeaningData(
        root = "و-ص-ف",
        primaryMeaning = "to describe, attribute",
        extendedMeaning = "Describing or attributing qualities.",
        quranUsage = "Wasafa means to describe. 'Glory to Allah above what they describe (yasifun).'",
        notes = "Allah is beyond human descriptions."
      ),
      RootMeaningData(
        root = "و-ل-ج",
        primaryMeaning = "to enter, penetrate",
        extendedMeaning = "Entering, penetrating, or going into.",
        quranUsage = "Walaja means to enter. 'He knows what enters (yaliju) the earth.' Wuluj is entering.",
        notes = null
      ),
      RootMeaningData(
        root = "أ-ب-ي",
        primaryMeaning = "to refuse, reject",
        extendedMeaning = "Refusing, rejecting, or being unwilling.",
        quranUsage = "Aba means to refuse. 'Iblis refused (aba) and was arrogant.' Iba' is refusal.",
        notes = "Iblis's refusal to prostrate was from arrogance."
      ),
      RootMeaningData(
        root = "ب-غ-ت",
        primaryMeaning = "suddenly, unexpectedly",
        extendedMeaning = "Coming suddenly or unexpectedly.",
        quranUsage = "Baghtatan (بغتة) means suddenly. 'The Hour will come upon them suddenly (baghtatan).'",
        notes = "The Day of Judgment comes suddenly."
      ),
      RootMeaningData(
        root = "ح-و-ر",
        primaryMeaning = "to return, white, beautiful eyes",
        extendedMeaning = "Returning, or intense whiteness. Hur are maidens with beautiful eyes.",
        quranUsage = "Hur (حور) are fair maidens of Paradise. 'Companions with beautiful eyes (hur 'in).' Hiwar is dialogue.",
        notes = "Hur 'in describes the contrast in eye color."
      ),
      RootMeaningData(
        root = "خ-ز-ن",
        primaryMeaning = "to store, treasure, guard",
        extendedMeaning = "Storing, treasuring, or guarding something.",
        quranUsage = "Khazana means to store. Khaza'in are treasures. 'To Allah belong the khaza'in (treasures) of the heavens and earth.'",
        notes = "Khazanah is the keepers of Hell."
      ),
      RootMeaningData(
        root = "ر-أ-ف",
        primaryMeaning = "compassion, kindness, mercy",
        extendedMeaning = "Gentleness, compassion, and tender mercy.",
        quranUsage = "Ra'fah (رأفة) is compassion. 'Rauf' (الرؤوف) is the Compassionate - Allah's name. 'Allah is Ra'uf to the servants.'",
        notes = "Ra'fah is a tender, gentle form of mercy."
      ),
      RootMeaningData(
        root = "ش-ه-و",
        primaryMeaning = "desire, lust, appetite",
        extendedMeaning = "Desire, appetite, or lustful craving.",
        quranUsage = "Shahwah (شهوة) is desire. 'Beautified for people is the love of shahawat (desires).' Ishtaha is to desire.",
        notes = "Controlling shahawat is part of self-discipline."
      ),
      RootMeaningData(
        root = "ط-م-أ-ن",
        primaryMeaning = "tranquility, peace of heart",
        extendedMeaning = "Serenity, calmness, and reassurance of the heart.",
        quranUsage = "Itma'naan is tranquility. 'Hearts find rest (tatma'innu) in the remembrance of Allah.' Mutma'innah is tranquil.",
        notes = "The tranquil soul (nafs mutma'innah) returns to Allah."
      ),
      RootMeaningData(
        root = "ف-د-ي",
        primaryMeaning = "ransom, redeem, sacrifice",
        extendedMeaning = "Ransoming, redeeming, or sacrificing for someone.",
        quranUsage = "Fida' (فداء) is ransom. 'We ransomed (fadaynahu) him with a great sacrifice.' Fidyah is compensation.",
        notes = "Ibrahim's son was ransomed with a ram."
      ),
      RootMeaningData(
        root = "ف-و-ه",
        primaryMeaning = "mouth, to utter",
        extendedMeaning = "Mouth, or uttering/speaking.",
        quranUsage = "Afwah (أفواه) is mouths. 'A word that comes out of their mouths (afwahihim).'",
        notes = null
      ),
      RootMeaningData(
        root = "ي-أ-س",
        primaryMeaning = "despair, hopelessness",
        extendedMeaning = "Losing hope, despair, or giving up.",
        quranUsage = "Ya's (يأس) is despair. 'Do not despair (tay'asu) of Allah's mercy.' Ya'is is one who despairs.",
        notes = "Despair of Allah's mercy is a sin."
      ),
      RootMeaningData(
        root = "ب-ك-ر",
        primaryMeaning = "early morning, virgin, firstborn",
        extendedMeaning = "Early morning, virginity, or being first.",
        quranUsage = "Bukrah (بكرة) is early morning. Bikr is virgin. 'Neither virgin (bikr) nor previously married.'",
        notes = null
      ),
      RootMeaningData(
        root = "ج-ب-ي",
        primaryMeaning = "forehead, to collect",
        extendedMeaning = "Forehead, or collecting/gathering.",
        quranUsage = "Jibah is forehead. 'Their foreheads (jibahuhum), sides and backs will be branded.'",
        notes = null
      ),
      RootMeaningData(
        root = "ج-ح-د",
        primaryMeaning = "to deny, reject",
        extendedMeaning = "Denying something known to be true.",
        quranUsage = "Jahada means to deny. 'They denied (jahadu) Our signs.' Juhud is denial.",
        notes = "Juhud is denying truth while knowing it."
      ),
      RootMeaningData(
        root = "ح-س-ر",
        primaryMeaning = "regret, sorrow, uncover",
        extendedMeaning = "Deep regret, grief, or uncovering.",
        quranUsage = "Hasrah (حسرة) is regret. 'Alas (hasrata) for me!' Hasir is one full of regret.",
        notes = "Hasrah is intense regret on Day of Judgment."
      ),
      RootMeaningData(
        root = "ح-ن-ف",
        primaryMeaning = "true faith, inclining to truth",
        extendedMeaning = "Inclining away from falsehood toward truth.",
        quranUsage = "Hanif (حنيف) is one inclining to truth. 'Ibrahim was hanif (upright), not of the polytheists.'",
        notes = "Hanifiyyah is the pure religion of Ibrahim."
      ),
      RootMeaningData(
        root = "خ-ر-ر",
        primaryMeaning = "to fall down, prostrate",
        extendedMeaning = "Falling down, especially in prostration.",
        quranUsage = "Kharra means to fall prostrate. 'They fall (yakhirruna) on their faces prostrating.'",
        notes = null
      ),
      RootMeaningData(
        root = "خ-و-ض",
        primaryMeaning = "to plunge, engage in vain talk",
        extendedMeaning = "Plunging into something, especially vain discourse.",
        quranUsage = "Khawda means to engage in vain talk. 'They were plunging (yakhuduuna) with those who plunge.'",
        notes = "Idle, vain discourse is condemned."
      ),
      RootMeaningData(
        root = "د-ر-ك",
        primaryMeaning = "to reach, overtake, comprehend",
        extendedMeaning = "Reaching, overtaking, or comprehending.",
        quranUsage = "Adraka means to reach/comprehend. 'Vision cannot perceive (tudrikuhu) Him.' Darak is lowest level.",
        notes = "Darak is the lowest depth of Hell."
      ),
      RootMeaningData(
        root = "س-ل-ك",
        primaryMeaning = "to insert, travel, path",
        extendedMeaning = "Inserting, traveling a path, or following a way.",
        quranUsage = "Salaka means to travel/insert. 'Travel (usluk) your hand into your garment.' Suluk is conduct.",
        notes = null
      ),
      RootMeaningData(
        root = "ش-ق-و",
        primaryMeaning = "misery, wretchedness",
        extendedMeaning = "Misery, wretchedness, or being wretched.",
        quranUsage = "Shaqiy (شقي) is wretched. 'As for those who are wretched (shaquu).' Shaqawah is wretchedness.",
        notes = "Opposite of sa'id (happy/blessed)."
      ),
      RootMeaningData(
        root = "ع-ذ-ر",
        primaryMeaning = "excuse, apologize",
        extendedMeaning = "Excuse, apology, or offering justification.",
        quranUsage = "'Udhr (عذر) is excuse. 'What is your excuse ('udhrukum)?' Ma'dhirah is excuse.",
        notes = "Some excuses are not accepted."
      ),
      RootMeaningData(
        root = "ع-س-ر",
        primaryMeaning = "difficulty, hardship",
        extendedMeaning = "Difficulty, hardship, or distress.",
        quranUsage = "'Usr (عسر) is difficulty. 'With difficulty ('usr) comes ease.' 'Asir is difficult.",
        notes = "Allah promises ease after hardship."
      ),
      RootMeaningData(
        root = "ع-ص-و",
        primaryMeaning = "staff, stick, to disobey",
        extendedMeaning = "A staff or stick. Also disobedience.",
        quranUsage = "'Asa (عصا) is staff. 'Throw your 'asa (staff)!' - Musa's staff. 'Asaa also means disobeyed.",
        notes = "Musa's staff turned into a serpent."
      ),
      RootMeaningData(
        root = "ع-و-ن",
        primaryMeaning = "help, assistance",
        extendedMeaning = "Help, assistance, or support.",
        quranUsage = "'Awn (عون) is help. 'We seek Your help (nasta'in).' Isti'anah is seeking help.",
        notes = "Help is sought only from Allah."
      ),
      RootMeaningData(
        root = "ن-ب-ذ",
        primaryMeaning = "to throw, cast away, reject",
        extendedMeaning = "Throwing away, casting aside, or rejecting.",
        quranUsage = "Nabadha means to cast away. 'They threw (nabadhuhu) it behind their backs.'",
        notes = "Refers to rejecting the Book of Allah."
      ),
      RootMeaningData(
        root = "ن-ي-ل",
        primaryMeaning = "to attain, reach, obtain",
        extendedMeaning = "Attaining, reaching, or obtaining something.",
        quranUsage = "Nala/yanalu means to attain. 'Their meat does not reach (yanalu) Allah.' Nayl is attainment.",
        notes = null
      ),
      RootMeaningData(
        root = "أ-ي-د",
        primaryMeaning = "to support, strengthen",
        extendedMeaning = "Supporting, strengthening, or providing power.",
        quranUsage = "Ayyada means to support. 'We supported (ayyadnahu) him with the Holy Spirit.'",
        notes = "Isa was supported with Ruh al-Qudus."
      ),
      RootMeaningData(
        root = "ز-ب-ر",
        primaryMeaning = "scriptures, to write",
        extendedMeaning = "Scriptures, writings, or pieces of iron.",
        quranUsage = "Zubur (زبر) are scriptures. 'We gave Dawud the Zabur.' Zubar is pieces of iron.",
        notes = "Zabur is the scripture given to Dawud."
      ),
      RootMeaningData(
        root = "س-ب-ب",
        primaryMeaning = "cause, means, rope",
        extendedMeaning = "Cause, means, or a rope/connection.",
        quranUsage = "Sabab (سبب) is cause/means. 'We gave him means (asbab) to everything.' Asbab are means.",
        notes = null
      ),
      RootMeaningData(
        root = "ش-ف-ق",
        primaryMeaning = "fear, compassion, twilight",
        extendedMeaning = "Fear mixed with compassion, or the reddish twilight.",
        quranUsage = "Shafaq (شفق) is twilight/fear. 'By the shafaq (twilight).' Mushfiq is fearful/compassionate.",
        notes = null
      ),
      RootMeaningData(
        root = "ص-ع-ق",
        primaryMeaning = "thunderbolt, to be struck",
        extendedMeaning = "Being struck by a thunderbolt or fainting.",
        quranUsage = "Sa'iqah (صاعقة) is thunderbolt. 'The sa'iqah (thunderbolt) struck them.' Sa'iq is one struck.",
        notes = null
      ),
      RootMeaningData(
        root = "ط-ب-ع",
        primaryMeaning = "to seal, nature, stamp",
        extendedMeaning = "Sealing, stamping, or natural disposition.",
        quranUsage = "Taba'a means to seal. 'Allah has sealed (taba'a) their hearts.' Tab' is seal/nature.",
        notes = "Hearts are sealed due to disbelief."
      ),
      RootMeaningData(
        root = "ط-ر-ف",
        primaryMeaning = "edge, glance, blink",
        extendedMeaning = "Edge, side, or a glance of the eye.",
        quranUsage = "Tarf (طرف) is glance. 'Restricting their glances (tarf).' Taraf is edge/side.",
        notes = null
      ),
      RootMeaningData(
        root = "غ-م-م",
        primaryMeaning = "grief, distress, clouds",
        extendedMeaning = "Grief, distress, or covering like clouds.",
        quranUsage = "Ghamm (غم) is grief/distress. 'Grief upon grief (ghamman).' Ghammam is clouds.",
        notes = null
      ),
      RootMeaningData(
        root = "ف-أ-ي",
        primaryMeaning = "which, what",
        extendedMeaning = "Which (interrogative and relative).",
        quranUsage = "Ayy (أي) means which. 'Which (fa-bi-ayyi) of your Lord's favors will you deny?'",
        notes = "Repeated in Surah Ar-Rahman."
      ),
      RootMeaningData(
        root = "ف-ر-ر",
        primaryMeaning = "to flee, escape",
        extendedMeaning = "Fleeing, escaping, or running away.",
        quranUsage = "Farra means to flee. 'So flee (firru) to Allah.' Firar is fleeing.",
        notes = "Fleeing to Allah means turning to Him."
      ),
      RootMeaningData(
        root = "و-ر-د",
        primaryMeaning = "to arrive, come to water",
        extendedMeaning = "Arriving, especially at water. Also rose.",
        quranUsage = "Warada means to come to. 'Every one of you will arrive (wariduhaa) at it.' Wird is portion of worship.",
        notes = "Everyone will come to Hell, but believers will pass."
      ),
      RootMeaningData(
        root = "و-ق-د",
        primaryMeaning = "to kindle, ignite",
        extendedMeaning = "Kindling, igniting, or fueling fire.",
        quranUsage = "Waqud (وقود) is fuel. 'Whose fuel (waqud) is people and stones.' Awqada is to kindle.",
        notes = null
      ),
      RootMeaningData(
        root = "و-ك-أ",
        primaryMeaning = "to lean on, trust",
        extendedMeaning = "Leaning on, relying upon, or trusting.",
        quranUsage = "Tawakkul is reliance. 'Upon Allah let the believers rely (yatawakkal).' Mutawakkil relies on Allah.",
        notes = "Tawakkul is complete reliance on Allah."
      ),
      RootMeaningData(
        root = "أ-ص-ل",
        primaryMeaning = "root, origin, foundation",
        extendedMeaning = "Root, origin, or foundation.",
        quranUsage = "Asl (أصل) is root. 'Its root (asluha) firm and its branches in the sky.'",
        notes = "The good word is like a good tree with firm roots."
      ),
      RootMeaningData(
        root = "ب-ط-ش",
        primaryMeaning = "to seize, strike violently",
        extendedMeaning = "Seizing or striking with violence.",
        quranUsage = "Batasha means to seize. 'When you seize (batashtum), you seize like tyrants.' Batsh is violent seizing.",
        notes = null
      ),
      RootMeaningData(
        root = "ج-ب-ر",
        primaryMeaning = "to compel, mend, mighty",
        extendedMeaning = "Compelling, mending, or being mighty and powerful.",
        quranUsage = "Jabbar (جبار) is the Compeller - Allah's name. Also tyrant. 'He was not a jabbar (tyrant).'",
        notes = "Al-Jabbar is one of Allah's names."
      ),
      RootMeaningData(
        root = "ح-ي-ق",
        primaryMeaning = "to surround, befall",
        extendedMeaning = "Surrounding or befalling someone (especially evil).",
        quranUsage = "Haqa means to befall. 'Evil plotting surrounds (yahiqu) only its own people.'",
        notes = null
      ),
      RootMeaningData(
        root = "د-م-ر",
        primaryMeaning = "to destroy, annihilate",
        extendedMeaning = "Complete destruction and annihilation.",
        quranUsage = "Dammara means to destroy. 'We destroyed (dammarnaa) them utterly.' Tadmir is destruction.",
        notes = null
      ),
      RootMeaningData(
        root = "د-م-و",
        primaryMeaning = "tears, to weep",
        extendedMeaning = "Tears or weeping.",
        quranUsage = "Dam' (دمع) is tears. 'Their eyes overflow with tears (dam').'",
        notes = null
      ),
      RootMeaningData(
        root = "ر-ج-ز",
        primaryMeaning = "punishment, abomination",
        extendedMeaning = "Punishment, filth, or abomination.",
        quranUsage = "Rijz (رجز) is punishment/abomination. 'We will send upon them rijz (punishment).' Also idols are rijz.",
        notes = null
      ),
      RootMeaningData(
        root = "ر-ع-ي",
        primaryMeaning = "to tend, shepherd, observe",
        extendedMeaning = "Shepherding, tending, or observing carefully.",
        quranUsage = "Ra'a means to tend. 'They do not observe (yar'awna) any covenant.'",
        notes = null
      ),
      RootMeaningData(
        root = "ر-ه-ق",
        primaryMeaning = "to cover, burden, overcome",
        extendedMeaning = "Covering, burdening, or overwhelming.",
        quranUsage = "Rahiqa means to cover. 'Humiliation will cover (tarhaquha) them.' Irhaq is overburdening.",
        notes = null
      ),
      RootMeaningData(
        root = "ز-ل-ف",
        primaryMeaning = "nearness, to draw near",
        extendedMeaning = "Drawing near, nearness, or stages of nearness.",
        quranUsage = "Zulfa (زلفى) is nearness. 'That which brings us near (zulfa) to Allah.' Azlafa is to bring near.",
        notes = null
      ),
      RootMeaningData(
        root = "ز-ي-ل",
        primaryMeaning = "to separate, remove",
        extendedMeaning = "Separating, removing, or departing.",
        quranUsage = "Zayyala means to separate. 'We would have separated (zayyalna) them.'",
        notes = null
      ),
      RootMeaningData(
        root = "ع-ت-و",
        primaryMeaning = "to be insolent, rebel",
        extendedMeaning = "Insolence, arrogance, or rebellion.",
        quranUsage = "'Ata means to be insolent. 'They exceeded in 'utuww (insolence).' 'Atiyy is rebellious.",
        notes = null
      ),
      RootMeaningData(
        root = "ع-ز-ل",
        primaryMeaning = "to isolate, remove",
        extendedMeaning = "Isolating, removing, or setting aside.",
        quranUsage = "'Azala means to isolate. 'When you withdraw (i'tazaltum) from them.' I'tizal is withdrawal.",
        notes = null
      ),
      RootMeaningData(
        root = "ق-ه-ر",
        primaryMeaning = "to overpower, subdue",
        extendedMeaning = "Overpowering, subduing, or conquering.",
        quranUsage = "Qahhar (قهار) is the Subduer - Allah's name. 'Al-Wahid al-Qahhar.' Qahr is subjugation.",
        notes = "Al-Qahhar is one of Allah's names."
      ),
      RootMeaningData(
        root = "م-أ-ي",
        primaryMeaning = "water, hundred",
        extendedMeaning = "Hundred, or related to water.",
        quranUsage = "Mi'ah (مائة) is hundred. 'Strike each of them with a hundred (mi'ata) lashes.'",
        notes = null
      ),
      RootMeaningData(
        root = "م-ل-و",
        primaryMeaning = "to fill, dictate",
        extendedMeaning = "Filling or dictating.",
        quranUsage = "Amla means to dictate. 'Let him who has the debt dictate (yumlil).' Imla' is dictation.",
        notes = null
      ),

      // === ADDITIONAL ROOTS FOR 100% COVERAGE (Part 2) ===
      RootMeaningData(root = "ب-ر-ز", primaryMeaning = "to appear, emerge", extendedMeaning = "Appearing, emerging into the open.", quranUsage = "Baraza means to appear. 'They will appear (barazuu) before Allah.'", notes = null),
      RootMeaningData(root = "د-و-م", primaryMeaning = "to continue, last", extendedMeaning = "Continuing, lasting, or being permanent.", quranUsage = "Da'im is continuous. 'Fruits continuous (da'im).' Dawam is permanence.", notes = null),
      RootMeaningData(root = "ز-ن-ي", primaryMeaning = "adultery, fornication", extendedMeaning = "Unlawful sexual relations.", quranUsage = "Zina (زنى) is adultery/fornication. 'Do not approach zina.' Zani is fornicator.", notes = "Zina is a major sin."),
      RootMeaningData(root = "ز-ي-غ", primaryMeaning = "to deviate, swerve", extendedMeaning = "Deviating from truth, swerving.", quranUsage = "Zagha means to deviate. 'When they deviated (zaghu), Allah caused their hearts to deviate.' Zaygh is deviation.", notes = null),
      RootMeaningData(root = "س-ب-ت", primaryMeaning = "Sabbath, rest", extendedMeaning = "Sabbath day, or resting.", quranUsage = "Sabt (سبت) is Sabbath. 'Those who violated the Sabt (Sabbath).'", notes = "Refers to the story of the Sabbath-breakers."),
      RootMeaningData(root = "س-ر-ق", primaryMeaning = "to steal, theft", extendedMeaning = "Stealing or theft.", quranUsage = "Saraqa means to steal. 'The male thief (sariq) and female thief.' Sariqah is theft.", notes = null),
      RootMeaningData(root = "ع-ب-ر", primaryMeaning = "to cross, interpret", extendedMeaning = "Crossing, passing over, or interpreting dreams.", quranUsage = "'Abara means to interpret. 'If you can interpret (ta'buruuna) visions.' 'Ibrah is lesson.", notes = null),
      RootMeaningData(root = "ع-ر-ج", primaryMeaning = "to ascend, lame", extendedMeaning = "Ascending, or being lame/limping.", quranUsage = "'Araja means to ascend. 'The angels and the Spirit ascend (ta'ruju) to Him.' Ma'arij are ways of ascent.", notes = null),
      RootMeaningData(root = "ع-ز-م", primaryMeaning = "to resolve, determine", extendedMeaning = "Firm resolve, determination.", quranUsage = "'Azm (عزم) is resolve. 'Those of firm resolve ('ulul-'azm) among the messengers.' 'Azama is to determine.", notes = "Ulul-'azm are the five greatest prophets."),
      RootMeaningData(root = "ع-و-م", primaryMeaning = "to swim, float", extendedMeaning = "Swimming or floating.", quranUsage = "Sabaha/ya'um means to swim. 'Each in an orbit floating (yasbahun).'", notes = null),
      RootMeaningData(root = "غ-ن-م", primaryMeaning = "sheep, spoils of war", extendedMeaning = "Sheep/cattle, or war spoils (ghanima).", quranUsage = "Ghanam (غنم) is sheep. Ghanimah is spoils of war. 'Know that whatever you obtain as ghanima...'", notes = null),
      RootMeaningData(root = "ق-ذ-ف", primaryMeaning = "to throw, accuse", extendedMeaning = "Throwing, or accusing falsely.", quranUsage = "Qadhafa means to throw/accuse. 'We cast (naqdhifu) the truth against falsehood.' Also false accusation.", notes = null),
      RootMeaningData(root = "ه-م-م", primaryMeaning = "to intend, worry", extendedMeaning = "Intending, being about to, or worry.", quranUsage = "Hamma means to intend. 'She intended (hammat) him and he intended her.' Hamm is worry/intention.", notes = null),
      RootMeaningData(root = "و-ق-ر", primaryMeaning = "heaviness, deafness, dignity", extendedMeaning = "Heaviness in ears, or dignity and reverence.", quranUsage = "Waqr (وقر) is heaviness. 'In their ears is waqr (deafness).' Waqar is dignity.", notes = null),
      RootMeaningData(root = "و-ه-ن", primaryMeaning = "weakness, feebleness", extendedMeaning = "Weakness, frailty, or becoming weak.", quranUsage = "Wahn (وهن) is weakness. 'Do not weaken (tahinu) or grieve.' Wahin is weak.", notes = null),
      RootMeaningData(root = "أ-ن-ي", primaryMeaning = "vessel, pot, time", extendedMeaning = "Vessel or pot. Also time.", quranUsage = "Ana (آنى) is time/hour. Inaa' (إناء) is vessel. 'From vessels (aniyah) of silver.'", notes = null),
      RootMeaningData(root = "أ-و-ن", primaryMeaning = "time, when", extendedMeaning = "Time or moment.", quranUsage = "An (أن) can indicate time. 'Idha' is 'when.'", notes = null),
      RootMeaningData(root = "ب-ه-ت", primaryMeaning = "to slander, astonish", extendedMeaning = "False accusation or being astonished.", quranUsage = "Buhtan (بهتان) is slander. 'A clear buhtan (slander).' Bahata is to astonish.", notes = null),
      RootMeaningData(root = "ت-ر-ف", primaryMeaning = "luxury, affluence", extendedMeaning = "Luxury, extravagance, living in ease.", quranUsage = "Mutraf (مترف) is one living in luxury. 'We sent a warner to any town except that its mutrafun (affluent) said...'", notes = null),
      RootMeaningData(root = "خ-س-ف", primaryMeaning = "to sink, eclipse", extendedMeaning = "Sinking into earth, or lunar eclipse.", quranUsage = "Khasafa means to sink. 'We caused the earth to swallow (khasafna) him.' Khusuf is eclipse.", notes = null),
      RootMeaningData(root = "ر-ج-ف", primaryMeaning = "to shake, tremble", extendedMeaning = "Shaking, trembling, or earthquake.", quranUsage = "Rajfah (رجفة) is earthquake/trembling. 'The rajfah (earthquake) seized them.' Rajif is trembling.", notes = null),
      RootMeaningData(root = "س-ر-ي", primaryMeaning = "to travel by night", extendedMeaning = "Traveling or journeying by night.", quranUsage = "Asra means to travel by night. 'Glory to Him who took His servant by night (asra).' Isra' is the night journey.", notes = "The Prophet's night journey to Jerusalem."),
      RootMeaningData(root = "س-ق-ط", primaryMeaning = "to fall, drop", extendedMeaning = "Falling, dropping, or collapsing.", quranUsage = "Saqata means to fall. 'When it fell (suqita) into their hands.' Saqit is one who falls.", notes = null),
      RootMeaningData(root = "ض-ر-ع", primaryMeaning = "to humble, implore", extendedMeaning = "Humbling oneself, imploring, supplicating.", quranUsage = "Tadarru' (تضرع) is humble supplication. 'Call upon your Lord with humility (tadarru'an).'", notes = null),
      RootMeaningData(root = "ع-ق-ر", primaryMeaning = "to hamstring, barren", extendedMeaning = "Hamstringing an animal, or being barren.", quranUsage = "'Aqara means to hamstring. 'They hamstrung ('aqaru) the she-camel.' 'Aqir is barren.", notes = null),
      RootMeaningData(root = "ع-ي-ش", primaryMeaning = "to live, livelihood", extendedMeaning = "Living, life, or means of living.", quranUsage = "'Aysh (عيش) is life/living. Ma'ishah is livelihood. 'We distributed their livelihood (ma'ishatahum).'", notes = null),
      RootMeaningData(root = "ف-ر-ط", primaryMeaning = "to neglect, excess", extendedMeaning = "Neglecting, or going to excess.", quranUsage = "Farrata means to neglect. 'What I neglected (farrattu) regarding Allah.' Ifrat is excess.", notes = null),
      RootMeaningData(root = "ك-ل-ف", primaryMeaning = "to burden, charge", extendedMeaning = "Burdening, charging with duty, or obligation.", quranUsage = "Kallafa means to burden. 'Allah does not burden (yukallifu) a soul beyond its capacity.' Taklif is obligation.", notes = null),
      RootMeaningData(root = "و-ب-ل", primaryMeaning = "heavy rain, severity", extendedMeaning = "Heavy rain, or severity and evil consequence.", quranUsage = "Wabil (وابل) is heavy rain. 'Like a garden on a hill struck by wabil (heavy rain).' Wabal is evil consequence.", notes = null),
      RootMeaningData(root = "أ-س-و", primaryMeaning = "model, example", extendedMeaning = "A model, example, or pattern to follow.", quranUsage = "Uswah (أسوة) is example. 'In the Messenger of Allah is a good uswah (example) for you.'", notes = "The Prophet is the best example."),
      RootMeaningData(root = "ب-خ-س", primaryMeaning = "to diminish, wrong", extendedMeaning = "Diminishing someone's right, or wronging.", quranUsage = "Bakhasa means to diminish. 'Do not diminish (tabkhasu) people's things.'", notes = null),
      RootMeaningData(root = "ب-ض-ع", primaryMeaning = "piece, part, few", extendedMeaning = "A part, piece, or a few (3-9).", quranUsage = "Bid' (بضع) means a few. 'In a few (bid'i) years.'", notes = null),
      RootMeaningData(root = "ب-ع-ل", primaryMeaning = "husband, lord, Baal", extendedMeaning = "Husband, master, or the idol Baal.", quranUsage = "Ba'l (بعل) is husband/lord. 'Do you call upon Ba'l (a false god)?' Also husband.", notes = "Ba'l was an idol worshipped by some."),
      RootMeaningData(root = "ح-ظ-ظ", primaryMeaning = "portion, fortune", extendedMeaning = "Portion, share, or good fortune.", quranUsage = "Hazz (حظ) is portion/fortune. 'Only those with great fortune (hazz) attain it.'", notes = null),
      RootMeaningData(root = "خ-ط-ف", primaryMeaning = "to snatch, seize", extendedMeaning = "Snatching, seizing quickly.", quranUsage = "Khatifa means to snatch. 'Except one who snatches (khatifa) a fragment.'", notes = null),
      RootMeaningData(root = "د-ك-ك", primaryMeaning = "to crush, level", extendedMeaning = "Crushing, leveling, or demolishing.", quranUsage = "Dakka means to crush/level. 'The earth will be leveled (dukkat) completely.'", notes = null),
      RootMeaningData(root = "س-ر-ح", primaryMeaning = "to let loose, send", extendedMeaning = "Letting loose, sending, or releasing.", quranUsage = "Sarraha means to release. 'Release (sarrihuunna) them with kindness.' Tasrih is divorce release.", notes = null),
      RootMeaningData(root = "ض-ح-و", primaryMeaning = "forenoon, become clear", extendedMeaning = "Morning sun, forenoon, or becoming clear.", quranUsage = "Duha (ضحى) is forenoon. 'By the duha (morning brightness).' Surah Ad-Duha.", notes = null),
      RootMeaningData(root = "ع-م-د", primaryMeaning = "pillar, intentional", extendedMeaning = "Pillar, column, or doing something intentionally.", quranUsage = "'Amad (عمد) is pillars. 'The sky raised without any 'amad (pillars) that you can see.' 'Amadan is intentionally.", notes = null),
      RootMeaningData(root = "ع-م-ه", primaryMeaning = "to wander blindly", extendedMeaning = "Wandering blindly, being confused.", quranUsage = "'Amiha means to wander. 'They wander blindly (ya'mahun) in their transgression.'", notes = null),
      RootMeaningData(root = "ف-ي-أ", primaryMeaning = "shade, return", extendedMeaning = "Shade, shadow, or returning.", quranUsage = "Fay' (فيء) is shade/spoils. 'Their shadows (fay') turn.' Also war spoils.", notes = null),
      RootMeaningData(root = "م-ك-ث", primaryMeaning = "to stay, remain", extendedMeaning = "Staying, remaining, or lingering.", quranUsage = "Makatha means to stay. 'I will stay (amkuthu) at the fire.' Mukth is staying.", notes = null),
      RootMeaningData(root = "ن-س-ك", primaryMeaning = "worship, sacrifice", extendedMeaning = "Worship, devotion, or sacrifice ritual.", quranUsage = "Nusuk (نسك) is worship/sacrifice. 'My prayer and my nusuk (sacrifice).' Mansak is ritual.", notes = null),
      RootMeaningData(root = "ن-ك-ث", primaryMeaning = "to break oath", extendedMeaning = "Breaking an oath or covenant.", quranUsage = "Nakatha means to break. 'Whoever breaks (nakatha) only harms himself.' Nakth is breaking oath.", notes = null),
      RootMeaningData(root = "ن-و-ق", primaryMeaning = "she-camel", extendedMeaning = "A she-camel.", quranUsage = "Naqah (ناقة) is she-camel. 'This is the she-camel (naqah) of Allah.' The she-camel of Salih.", notes = "The miraculous she-camel of Prophet Salih."),
      RootMeaningData(root = "و-ع-ي", primaryMeaning = "to preserve, understand", extendedMeaning = "Preserving, understanding, or comprehending.", quranUsage = "Wa'a means to preserve. 'That a preserving ear (udhunun wa'iyah) might preserve it.' Wi'a' is vessel.", notes = null),
      RootMeaningData(root = "أ-د-ي", primaryMeaning = "to deliver, return", extendedMeaning = "Delivering, returning, or fulfilling trust.", quranUsage = "Adda means to deliver. 'Deliver (addu) the trusts to their owners.' Ada' is performance.", notes = null),
      RootMeaningData(root = "ت-ب-ر", primaryMeaning = "to destroy, ruin", extendedMeaning = "Complete destruction, ruin.", quranUsage = "Tabbara means to destroy. 'We destroyed (tabbarna) what Fir'awn and his people made.' Tatbir is destruction.", notes = null),
      RootMeaningData(root = "ث-ق-ف", primaryMeaning = "to find, seize", extendedMeaning = "Finding, seizing, or overtaking.", quranUsage = "Thaqifa means to find/seize. 'Wherever you find (thaqiftumuhum) them.' Thaqif is a tribe.", notes = null),
      RootMeaningData(root = "ح-ر-ف", primaryMeaning = "edge, letter, distort", extendedMeaning = "Edge, side, letter, or distorting meaning.", quranUsage = "Harf (حرف) is edge/letter. 'On an edge (harf) - if good comes to him...' Tahrif is distortion.", notes = null),
      RootMeaningData(root = "ح-ص-ر", primaryMeaning = "to confine, besiege", extendedMeaning = "Confining, besieging, or being restricted.", quranUsage = "Hasara means to confine. 'If you are confined (uhsirtum).' Hasr is siege.", notes = null),
      RootMeaningData(root = "ح-ط-م", primaryMeaning = "to crush, break", extendedMeaning = "Crushing, breaking into pieces.", quranUsage = "Hutamah (حطمة) is crusher - a name of Hell. 'It is the Hutamah.' Hattama is to crush.", notes = "One of the names of Hell."),
      RootMeaningData(root = "د-أ-ب", primaryMeaning = "habit, custom, toil", extendedMeaning = "Custom, habit, or continuous toil.", quranUsage = "Da'b (دأب) is custom. 'Like the custom (da'bi) of the people of Nuh.'", notes = null),
      RootMeaningData(root = "ذ-ر-أ", primaryMeaning = "to create, scatter", extendedMeaning = "Creating, multiplying, or scattering.", quranUsage = "Dhara'a means to spread/create. 'He scattered (dhara'a) in it creatures.' Dhurriyyah is offspring.", notes = null),
      RootMeaningData(root = "ر-د-ي", primaryMeaning = "to perish, destroy", extendedMeaning = "Perishing, being destroyed.", quranUsage = "Rada/yarda means to perish. 'He who perishes (halaka) from clear evidence.'", notes = null),
      RootMeaningData(root = "ر-ص-د", primaryMeaning = "to watch, lie in wait", extendedMeaning = "Watching, lying in wait, or observing.", quranUsage = "Rasada means to watch. 'Your Lord is in wait (bil-mirsad).' Mirsad is ambush/watch.", notes = null),
      RootMeaningData(root = "ز-ج-ر", primaryMeaning = "to rebuke, drive away", extendedMeaning = "Rebuking, driving away, or scolding.", quranUsage = "Zajara means to rebuke. 'They were rebuked (zujiru).' Zajr is rebuke.", notes = null),
      RootMeaningData(root = "ض-و-أ", primaryMeaning = "light, illuminate", extendedMeaning = "Light, shining, or illuminating.", quranUsage = "Daw' (ضوء) is light. 'Its daw' (light) would almost illuminate.' Diya' is radiance.", notes = null),
      RootMeaningData(root = "غ-ر-م", primaryMeaning = "debt, fine, loss", extendedMeaning = "Debt, fine, penalty, or financial loss.", quranUsage = "Gharam (غرام) is penalty. 'Its punishment is gharam (lasting).' Gharim is debtor.", notes = null),
      RootMeaningData(root = "ك-ر-ر", primaryMeaning = "to repeat, return", extendedMeaning = "Repeating, returning again.", quranUsage = "Karrar means to return. 'If only we could return (nuraddu).' Takrar is repetition.", notes = null),
      RootMeaningData(root = "ك-ظ-م", primaryMeaning = "to suppress, restrain", extendedMeaning = "Suppressing anger, restraining.", quranUsage = "Kathm (كظم) is suppressing. 'Those who suppress (kadhimin) their anger.' Kazim is one who suppresses.", notes = null),
      RootMeaningData(root = "ل-ح-د", primaryMeaning = "to deviate, grave", extendedMeaning = "Deviating from truth, or a side grave.", quranUsage = "Ilhad (إلحاد) is deviation. 'Those who deviate (yulhidun) concerning His names.' Lahd is grave niche.", notes = null),
      RootMeaningData(root = "م-ق-ت", primaryMeaning = "hatred, abhorrence", extendedMeaning = "Intense hatred, abhorrence.", quranUsage = "Maqt (مقت) is hatred. 'Great is maqt (hatred) with Allah.' Maqata is to abhor.", notes = null),
      RootMeaningData(root = "م-ه-ل", primaryMeaning = "to give time, delay", extendedMeaning = "Giving respite, delay, or leisure.", quranUsage = "Amhala means to give time. 'Give respite (amhilhum) to the disbelievers.' Muhlah is respite.", notes = null),
      RootMeaningData(root = "ن-د-د", primaryMeaning = "equal, rival", extendedMeaning = "Equal, rival, or partner.", quranUsage = "Nidd (ند) is rival/equal. 'Do not make rivals (andadan) to Allah.' Andad are equals.", notes = null),
      RootMeaningData(root = "ن-ز-غ", primaryMeaning = "to incite, provoke", extendedMeaning = "Inciting evil, provoking.", quranUsage = "Nazagha means to incite. 'Satan incites (yanzaghu) between them.' Nazgh is incitement.", notes = null),
      RootMeaningData(root = "و-ط-أ", primaryMeaning = "to tread, step", extendedMeaning = "Treading, stepping, or pressing down.", quranUsage = "Wati'a means to tread. 'They do not tread (yata'uuna) upon anything.' Wat' is treading.", notes = null),

      // === REMAINING ROOTS FOR 100% COVERAGE ===
      RootMeaningData(root = "أ-ب-ب", primaryMeaning = "herbage, fodder", extendedMeaning = "Herbage, pasture for animals.", quranUsage = "Abb (أب) is herbage. 'And fruits and abb (herbage).'", notes = null),
      RootMeaningData(root = "أ-ب-ق", primaryMeaning = "to flee, escape", extendedMeaning = "Fleeing, running away.", quranUsage = "Abaqa means to flee. 'When he fled (abaqa) to the laden ship.'", notes = "Refers to Prophet Yunus."),
      RootMeaningData(root = "أ-ب-ل", primaryMeaning = "camels", extendedMeaning = "Camels.", quranUsage = "Ibil (إبل) is camels. 'Do they not look at the ibil (camels)?'", notes = null),
      RootMeaningData(root = "أ-ث-ث", primaryMeaning = "furniture, goods", extendedMeaning = "Furniture, household goods.", quranUsage = "Athath (أثاث) is furniture. 'Furniture (athath) and enjoyment.'", notes = null),
      RootMeaningData(root = "أ-ث-ل", primaryMeaning = "tamarisk tree", extendedMeaning = "A tamarisk tree.", quranUsage = "Athl (أثل) is tamarisk. 'Gardens of athl (tamarisk).'", notes = null),
      RootMeaningData(root = "أ-ج-ج", primaryMeaning = "to kindle, blaze", extendedMeaning = "Kindling, blazing.", quranUsage = "Ujaj (أجاج) is salty/bitter. 'And this is salty, bitter (ujaj).'", notes = null),
      RootMeaningData(root = "أ-د-د", primaryMeaning = "strength, power", extendedMeaning = "Strength, power.", quranUsage = "Iddan (إدا) is monstrous. 'A monstrous (iddan) thing.'", notes = null),
      RootMeaningData(root = "أ-ر-ب", primaryMeaning = "need, skill", extendedMeaning = "Need, requirement, or skill.", quranUsage = "Irbah (إربة) is need. 'Those without irbah (need) for women.'", notes = null),
      RootMeaningData(root = "أ-ر-ك", primaryMeaning = "couch, throne", extendedMeaning = "Couches, thrones.", quranUsage = "Ara'ik (أرائك) are couches. 'Reclining on ara'ik (couches).'", notes = null),
      RootMeaningData(root = "أ-ز-ر", primaryMeaning = "to support, strengthen", extendedMeaning = "Supporting, strengthening.", quranUsage = "Azara means to support. 'Strengthen (azirni) me.' Izar is waist-wrapper.", notes = null),
      RootMeaningData(root = "أ-ز-ز", primaryMeaning = "to shake, incite", extendedMeaning = "Shaking, inciting.", quranUsage = "Azza means to incite. 'We sent devils to incite (ta'uzzuhum) them.'", notes = null),
      RootMeaningData(root = "أ-ز-ف", primaryMeaning = "to approach, draw near", extendedMeaning = "Approaching, drawing near.", quranUsage = "Azifah (آزفة) is the Approaching. 'The Approaching Day (azifah) has approached.'", notes = null),
      RootMeaningData(root = "أ-س-س", primaryMeaning = "to found, base", extendedMeaning = "Founding, establishing a base.", quranUsage = "Assasa means to found. 'One who founded (assasa) his building on taqwa.'", notes = null),
      RootMeaningData(root = "أ-س-ن", primaryMeaning = "stagnant, stale", extendedMeaning = "Stagnant, stale.", quranUsage = "Asin (آسن) is stagnant. 'Water not stagnant (asin).'", notes = null),
      RootMeaningData(root = "أ-ش-ر", primaryMeaning = "proud, exultant", extendedMeaning = "Proud, insolent.", quranUsage = "Ashir (أشر) is proud. 'Is he the proud (ashir) liar?'", notes = null),
      RootMeaningData(root = "أ-ص-ر", primaryMeaning = "burden, covenant", extendedMeaning = "Heavy burden, covenant.", quranUsage = "Isr (إصر) is burden. 'The burden (isr) that was upon them.'", notes = null),
      RootMeaningData(root = "أ-ف-ف", primaryMeaning = "expression of disgust", extendedMeaning = "Expression of annoyance.", quranUsage = "Uff (أف) is an expression of disgust. 'Do not say to them uff.'", notes = null),
      RootMeaningData(root = "أ-ف-ل", primaryMeaning = "to set, disappear", extendedMeaning = "Setting (of celestial bodies).", quranUsage = "Afala means to set. 'When it set (afala).'", notes = null),
      RootMeaningData(root = "أ-ل-ت", primaryMeaning = "to diminish, wrong", extendedMeaning = "Diminishing, wronging.", quranUsage = "Alata means to diminish. 'We do not diminish (nalituhum).'", notes = null),
      RootMeaningData(root = "أ-ل-ل", primaryMeaning = "to lament", extendedMeaning = "Lamenting.", quranUsage = "Related to expression of distress.", notes = null),
      RootMeaningData(root = "أ-م-ت", primaryMeaning = "crookedness", extendedMeaning = "Crookedness, unevenness.", quranUsage = "Amt (أمت) is crookedness. 'You see no amt (crookedness) in it.'", notes = null),
      RootMeaningData(root = "أ-م-ل", primaryMeaning = "hope, wish", extendedMeaning = "Hope, wish, aspiration.", quranUsage = "Amal (أمل) is hope. 'Let them hope (amal) extend their life.'", notes = null),
      RootMeaningData(root = "أ-م-و", primaryMeaning = "maidservant", extendedMeaning = "Maidservant.", quranUsage = "Amah (أمة) is maidservant. 'A believing slave girl (amah).'", notes = null),
      RootMeaningData(root = "أ-ن-م", primaryMeaning = "creatures, mankind", extendedMeaning = "Creatures, mankind and jinn.", quranUsage = "Anam (أنام) is creatures. 'He laid the earth for the anam (creatures).'", notes = null),
      RootMeaningData(root = "أ-و-د", primaryMeaning = "to burden, difficulty", extendedMeaning = "Burdening, difficulty.", quranUsage = "Ada/ya'udu means to burden. 'It does not burden (ya'uduhu) Him.'", notes = null),
      RootMeaningData(root = "أ-و-ه", primaryMeaning = "alas, grief", extendedMeaning = "Expression of grief.", quranUsage = "Awwah (أواه) is one who sighs. 'Ibrahim was forbearing, awwah (sighing).'", notes = null),
      RootMeaningData(root = "أ-ي-م", primaryMeaning = "unmarried, widow", extendedMeaning = "Unmarried person, widow/widower.", quranUsage = "Ayyim (أيم) is unmarried. 'Marry the unmarried (ayama) among you.'", notes = null),
      RootMeaningData(root = "ب-أ-ر", primaryMeaning = "well, pit", extendedMeaning = "A well, pit.", quranUsage = "Bi'r (بئر) is well. 'A well (bi'r) disabled.'", notes = null),
      RootMeaningData(root = "ب-ت-ر", primaryMeaning = "to cut off", extendedMeaning = "Cutting off, being without posterity.", quranUsage = "Abtar (أبتر) is cut off. 'Your enemy is the one cut off (abtar).'", notes = null),
      RootMeaningData(root = "ب-ت-ك", primaryMeaning = "to cut, slit", extendedMeaning = "Cutting, slitting.", quranUsage = "Battaka means to cut. 'They will cut (yubattikanna) the ears of cattle.'", notes = null),
      RootMeaningData(root = "ب-ت-ل", primaryMeaning = "to devote, cut off", extendedMeaning = "Devoting oneself, cutting off.", quranUsage = "Tabattul is devotion. 'Devote (tabattal) yourself to Him.'", notes = null),
      RootMeaningData(root = "ب-ج-س", primaryMeaning = "to gush forth", extendedMeaning = "Gushing forth.", quranUsage = "Inbajasa means to gush. 'Twelve springs gushed (inbajasat) forth.'", notes = null),
      RootMeaningData(root = "ب-ح-ث", primaryMeaning = "to search, dig", extendedMeaning = "Searching, digging.", quranUsage = "Bahatha means to search. 'A crow searching (yabhath) in the ground.'", notes = null),
      RootMeaningData(root = "ب-خ-ع", primaryMeaning = "to destroy oneself", extendedMeaning = "Destroying oneself from grief.", quranUsage = "Bakha'a means to destroy oneself. 'Will you destroy (bakhi') yourself?'", notes = null),
      RootMeaningData(root = "ب-د-ر", primaryMeaning = "full moon, Badr", extendedMeaning = "Full moon, or the Battle of Badr.", quranUsage = "Badr (بدر) is the battle site. 'At Badr when you were few.'", notes = null),
      RootMeaningData(root = "ب-د-ن", primaryMeaning = "body, sacrificial camel", extendedMeaning = "Body, or large sacrificial animal.", quranUsage = "Badan (بدن) is body. 'Today We will save your body (badan).' Budn are sacrificial camels.", notes = null),
      RootMeaningData(root = "ب-ر-ح", primaryMeaning = "to depart, cease", extendedMeaning = "Departing, ceasing.", quranUsage = "Bariha means to cease. 'I will not cease (abrahu) until I reach.'", notes = null),
      RootMeaningData(root = "ب-ر-ز-خ", primaryMeaning = "barrier, isthmus", extendedMeaning = "A barrier between two things.", quranUsage = "Barzakh (برزخ) is barrier. 'Between them is a barzakh (barrier).' Also the realm after death.", notes = null),
      RootMeaningData(root = "ب-ر-ص", primaryMeaning = "leprosy", extendedMeaning = "Leprosy, skin disease.", quranUsage = "Abras (أبرص) is leper. 'I cure the abras (leper).'", notes = null),
      RootMeaningData(root = "ب-ر-م", primaryMeaning = "to twist, dislike", extendedMeaning = "Twisting, or disliking.", quranUsage = "Barima means to be weary. 'Have they decided (abramu) an affair?'", notes = null),
      RootMeaningData(root = "ب-ز-غ", primaryMeaning = "to rise, shine", extendedMeaning = "Rising, shining (of celestial bodies).", quranUsage = "Bazagha means to rise. 'When the sun rose (bazaghat).'", notes = null),
      RootMeaningData(root = "ب-س-ر", primaryMeaning = "to frown, unripe dates", extendedMeaning = "Frowning, or unripe dates.", quranUsage = "Basara means to frown. 'Then he frowned (basara).'", notes = null),
      RootMeaningData(root = "ب-س-س", primaryMeaning = "to crumble", extendedMeaning = "Crumbling.", quranUsage = "Bussat means crumbled. 'The mountains will be crumbled (bussat).'", notes = null),
      RootMeaningData(root = "ب-س-ق", primaryMeaning = "tall, lofty", extendedMeaning = "Tall, lofty.", quranUsage = "Basiqat (باسقات) are tall. 'Tall (basiqat) palm trees.'", notes = null),
      RootMeaningData(root = "ب-س-ل", primaryMeaning = "to give up, detained", extendedMeaning = "Being given up, detained for sin.", quranUsage = "Ubsilat means to be detained. 'A soul detained (ubsilat) for what it earned.'", notes = null),
      RootMeaningData(root = "ب-س-م", primaryMeaning = "to smile", extendedMeaning = "Smiling.", quranUsage = "Tabassama means to smile. 'He smiled (tabassama) laughing.'", notes = null),
      RootMeaningData(root = "ب-ص-ل", primaryMeaning = "onion", extendedMeaning = "Onion.", quranUsage = "Basal (بصل) is onion. 'Its herbs and onions (basal).'", notes = null),
      RootMeaningData(root = "ب-ط-أ", primaryMeaning = "to be slow", extendedMeaning = "Being slow, delayed.", quranUsage = "Bata'a means to be slow. 'Among you is one who is slow (yubatti').'", notes = null),
      RootMeaningData(root = "ب-ط-ر", primaryMeaning = "insolence, ingratitude", extendedMeaning = "Insolent ingratitude.", quranUsage = "Batira means to be insolent. 'They were insolent (batirat) in their living.'", notes = null),
      RootMeaningData(root = "ب-ع-ث-ر", primaryMeaning = "to scatter", extendedMeaning = "Scattering, overturning.", quranUsage = "Bu'thira means to be scattered. 'When graves are scattered (bu'thirat).'", notes = null),
      RootMeaningData(root = "ب-ع-ر", primaryMeaning = "dung, camel", extendedMeaning = "Camel dung.", quranUsage = "Ba'ir (بعير) is camel. 'A camel-load (ba'ir).'", notes = null),
      RootMeaningData(root = "ب-ق-ع", primaryMeaning = "spot, blessed place", extendedMeaning = "A spot, place.", quranUsage = "Buq'ah (بقعة) is spot. 'In the blessed buq'ah (spot).'", notes = null),
      RootMeaningData(root = "ب-ق-ل", primaryMeaning = "herbs, vegetables", extendedMeaning = "Herbs, vegetables.", quranUsage = "Baql (بقل) is herbs. 'Its herbs (baql) and cucumbers.'", notes = null),
      RootMeaningData(root = "ب-ل-س", primaryMeaning = "despair", extendedMeaning = "Despairing.", quranUsage = "Mublis (مبلس) is despairing. 'They will be in despair (mublisun).'", notes = null),
      RootMeaningData(root = "ب-ل-ع", primaryMeaning = "to swallow", extendedMeaning = "Swallowing.", quranUsage = "Bala'a means to swallow. 'O earth, swallow (ibla'i) your water.'", notes = null),
      RootMeaningData(root = "ب-ن-ن", primaryMeaning = "fingertips", extendedMeaning = "Fingertips.", quranUsage = "Banan (بنان) is fingertips. 'Strike their fingertips (banan).'", notes = null),
      RootMeaningData(root = "ب-ه-ج", primaryMeaning = "beauty, joy", extendedMeaning = "Beauty, joy.", quranUsage = "Bahij (بهيج) is beautiful. 'Pairs of every beautiful (bahij) kind.'", notes = null),
      RootMeaningData(root = "ب-ه-ل", primaryMeaning = "to curse, invoke", extendedMeaning = "Invoking curse, mutual imprecation.", quranUsage = "Mubahalah is mutual cursing. 'Let us invoke (nabtahil) and invoke Allah's curse.'", notes = null),
      RootMeaningData(root = "ب-ه-م", primaryMeaning = "cattle, beasts", extendedMeaning = "Cattle, livestock.", quranUsage = "Bahimah (بهيمة) is beast. 'Bahimah (beast) of cattle.'", notes = null),
      RootMeaningData(root = "ب-و-ر", primaryMeaning = "perish, ruin", extendedMeaning = "Perishing, destruction.", quranUsage = "Bur (بور) is ruin. 'A people destroyed (buran).'", notes = null),
      RootMeaningData(root = "ب-ي-د", primaryMeaning = "to perish", extendedMeaning = "Perishing, being destroyed.", quranUsage = "Bayda means to destroy. 'May it destroy (tubidu) them.'", notes = null),
      RootMeaningData(root = "ت-ب-ب", primaryMeaning = "perdition", extendedMeaning = "Perdition, ruin.", quranUsage = "Tabba means to perish. 'May the hands of Abu Lahab perish (tabbat).'", notes = null),
      RootMeaningData(root = "ت-ر-ق", primaryMeaning = "collarbone", extendedMeaning = "Collarbone.", quranUsage = "Taraqiy (تراقي) are collarbones. 'When it reaches the collarbones (taraqiy).'", notes = null),
      RootMeaningData(root = "ت-ع-س", primaryMeaning = "misery, destruction", extendedMeaning = "Misery, destruction.", quranUsage = "Ta'san (تعسا) is destruction. 'Destruction (ta'san) for them.'", notes = null),
      RootMeaningData(root = "ت-ف-ث", primaryMeaning = "dirt, unkemptness", extendedMeaning = "Dirt, the state of pilgrims.", quranUsage = "Tafath (تفث) is dirt. 'Let them end their tafath (unkemptness).'", notes = null),
      RootMeaningData(root = "ت-ق-ن", primaryMeaning = "to perfect", extendedMeaning = "Perfecting, doing well.", quranUsage = "Atqana means to perfect. 'The making of Allah who perfected (atqana).'", notes = null),
      RootMeaningData(root = "ت-ل-ل", primaryMeaning = "to throw down", extendedMeaning = "Throwing down on forehead.", quranUsage = "Talla means to throw down. 'He threw (tallahu) him on his forehead.'", notes = null),
      RootMeaningData(root = "ت-و-ر", primaryMeaning = "bowl, basin", extendedMeaning = "A bowl, basin.", quranUsage = "At-Tawr (التور) can be related to Mount Tur.", notes = null),
      RootMeaningData(root = "ت-ي-ه", primaryMeaning = "to wander, be lost", extendedMeaning = "Wandering, being lost.", quranUsage = "Taha means to wander. 'They will wander (yatihun) in the land.'", notes = null),
      RootMeaningData(root = "ث-ب-ر", primaryMeaning = "destruction", extendedMeaning = "Destruction, ruin.", quranUsage = "Thubur (ثبور) is destruction. 'They will call out destruction (thubura).'", notes = null),
      RootMeaningData(root = "ث-ب-ط", primaryMeaning = "to hold back", extendedMeaning = "Holding back, discouraging.", quranUsage = "Thabbata means to hold back. 'Allah held them back (thabbatahum).'", notes = null),
      RootMeaningData(root = "ث-ب-ي", primaryMeaning = "to anchor", extendedMeaning = "Anchoring, stabilizing.", quranUsage = "Related to being firm.", notes = null),
      RootMeaningData(root = "ث-ج-ج", primaryMeaning = "to pour abundantly", extendedMeaning = "Pouring abundantly.", quranUsage = "Thajjaj (ثجاج) is pouring. 'Water pouring (thajjajan) abundantly.'", notes = null),
      RootMeaningData(root = "ث-خ-ن", primaryMeaning = "to weaken, overcome", extendedMeaning = "Weakening through fighting.", quranUsage = "Athkhana means to overcome. 'Until he has overcome (yuthkhina) in the land.'", notes = null),
      RootMeaningData(root = "ث-ر-ب", primaryMeaning = "to blame", extendedMeaning = "Blaming, reproaching.", quranUsage = "Thariiba means no blame. 'No blame (tathrib) on you today.'", notes = null),
      RootMeaningData(root = "ث-ر-ي", primaryMeaning = "moist earth", extendedMeaning = "Moist earth.", quranUsage = "Thara (ثرى) is moist earth. 'What is in the moist earth (thara).'", notes = null),
      RootMeaningData(root = "ث-ق-ب", primaryMeaning = "to pierce, penetrate", extendedMeaning = "Piercing, penetrating.", quranUsage = "Thaqib (ثاقب) is piercing. 'A piercing (thaqib) flame.'", notes = null),
      RootMeaningData(root = "ث-ل-ل", primaryMeaning = "to destroy", extendedMeaning = "Destroying.", quranUsage = "Related to destruction.", notes = null),
      RootMeaningData(root = "ث-و-ر", primaryMeaning = "to rise, stir", extendedMeaning = "Rising up, stirring.", quranUsage = "Athara means to stir. 'Stirs up (tuthiru) the earth.'", notes = null),
      RootMeaningData(root = "ث-ي-ب", primaryMeaning = "previously married", extendedMeaning = "A woman previously married.", quranUsage = "Thayyib (ثيب) is previously married. 'Previously married (thayyibat) and virgins.'", notes = null),
      RootMeaningData(root = "ج-أ-ر", primaryMeaning = "to cry out, supplicate", extendedMeaning = "Crying out, supplicating loudly.", quranUsage = "Ja'ara means to cry out. 'You cry out (taj'arun) to Him.'", notes = null),
      RootMeaningData(root = "ج-ب-ب", primaryMeaning = "well, cistern", extendedMeaning = "A well, cistern.", quranUsage = "Jubb (جب) is well. 'Cast him into the bottom of the well (jubb).'", notes = null),
      RootMeaningData(root = "ج-ب-ت", primaryMeaning = "idol, false deity", extendedMeaning = "An idol, false deity.", quranUsage = "Jibt (جبت) is idol. 'They believe in jibt (idols).'", notes = null),
      RootMeaningData(root = "ج-ب-ن", primaryMeaning = "cowardice", extendedMeaning = "Cowardice.", quranUsage = "Related to being cowardly.", notes = null),
      RootMeaningData(root = "ج-ث-ث", primaryMeaning = "to uproot", extendedMeaning = "Uprooting.", quranUsage = "Ijtuthat means uprooted. 'Its root uprooted (ijtuthat).'", notes = null),
      RootMeaningData(root = "ج-ث-م", primaryMeaning = "to fall prostrate", extendedMeaning = "Falling down lifeless.", quranUsage = "Jathim means fallen. 'They became fallen (jathimin).'", notes = null),
      RootMeaningData(root = "ج-د-ث", primaryMeaning = "grave", extendedMeaning = "A grave.", quranUsage = "Ajdath (أجداث) are graves. 'They come out from the graves (ajdath).'", notes = null),
      RootMeaningData(root = "ج-د-ر", primaryMeaning = "wall", extendedMeaning = "A wall.", quranUsage = "Jidar (جدار) is wall. 'A wall (jidar) about to collapse.'", notes = null),
      RootMeaningData(root = "ج-ذ-ذ", primaryMeaning = "to cut into pieces", extendedMeaning = "Cutting into pieces.", quranUsage = "Judhadhan means pieces. 'He made them into pieces (judhadhan).'", notes = null),
      RootMeaningData(root = "ج-ذ-و", primaryMeaning = "firebrand", extendedMeaning = "A burning piece of wood.", quranUsage = "Jadhwah (جذوة) is firebrand. 'A firebrand (jadhwah) to warm.'", notes = null),
      RootMeaningData(root = "ج-ر-ر", primaryMeaning = "to drag, pull", extendedMeaning = "Dragging, pulling.", quranUsage = "Jarra means to drag. Related to dragging.", notes = null),
      RootMeaningData(root = "ج-ر-ز", primaryMeaning = "barren land", extendedMeaning = "Barren land without vegetation.", quranUsage = "Juruz (جرز) is barren. 'A barren (juruz) land.'", notes = null),
      RootMeaningData(root = "ج-ر-ع", primaryMeaning = "to swallow, gulp", extendedMeaning = "Swallowing, gulping.", quranUsage = "Yatajarra'u means to gulp. 'He gulps (yatajarra'uhu) it.'", notes = null),
      RootMeaningData(root = "ج-ر-ف", primaryMeaning = "to sweep away", extendedMeaning = "Sweeping away.", quranUsage = "Juruf (جرف) is edge. 'On the edge (juruf) of a crumbling bank.'", notes = null),
      RootMeaningData(root = "ج-ز-أ", primaryMeaning = "part, piece", extendedMeaning = "A part, piece.", quranUsage = "Juz' (جزء) is part. 'For each gate a part (juz') of them.'", notes = null),
      RootMeaningData(root = "ج-س-د", primaryMeaning = "body", extendedMeaning = "A body, corpse.", quranUsage = "Jasad (جسد) is body. 'A body (jasad) without soul.'", notes = null),
      RootMeaningData(root = "ج-س-س", primaryMeaning = "to spy", extendedMeaning = "Spying.", quranUsage = "Tajassasu means to spy. 'Do not spy (tajassasu).'", notes = null),
      RootMeaningData(root = "ج-س-م", primaryMeaning = "body, physical", extendedMeaning = "Body, physical form.", quranUsage = "Jism (جسم) is body. 'Increased him in body (jism) and knowledge.'", notes = null),
      RootMeaningData(root = "ج-ف-أ", primaryMeaning = "to carry away (foam)", extendedMeaning = "Carrying away as foam.", quranUsage = "Jufa' (جفاء) is foam. 'The foam (jufa') goes away.'", notes = null),
      RootMeaningData(root = "ج-ف-و", primaryMeaning = "to leave, forsake", extendedMeaning = "Leaving, forsaking.", quranUsage = "Tatajafa means to leave. 'Their sides leave (tatajafa) beds.'", notes = null),
      RootMeaningData(root = "ج-ل-ب", primaryMeaning = "to bring, incite", extendedMeaning = "Bringing, inciting.", quranUsage = "Ajlib means to gather. 'Gather (ajlib) against them.'", notes = null),
      RootMeaningData(root = "ج-ل-و", primaryMeaning = "to reveal, clear", extendedMeaning = "Revealing, clearing.", quranUsage = "Jala means to clear. 'When it clears (jallaha).'", notes = null),
      RootMeaningData(root = "ج-م-ح", primaryMeaning = "to be headstrong", extendedMeaning = "Being headstrong, rushing.", quranUsage = "Jamaha means to rush. 'They rush (yajmahun) headlong.'", notes = null),
      RootMeaningData(root = "ج-م-م", primaryMeaning = "to gather", extendedMeaning = "Gathering, being abundant.", quranUsage = "Jamm (جم) is abundant. 'You love wealth with abundant (jamman) love.'", notes = null),
      RootMeaningData(root = "ج-ن-ف", primaryMeaning = "to incline unjustly", extendedMeaning = "Inclining to injustice.", quranUsage = "Janaf (جنف) is inclination. 'Fearing inclination (janaf) to sin.'", notes = null),
      RootMeaningData(root = "ج-ه-ز", primaryMeaning = "to prepare", extendedMeaning = "Preparing, equipping.", quranUsage = "Jahhaza means to equip. 'When he equipped (jahhazahum) them.'", notes = null),
      RootMeaningData(root = "ج-و-ز", primaryMeaning = "to pass, cross", extendedMeaning = "Passing through.", quranUsage = "Jawaza means to pass. 'We let pass (jawazna) the Children of Israel.'", notes = null),
      RootMeaningData(root = "ج-و-س", primaryMeaning = "to search, traverse", extendedMeaning = "Searching, traversing.", quranUsage = "Jasu means to traverse. 'They traversed (jasu) through the land.'", notes = null),
      RootMeaningData(root = "ج-و-ف", primaryMeaning = "cavity, hollow", extendedMeaning = "Cavity, interior.", quranUsage = "Jawf (جوف) is interior. 'In his interior (jawf) two hearts.'", notes = null),
      RootMeaningData(root = "ج-ي-ب", primaryMeaning = "pocket, collar", extendedMeaning = "Pocket, collar opening.", quranUsage = "Jayb (جيب) is pocket. 'Put your hand in your jayb (pocket).' Also collar.", notes = null),
      RootMeaningData(root = "ج-ي-د", primaryMeaning = "neck", extendedMeaning = "Neck.", quranUsage = "Jid (جيد) is neck. 'Around her jid (neck) a rope.'", notes = null),

      // === FINAL BATCH FOR 100% COVERAGE ===
      RootMeaningData(root = "ح-ب-س", primaryMeaning = "to confine, detain", extendedMeaning = "Confining, detaining.", quranUsage = "Habasa means to confine. 'Detain (tahbisuna) them.'", notes = null),
      RootMeaningData(root = "ح-ت-م", primaryMeaning = "to decree, determine", extendedMeaning = "Decreeing, determining.", quranUsage = "Hatm is decree. 'It is a decree (hatman) decided.'", notes = null),
      RootMeaningData(root = "ح-ث-ث", primaryMeaning = "to urge, hasten", extendedMeaning = "Urging, hastening.", quranUsage = "Haththa means to urge.", notes = null),
      RootMeaningData(root = "ح-ج-ز", primaryMeaning = "barrier, to prevent", extendedMeaning = "A barrier, preventing.", quranUsage = "Hajiz is barrier. 'Preventing (hajiz) them.'", notes = null),
      RootMeaningData(root = "ح-د-ق", primaryMeaning = "to surround, eye", extendedMeaning = "Surrounding, or the pupil.", quranUsage = "Hadaqa means to stare. Hadiqah is garden.", notes = null),
      RootMeaningData(root = "ح-ر-د", primaryMeaning = "anger, determination", extendedMeaning = "Anger or determination.", quranUsage = "Hard (حرد) is determination. 'They went early with hard (determination).'", notes = null),
      RootMeaningData(root = "ح-ر-س", primaryMeaning = "to guard", extendedMeaning = "Guarding.", quranUsage = "Harasa means to guard. Haras are guards.", notes = null),
      RootMeaningData(root = "ح-ر-ض", primaryMeaning = "to incite, urge", extendedMeaning = "Inciting, urging.", quranUsage = "Harrada means to urge. 'Urge (harrid) the believers.'", notes = null),
      RootMeaningData(root = "ح-ر-ي", primaryMeaning = "worthy, fitting", extendedMeaning = "Being worthy or fitting.", quranUsage = "Hariyy (حري) is worthy.", notes = null),
      RootMeaningData(root = "ح-س-م", primaryMeaning = "to cut off, decide", extendedMeaning = "Cutting off, decisive.", quranUsage = "Husum (حسوم) is continuous. 'Seven nights, continuous (husum).'", notes = null),
      RootMeaningData(root = "ح-ص-ح-ص", primaryMeaning = "to become clear", extendedMeaning = "Becoming clear, manifest.", quranUsage = "Hashasa means to become clear. 'Now the truth has become clear (hashasa).'", notes = null),
      RootMeaningData(root = "ح-ص-ل", primaryMeaning = "to obtain, result", extendedMeaning = "Obtaining, resulting.", quranUsage = "Hussila means to be brought out. 'What is in the chests is brought out (hussila).'", notes = null),
      RootMeaningData(root = "ح-ض-ض", primaryMeaning = "to urge, encourage", extendedMeaning = "Urging, encouraging.", quranUsage = "Hadda means to urge. 'You do not urge (tahadduna) feeding the poor.'", notes = null),
      RootMeaningData(root = "ح-ط-ب", primaryMeaning = "firewood", extendedMeaning = "Firewood.", quranUsage = "Hatab (حطب) is firewood. 'Carrier of firewood (hatab).'", notes = null),
      RootMeaningData(root = "ح-ط-ط", primaryMeaning = "to put down, remove", extendedMeaning = "Putting down, removing burden.", quranUsage = "Hatta means to remove. 'Remove (hittah) from us.'", notes = null),
      RootMeaningData(root = "ح-ظ-ر", primaryMeaning = "to forbid, enclosure", extendedMeaning = "Forbidding, enclosure.", quranUsage = "Hazir (حظير) is enclosure. 'Like uprooted trunks of palm trees.'", notes = null),
      RootMeaningData(root = "ح-ف-د", primaryMeaning = "grandchildren, hasten", extendedMeaning = "Grandchildren, or hastening.", quranUsage = "Hafadah (حفدة) are grandchildren. 'Sons and grandchildren (hafadah).'", notes = null),
      RootMeaningData(root = "ح-ف-ر", primaryMeaning = "to dig", extendedMeaning = "Digging.", quranUsage = "Hafara means to dig. Hafirah is pit.", notes = null),
      RootMeaningData(root = "ح-ف-ف", primaryMeaning = "to surround", extendedMeaning = "Surrounding.", quranUsage = "Haffa means to surround. 'Surrounded (hafin) by angels.'", notes = null),
      RootMeaningData(root = "ح-ف-و", primaryMeaning = "barefoot, eager", extendedMeaning = "Barefoot, or being eager.", quranUsage = "Hafiy (حفي) is well-informed. 'As if you were eager (hafiy) about it.'", notes = null),
      RootMeaningData(root = "ح-ق-ب", primaryMeaning = "long time, era", extendedMeaning = "A long period of time.", quranUsage = "Huqub (حقب) is a long time. 'For ages (ahqaban).'", notes = null),
      RootMeaningData(root = "ح-ق-ف", primaryMeaning = "sand dune", extendedMeaning = "Sand dune.", quranUsage = "Ahqaf (أحقاف) are sand dunes. Surah 46.", notes = null),
      RootMeaningData(root = "ح-ل-ق", primaryMeaning = "to shave, ring", extendedMeaning = "Shaving, or a ring.", quranUsage = "Halaqa means to shave. 'Shaving (muhaliqin) your heads.'", notes = null),
      RootMeaningData(root = "ح-ن-ث", primaryMeaning = "to break oath, sin", extendedMeaning = "Breaking an oath, sin.", quranUsage = "Hinth (حنث) is great sin. 'They persisted in the great sin (hinth).'", notes = null),
      RootMeaningData(root = "ح-ن-ذ", primaryMeaning = "to roast", extendedMeaning = "Roasting meat.", quranUsage = "Hanidh (حنيذ) is roasted. 'A roasted (hanidh) calf.'", notes = null),
      RootMeaningData(root = "ح-ن-ن", primaryMeaning = "tenderness, compassion", extendedMeaning = "Tenderness, compassion.", quranUsage = "Hanan (حنان) is tenderness. 'Compassion (hananan) from Us.'", notes = null),
      RootMeaningData(root = "ح-و-ب", primaryMeaning = "sin", extendedMeaning = "Sin, especially great sin.", quranUsage = "Hub (حوب) is sin. 'It is ever a great sin (huban).'", notes = null),
      RootMeaningData(root = "ح-و-ج", primaryMeaning = "need", extendedMeaning = "Need, poverty.", quranUsage = "Hajah (حاجة) is need. 'No need (hajah) in their hearts.'", notes = null),
      RootMeaningData(root = "ح-و-ذ", primaryMeaning = "to surround, possess", extendedMeaning = "Surrounding, possessing.", quranUsage = "Istawhadha means to gain control.", notes = null),
      RootMeaningData(root = "ح-و-ز", primaryMeaning = "to take aside", extendedMeaning = "Taking aside.", quranUsage = "Tahawwaza means to take aside. 'Or taking aside (mutahayyizan).'", notes = null),
      RootMeaningData(root = "ح-و-ش", primaryMeaning = "to gather", extendedMeaning = "Gathering.", quranUsage = "Mahshur is gathered.", notes = null),
      RootMeaningData(root = "ح-و-ي", primaryMeaning = "to gather, contain", extendedMeaning = "Gathering, containing.", quranUsage = "Hawa means to gather. Hawaya is intestines.", notes = null),
      RootMeaningData(root = "ح-ي-د", primaryMeaning = "to deviate, turn aside", extendedMeaning = "Deviating, turning aside.", quranUsage = "Hada means to turn aside. 'Turning aside (yahid).'", notes = null),
      RootMeaningData(root = "ح-ي-ف", primaryMeaning = "injustice", extendedMeaning = "Injustice.", quranUsage = "Hayf (حيف) is injustice. 'Fearing injustice (yahifa).'", notes = null),
      RootMeaningData(root = "خ-ب-أ", primaryMeaning = "to hide", extendedMeaning = "Hiding.", quranUsage = "Khab' is hidden. 'Hidden (khabaya) treasure.'", notes = null),
      RootMeaningData(root = "خ-ب-ت", primaryMeaning = "to be humble", extendedMeaning = "Being humble.", quranUsage = "Akhbata means to be humble. 'Those who humble (akhbatu) themselves.'", notes = null),
      RootMeaningData(root = "خ-ب-ط", primaryMeaning = "to strike, confuse", extendedMeaning = "Striking, confusion.", quranUsage = "Takhabatahu means to confuse. 'Satan confuses (yatakhabbatuhu) him.'", notes = null),
      RootMeaningData(root = "خ-ب-ل", primaryMeaning = "to corrupt, confuse", extendedMeaning = "Corruption, confusion.", quranUsage = "Khabal (خبال) is corruption. 'They would increase you in corruption (khabal).'", notes = null),
      RootMeaningData(root = "خ-ب-و", primaryMeaning = "to subside", extendedMeaning = "Subsiding, dying down.", quranUsage = "Khabat means to subside. 'Whenever it subsides (khabat).'", notes = null),
      RootMeaningData(root = "خ-ت-ر", primaryMeaning = "to betray", extendedMeaning = "Treacherous betrayal.", quranUsage = "Khattar is treacherous.", notes = null),
      RootMeaningData(root = "خ-د-د", primaryMeaning = "to dig, cheek", extendedMeaning = "Digging a trench, or cheek.", quranUsage = "Ukhdud (أخدود) is trench. 'Companions of the ukhdud (trench).'", notes = null),
      RootMeaningData(root = "خ-د-ن", primaryMeaning = "friend, companion", extendedMeaning = "Secret friend.", quranUsage = "Akhdan (أخدان) are secret friends. 'Not taking secret friends (akhdan).'", notes = null),
      RootMeaningData(root = "خ-ر-ب", primaryMeaning = "to ruin", extendedMeaning = "Ruining.", quranUsage = "Khariba means to be ruined. 'They ruin (yukhribuna) their houses.'", notes = null),
      RootMeaningData(root = "خ-ر-د-ل", primaryMeaning = "mustard seed", extendedMeaning = "Mustard seed.", quranUsage = "Khardal (خردل) is mustard. 'A mustard seed (khardal).'", notes = null),
      RootMeaningData(root = "خ-ر-ط-م", primaryMeaning = "nose, snout", extendedMeaning = "Nose, snout.", quranUsage = "Khurtum (خرطوم) is nose. 'We will brand him on the nose (khurtum).'", notes = null),
      RootMeaningData(root = "خ-ص-ف", primaryMeaning = "to patch, cover", extendedMeaning = "Patching, covering.", quranUsage = "Yakhsifan means to patch. 'They patch (yakhsifan) over themselves.'", notes = null),
      RootMeaningData(root = "خ-ض-د", primaryMeaning = "to bend", extendedMeaning = "Bending, cut.", quranUsage = "Khud means bent. 'Among thornless lote trees (makhdhud).'", notes = null),
      RootMeaningData(root = "خ-ط-ط", primaryMeaning = "to draw, write", extendedMeaning = "Drawing, writing.", quranUsage = "Khatt (خط) is writing. 'You could not write (takhutt) it.'", notes = null),
      RootMeaningData(root = "خ-ل-ع", primaryMeaning = "to remove, divorce", extendedMeaning = "Removing.", quranUsage = "Ikhla' means to remove. 'Remove (ikhla') your sandals.'", notes = null),
      RootMeaningData(root = "خ-م-د", primaryMeaning = "to subside, die out", extendedMeaning = "Subsiding, dying out.", quranUsage = "Khamada means to die out. Khamidun are extinct.", notes = null),
      RootMeaningData(root = "خ-م-ص", primaryMeaning = "hunger, empty", extendedMeaning = "Hunger, empty stomach.", quranUsage = "Khamsah is hunger. Makhmasa is hunger.", notes = null),
      RootMeaningData(root = "خ-م-ط", primaryMeaning = "bitter plant", extendedMeaning = "A bitter plant.", quranUsage = "Khamt (خمط) is bitter. 'Bitter fruit (ukul khamt).'", notes = null),
      RootMeaningData(root = "خ-ن-س", primaryMeaning = "to withdraw, hide", extendedMeaning = "Withdrawing, hiding.", quranUsage = "Khannas (خناس) is the whisperer who withdraws.", notes = null),
      RootMeaningData(root = "خ-ن-ق", primaryMeaning = "to strangle", extendedMeaning = "Strangling.", quranUsage = "Munkhaniqa is strangled. 'The strangled (munkhaniqah).'", notes = null),
      RootMeaningData(root = "خ-و-ر", primaryMeaning = "to low, weak", extendedMeaning = "Lowing (of cattle), or weak.", quranUsage = "Khuwar (خوار) is lowing. 'A calf body with a lowing (khuwar) sound.'", notes = null),
      RootMeaningData(root = "خ-ي-م", primaryMeaning = "tent", extendedMeaning = "Tent.", quranUsage = "Khiyam (خيام) are tents. 'In tents (khiyam).'", notes = null),
      RootMeaningData(root = "د-ث-ر", primaryMeaning = "to wrap", extendedMeaning = "Wrapping.", quranUsage = "Muddaththir (مدثر) is one wrapped. Surah 74.", notes = null),
      RootMeaningData(root = "د-ح-و", primaryMeaning = "to spread out", extendedMeaning = "Spreading out.", quranUsage = "Dahaha means to spread. 'The earth He spread (dahaha).'", notes = null),
      RootMeaningData(root = "د-ر-ه-م", primaryMeaning = "dirham, coin", extendedMeaning = "A silver coin.", quranUsage = "Darahim are dirhams. 'A few dirhams (darahim).'", notes = null),
      RootMeaningData(root = "د-س-ر", primaryMeaning = "to push, plank", extendedMeaning = "Pushing, or planks.", quranUsage = "Dusur (دسر) are planks. 'Planks (alwah) and dusur (nails).'", notes = null),
      RootMeaningData(root = "د-س-س", primaryMeaning = "to bury, hide", extendedMeaning = "Burying, hiding.", quranUsage = "Dassa means to bury. 'He who corrupts (dassaha) it.'", notes = null),
      RootMeaningData(root = "د-س-و", primaryMeaning = "to make impure", extendedMeaning = "Making impure, corrupting.", quranUsage = "Dassa means to corrupt.", notes = null),
      RootMeaningData(root = "د-ع-ع", primaryMeaning = "to push, repulse", extendedMeaning = "Pushing away.", quranUsage = "Yadu'u means to push. 'Repulses (yadu'u) the orphan.'", notes = null),
      RootMeaningData(root = "د-ف-أ", primaryMeaning = "warmth", extendedMeaning = "Warmth.", quranUsage = "Dif' (دفء) is warmth. 'In them is warmth (dif').'", notes = null),
      RootMeaningData(root = "د-ف-ق", primaryMeaning = "to gush forth", extendedMeaning = "Gushing forth.", quranUsage = "Dafiq (دافق) is gushing. 'Gushing (dafiq) water.'", notes = null),
      RootMeaningData(root = "د-ل-ك", primaryMeaning = "to rub, sunset", extendedMeaning = "Rubbing, or sunset.", quranUsage = "Duluk (دلوك) is decline. 'From the decline (duluk) of the sun.'", notes = null),
      RootMeaningData(root = "د-م-د-م", primaryMeaning = "to destroy", extendedMeaning = "Complete destruction.", quranUsage = "Damdama means to destroy. 'Their Lord destroyed (damdama) them.'", notes = null),
      RootMeaningData(root = "د-م-ع", primaryMeaning = "tears", extendedMeaning = "Tears.", quranUsage = "Dam' (دمع) is tears. 'Overflowing with tears (dam').'", notes = null),
      RootMeaningData(root = "د-م-غ", primaryMeaning = "to crush the skull", extendedMeaning = "Crushing.", quranUsage = "Yadmaghu means to crush. 'To crush (fayadmaghuhu) it.'", notes = null),
      RootMeaningData(root = "د-ن-ر", primaryMeaning = "dinar, gold coin", extendedMeaning = "A gold coin.", quranUsage = "Dinar (دينار) is gold coin.", notes = null),
      RootMeaningData(root = "د-ه-ق", primaryMeaning = "to pour", extendedMeaning = "Pouring.", quranUsage = "Dihaq (دهاق) is overflowing. 'A cup overflowing (dihaq).'", notes = null),
      RootMeaningData(root = "د-ه-م", primaryMeaning = "dark green", extendedMeaning = "Dark green.", quranUsage = "Mudhammatani are dark green. 'Dark green (mudhammatani).'", notes = null),
      RootMeaningData(root = "د-ه-ي", primaryMeaning = "calamity", extendedMeaning = "Great calamity.", quranUsage = "Dahiya is calamity. 'The great calamity (dahiya).'", notes = null),
      RootMeaningData(root = "د-و-ل", primaryMeaning = "to rotate, state", extendedMeaning = "Rotating, circulating.", quranUsage = "Dawlah (دولة) is circulation. 'Not circulating (dulatan) among the rich.'", notes = null),
      RootMeaningData(root = "ذ-أ-ب", primaryMeaning = "wolf", extendedMeaning = "Wolf.", quranUsage = "Dhi'b (ذئب) is wolf. 'The wolf (dhi'b) ate him.'", notes = null),
      RootMeaningData(root = "ذ-أ-م", primaryMeaning = "to blame", extendedMeaning = "Blaming.", quranUsage = "Madhum is blamed. 'Blameworthy (madhuman).'", notes = null),
      RootMeaningData(root = "ذ-ب-ذ-ب", primaryMeaning = "to waver", extendedMeaning = "Wavering.", quranUsage = "Muthadhdhidin are wavering. 'Wavering (muthadhdhidin) between.'", notes = null),
      RootMeaningData(root = "ذ-خ-ر", primaryMeaning = "to store", extendedMeaning = "Storing, saving.", quranUsage = "Adkhara means to store. 'What you stored (taddakhirun).'", notes = null),
      RootMeaningData(root = "ذ-ع-ن", primaryMeaning = "to submit", extendedMeaning = "Submitting obediently.", quranUsage = "Mudh'inun are submissive. 'Submissive (mudh'inin).'", notes = null),
      RootMeaningData(root = "ذ-ق-ن", primaryMeaning = "chin", extendedMeaning = "Chin, beard.", quranUsage = "Adhqan (أذقان) are chins. 'Fall on their chins (adhqan).'", notes = null),
      RootMeaningData(root = "ذ-ك-و", primaryMeaning = "to slaughter properly", extendedMeaning = "Proper slaughter.", quranUsage = "Dhakkaha means to slaughter. 'Except what you slaughter (dhakkaytum).'", notes = null),
      RootMeaningData(root = "ذ-و-د", primaryMeaning = "to drive away", extendedMeaning = "Driving away.", quranUsage = "Tadhudan means to drive away. 'Two women driving (tadhudani).'", notes = null),
      RootMeaningData(root = "ذ-ي-ع", primaryMeaning = "to spread news", extendedMeaning = "Spreading news.", quranUsage = "Adha'u means to spread. 'They spread (adha'u) it.'", notes = null),
      RootMeaningData(root = "ر-ت-ع", primaryMeaning = "to graze, enjoy", extendedMeaning = "Grazing, enjoying.", quranUsage = "Yarta'u means to enjoy. 'Play and enjoy (yarta').'", notes = null),
      RootMeaningData(root = "ر-ت-ق", primaryMeaning = "to close up, join", extendedMeaning = "Closing, joining.", quranUsage = "Ratq is joined. 'They were joined (ratqan).'", notes = null),
      RootMeaningData(root = "ر-ج-ج", primaryMeaning = "to shake violently", extendedMeaning = "Violent shaking.", quranUsage = "Rajja means to shake. 'The earth is shaken (rujjat).'", notes = null),
      RootMeaningData(root = "ر-ح-ق", primaryMeaning = "sealed wine", extendedMeaning = "Sealed nectar.", quranUsage = "Rahiq (رحيق) is nectar. 'Sealed nectar (rahiq makhtum).'", notes = null),
      RootMeaningData(root = "ر-د-أ", primaryMeaning = "helper, support", extendedMeaning = "Helper, support.", quranUsage = "Rid' (ردء) is helper. 'As a helper (rid'an).'", notes = null),
      RootMeaningData(root = "ر-د-ف", primaryMeaning = "to follow", extendedMeaning = "Following, successive.", quranUsage = "Murdif means following. 'Followed (murdifin) by a thousand.'", notes = null),
      RootMeaningData(root = "ر-د-م", primaryMeaning = "to fill, barrier", extendedMeaning = "Filling, barrier.", quranUsage = "Radm (ردم) is barrier. 'Shall I make a barrier (radm)?'", notes = null),
      RootMeaningData(root = "ر-س-س", primaryMeaning = "well", extendedMeaning = "A well.", quranUsage = "Rass (رس) is a well. 'Companions of the Rass.'", notes = null),
      RootMeaningData(root = "ر-غ-د", primaryMeaning = "plentiful, comfortable", extendedMeaning = "Plentiful, comfortable.", quranUsage = "Raghadan (رغدا) is plentifully. 'Eat plentifully (raghadan).'", notes = null),
      RootMeaningData(root = "ر-غ-م", primaryMeaning = "dust, despite", extendedMeaning = "Dust, or despite.", quranUsage = "Raghama means to humble. 'Wide (muragham).'", notes = null),
      RootMeaningData(root = "ر-ف-ت", primaryMeaning = "crumbled particles", extendedMeaning = "Crumbled particles.", quranUsage = "Rufat (رفات) are particles. 'Bones and crumbled particles (rufatan).'", notes = null),
      RootMeaningData(root = "ر-ف-ث", primaryMeaning = "sexual talk, intimacy", extendedMeaning = "Sexual intimacy.", quranUsage = "Rafath (رفث) is intimacy. 'No rafath (intimacy) during Hajj.'", notes = null),
      RootMeaningData(root = "ر-ف-د", primaryMeaning = "to support, gift", extendedMeaning = "Supporting, gift.", quranUsage = "Rifd (رفد) is support. 'Evil is the support (rifd).'", notes = null),
      RootMeaningData(root = "ر-ف-ر-ف", primaryMeaning = "cushions", extendedMeaning = "Green cushions.", quranUsage = "Rafarif (رفارف) are cushions. 'Green cushions (rafarif).'", notes = null),
      RootMeaningData(root = "ر-ك-د", primaryMeaning = "to be still", extendedMeaning = "Being still.", quranUsage = "Rawakid are still. 'Ships still (rawakid).'", notes = null),
      RootMeaningData(root = "ر-ك-ز", primaryMeaning = "sound, hidden", extendedMeaning = "Faint sound.", quranUsage = "Rikz (ركز) is faint sound. 'Any faint sound (rikzan).'", notes = null),
      RootMeaningData(root = "ر-ك-س", primaryMeaning = "to return to evil", extendedMeaning = "Returning to evil.", quranUsage = "Arkasa means to turn back. 'Allah turned them back (arkasahum).'", notes = null),
      RootMeaningData(root = "ر-ك-ض", primaryMeaning = "to strike with foot", extendedMeaning = "Striking, running.", quranUsage = "Rurkud means to run. 'When they were running (yarkudun).'", notes = null),
      RootMeaningData(root = "ر-ك-م", primaryMeaning = "to heap up", extendedMeaning = "Heaping up.", quranUsage = "Rukam (ركام) is heaped. 'Heaped clouds (rukam).'", notes = null),
      RootMeaningData(root = "ر-م-د", primaryMeaning = "ashes", extendedMeaning = "Ashes.", quranUsage = "Ramad (رماد) is ashes. 'Like ashes (ramad).'", notes = null),
      RootMeaningData(root = "ر-م-ز", primaryMeaning = "to signal", extendedMeaning = "Signaling.", quranUsage = "Ramz (رمز) is signal. 'Except by signal (ramzan).'", notes = null),
      RootMeaningData(root = "ر-م-ض", primaryMeaning = "Ramadan, heat", extendedMeaning = "Ramadan, heat.", quranUsage = "Ramadan (رمضان) is the fasting month.", notes = null),
      RootMeaningData(root = "ر-م-م", primaryMeaning = "decayed", extendedMeaning = "Decayed bones.", quranUsage = "Ramim (رميم) is decayed. 'Bones decayed (ramim).'", notes = null),
      RootMeaningData(root = "ر-ه-ط", primaryMeaning = "group, clan", extendedMeaning = "A group, clan.", quranUsage = "Raht (رهط) is clan. 'Your clan (rahtuka) is powerful.'", notes = null),
      RootMeaningData(root = "ر-ه-ن", primaryMeaning = "pledge, hostage", extendedMeaning = "Pledge, mortgage.", quranUsage = "Rahn (رهن) is pledge. 'A pledge (rihan) taken.'", notes = null),
      RootMeaningData(root = "ر-ه-و", primaryMeaning = "calm, still", extendedMeaning = "Calm, parted.", quranUsage = "Rahw (رهو) is calm. 'Leave the sea calm (rahwan).'", notes = null),
      RootMeaningData(root = "ر-و-ض", primaryMeaning = "garden, meadow", extendedMeaning = "Garden, meadow.", quranUsage = "Rawdah (روضة) is garden. 'In a garden (rawdah).'", notes = null),
      RootMeaningData(root = "ر-و-ع", primaryMeaning = "fear, alarm", extendedMeaning = "Fear, alarm.", quranUsage = "Raw' (روع) is fear. 'When fear (raw') left Ibrahim.'", notes = null),
      RootMeaningData(root = "ر-و-غ", primaryMeaning = "to turn aside", extendedMeaning = "Turning aside, evading.", quranUsage = "Ragha means to turn aside. 'He turned (raga) to them.'", notes = null),
      RootMeaningData(root = "ر-ي-ش", primaryMeaning = "feathers, finery", extendedMeaning = "Feathers, adornment.", quranUsage = "Rish (ريش) is feathers. 'Adornment (rishan).'", notes = null),
      RootMeaningData(root = "ر-ي-ع", primaryMeaning = "elevated place", extendedMeaning = "Elevated place, sign.", quranUsage = "Ri' (ريع) is elevated place. 'On every elevated place (ri').'", notes = null),
      RootMeaningData(root = "ر-ي-ن", primaryMeaning = "rust, covering", extendedMeaning = "Rust, covering the heart.", quranUsage = "Rana means to cover. 'Covered (rana) their hearts.'", notes = null),
      RootMeaningData(root = "ز-ب-ن", primaryMeaning = "guards of Hell", extendedMeaning = "Guards.", quranUsage = "Zabaniyah (زبانية) are guards of Hell.", notes = null),
      RootMeaningData(root = "ز-ج-و", primaryMeaning = "to drive", extendedMeaning = "Driving.", quranUsage = "Yazji means to drive. 'Drives (yazji) clouds.'", notes = null),
      RootMeaningData(root = "ز-ح-ز-ح", primaryMeaning = "to remove", extendedMeaning = "Removing.", quranUsage = "Zuhziha means to be removed. 'Removed (zuhziha) from Hell.'", notes = null),
      RootMeaningData(root = "ز-ر-ب", primaryMeaning = "pen, enclosure", extendedMeaning = "Pen for animals.", quranUsage = "Zarabiy (زرابي) are carpets. 'Rich carpets (zarabiy).'", notes = null),
      RootMeaningData(root = "ز-ر-ي", primaryMeaning = "to despise", extendedMeaning = "Despising.", quranUsage = "Tazri means to despise. 'You despise (tazri) them.'", notes = null),
      RootMeaningData(root = "ز-ف-ف", primaryMeaning = "to hasten", extendedMeaning = "Hastening.", quranUsage = "Yaziffun means to hasten. 'Hastening (yaziffun).'", notes = null),
      RootMeaningData(root = "ز-ق-م", primaryMeaning = "Zaqqum tree", extendedMeaning = "A tree in Hell.", quranUsage = "Zaqqum (زقوم) is the tree in Hell. 'The tree of Zaqqum.'", notes = null),
      RootMeaningData(root = "ز-ل-ق", primaryMeaning = "to slip", extendedMeaning = "Slipping.", quranUsage = "Zalaq is slippery. 'Slippery (zalaqan) ground.'", notes = null),
      RootMeaningData(root = "ز-ل-م", primaryMeaning = "divining arrows", extendedMeaning = "Divining arrows.", quranUsage = "Azlam (أزلام) are divining arrows.", notes = null),
      RootMeaningData(root = "ز-م-ر", primaryMeaning = "groups, flocks", extendedMeaning = "Groups, flocks.", quranUsage = "Zumar (زمر) are groups. 'In groups (zumaran).'", notes = "Surah 39 is Az-Zumar."),
      RootMeaningData(root = "ز-م-ل", primaryMeaning = "to wrap", extendedMeaning = "Wrapping.", quranUsage = "Muzzammil (مزمل) is one wrapped. Surah 73.", notes = null),
      RootMeaningData(root = "ز-م-ه-ر", primaryMeaning = "extremely cold", extendedMeaning = "Extreme cold.", quranUsage = "Zamharir (زمهرير) is extreme cold.", notes = null),
      RootMeaningData(root = "ز-ن-م", primaryMeaning = "base-born, ignoble", extendedMeaning = "Base-born.", quranUsage = "Zanim (زنيم) is base-born. 'A base-born (zanim).'", notes = null),
      RootMeaningData(root = "ز-ه-ر", primaryMeaning = "flower, splendor", extendedMeaning = "Flower, splendor.", quranUsage = "Zahrah (زهرة) is splendor. 'The splendor (zahrata) of the world.'", notes = null),
      RootMeaningData(root = "ز-و-د", primaryMeaning = "provisions", extendedMeaning = "Provisions for journey.", quranUsage = "Zad (زاد) is provision. 'Take provisions (zad).'", notes = null),
      RootMeaningData(root = "س-أ-م", primaryMeaning = "to become weary", extendedMeaning = "Weariness.", quranUsage = "Sa'ima means to be weary. 'They do not weary (yas'amun).'", notes = null),
      RootMeaningData(root = "س-ب-أ", primaryMeaning = "Sheba", extendedMeaning = "Sheba (kingdom).", quranUsage = "Saba' (سبأ) is Sheba. Surah 34.", notes = null),
      RootMeaningData(root = "س-ب-غ", primaryMeaning = "ample, complete", extendedMeaning = "Ample, complete.", quranUsage = "Sabighat are full. 'Full-length (sabighat) coats of armor.'", notes = null),
      RootMeaningData(root = "س-ج-ر", primaryMeaning = "to heat, fill", extendedMeaning = "Heating, filling.", quranUsage = "Sujjirat means kindled. 'The seas are set ablaze (sujjirat).'", notes = null),
      RootMeaningData(root = "س-ج-و", primaryMeaning = "to be still", extendedMeaning = "Being still.", quranUsage = "Saja means to become still. 'When the night covers (saja).'", notes = null),
      RootMeaningData(root = "س-ح-ق", primaryMeaning = "to crush, far", extendedMeaning = "Crushing, or being far.", quranUsage = "Suhuq (سحيق) is distant. 'A distant (sahiq) place.'", notes = null),
      RootMeaningData(root = "س-ح-ل", primaryMeaning = "coast, shore", extendedMeaning = "Coast, shore.", quranUsage = "Sahil (ساحل) is coast. Related to coastal areas.", notes = null),
      RootMeaningData(root = "س-د-ي", primaryMeaning = "neglected", extendedMeaning = "Neglected, without purpose.", quranUsage = "Suda (سدى) is neglected. 'Left neglected (sudan).'", notes = null),
      RootMeaningData(root = "س-ر-ب-ل", primaryMeaning = "garment", extendedMeaning = "Garment, coat.", quranUsage = "Saraabil are garments. 'Garments (saraabil).'", notes = null),
      RootMeaningData(root = "س-ر-د", primaryMeaning = "to link, armor", extendedMeaning = "Linking armor rings.", quranUsage = "Sard (سرد) is linked. 'Link (qaddir) the rings.'", notes = null),
      RootMeaningData(root = "س-ر-د-ق", primaryMeaning = "tent, canopy", extendedMeaning = "Tent, pavilion.", quranUsage = "Suradiq (سرادق) is canopy. 'Its canopy (suradiquha) surrounds.'", notes = null),
      RootMeaningData(root = "س-ر-م-د", primaryMeaning = "everlasting", extendedMeaning = "Everlasting, perpetual.", quranUsage = "Sarmadan is perpetual. 'Night perpetual (sarmadan).'", notes = null),
      RootMeaningData(root = "س-ط-و", primaryMeaning = "to assault", extendedMeaning = "Assaulting, attacking.", quranUsage = "Yastuna means to assault. 'They almost assault (yastuna).'", notes = null),
      RootMeaningData(root = "س-ع-د", primaryMeaning = "happiness", extendedMeaning = "Happiness, blessedness.", quranUsage = "Su'ida means to be happy. 'Those who are blessed (su'idu).'", notes = null),
      RootMeaningData(root = "س-غ-ب", primaryMeaning = "hunger", extendedMeaning = "Hunger.", quranUsage = "Masghaba (مسغبة) is hunger. 'A day of hunger (masghaba).'", notes = null),
      RootMeaningData(root = "س-ف-ع", primaryMeaning = "forelock, to seize", extendedMeaning = "Seizing by forelock.", quranUsage = "Nasfa' means to seize. 'We will seize (lanasfa'an) the forelock.'", notes = null),
      RootMeaningData(root = "س-ف-ك", primaryMeaning = "to shed blood", extendedMeaning = "Shedding blood.", quranUsage = "Yasfiku means to shed. 'Sheds (yasfiku) blood.'", notes = null),
      RootMeaningData(root = "س-ق-م", primaryMeaning = "illness", extendedMeaning = "Illness, disease.", quranUsage = "Saqim (سقيم) is ill. 'I am ill (saqim).'", notes = null),
      RootMeaningData(root = "س-ك-ب", primaryMeaning = "to pour", extendedMeaning = "Pouring.", quranUsage = "Maskub is poured. 'Water poured (maskub).'", notes = null),
      RootMeaningData(root = "س-ك-ت", primaryMeaning = "to be silent", extendedMeaning = "Being silent.", quranUsage = "Sakata means to be silent. 'When anger subsided (sakata).'", notes = null),
      RootMeaningData(root = "س-ل-ب", primaryMeaning = "to strip, snatch", extendedMeaning = "Stripping, snatching.", quranUsage = "Yaslubu means to snatch. 'If a fly snatches (yaslubu).'", notes = null),
      RootMeaningData(root = "س-ل-خ", primaryMeaning = "to strip off", extendedMeaning = "Stripping off.", quranUsage = "Naslakhu means to strip. 'We strip (naslakhu) from it the night.'", notes = null),
      RootMeaningData(root = "س-ل-ق", primaryMeaning = "to wound with tongue", extendedMeaning = "Harsh speech.", quranUsage = "Salaqukum means to assault. 'With sharp tongues (salaqukum).'", notes = null),
      RootMeaningData(root = "س-ل-و", primaryMeaning = "quail", extendedMeaning = "Quail.", quranUsage = "Salwa (سلوى) is quail. 'The manna and salwa (quail).'", notes = null),
      RootMeaningData(root = "س-م-د", primaryMeaning = "to hold head high", extendedMeaning = "Holding head high in pride.", quranUsage = "Samidun are haughty. 'Haughty (samidun).'", notes = null),
      RootMeaningData(root = "س-م-ك", primaryMeaning = "to raise, ceiling", extendedMeaning = "Raising, ceiling.", quranUsage = "Samk (سمك) is structure. 'Its structure (samkaha).'", notes = null),
      RootMeaningData(root = "س-ن-د", primaryMeaning = "to lean, prop", extendedMeaning = "Leaning, support.", quranUsage = "Musannadah are propped. 'Propped (musannadah) pieces of wood.'", notes = null),
      RootMeaningData(root = "س-ن-م", primaryMeaning = "camel hump", extendedMeaning = "Camel hump.", quranUsage = "Sanam (سنام) is hump. Related to high status.", notes = null),
      RootMeaningData(root = "س-ه-ر", primaryMeaning = "to stay awake", extendedMeaning = "Staying awake at night.", quranUsage = "Sahirah (ساهرة) is wide awake. 'On an open plain (sahirah).'", notes = null),
      RootMeaningData(root = "س-ه-م", primaryMeaning = "arrow, share", extendedMeaning = "Arrow, lot, share.", quranUsage = "Sahm (سهم) is lot. Related to drawing lots.", notes = null),
      RootMeaningData(root = "س-و-ح", primaryMeaning = "to travel", extendedMeaning = "Traveling.", quranUsage = "Siha means to travel. 'Travel (sihu) in the land.'", notes = null),
      RootMeaningData(root = "س-و-ط", primaryMeaning = "whip", extendedMeaning = "Whip.", quranUsage = "Sawt (سوط) is whip. 'Poured upon them a whip (sawta) of punishment.'", notes = null),
      RootMeaningData(root = "س-ي-ب", primaryMeaning = "camel let loose", extendedMeaning = "Camel let loose for idols.", quranUsage = "Sa'ibah (سائبة) is she-camel let loose.", notes = null),
      RootMeaningData(root = "س-ي-ح", primaryMeaning = "to travel, flow", extendedMeaning = "Traveling, flowing.", quranUsage = "Siha means to travel. 'Travel (sihu) four months.'", notes = null),
      RootMeaningData(root = "ش-أ-م", primaryMeaning = "left, ill-omen", extendedMeaning = "Left side, ill-omen.", quranUsage = "Ash'am is ill-fated. 'Most ill-fated (ash'aha).'", notes = null),
      RootMeaningData(root = "ش-ح-م", primaryMeaning = "fat", extendedMeaning = "Fat.", quranUsage = "Shahm (شحم) is fat. 'Their fat (shuhumahuma).'", notes = null),
      RootMeaningData(root = "ش-ح-ن", primaryMeaning = "to load a ship", extendedMeaning = "Loading a ship.", quranUsage = "Mashun is laden. 'The laden (mashun) ship.'", notes = null),
      RootMeaningData(root = "ش-خ-ص", primaryMeaning = "person, stare", extendedMeaning = "Person, staring.", quranUsage = "Shakhisa means to stare. 'Their eyes staring (shakhisah).'", notes = null),
      RootMeaningData(root = "ش-ر-د", primaryMeaning = "to scatter, disperse", extendedMeaning = "Scattering.", quranUsage = "Sharrida means to disperse. 'Disperse (sharrid) with them.'", notes = null),
      RootMeaningData(root = "ش-ر-ذ-م", primaryMeaning = "small group", extendedMeaning = "Small group.", quranUsage = "Shirdhimah (شرذمة) is small group.", notes = null),
      RootMeaningData(root = "ش-ر-ط", primaryMeaning = "condition, sign", extendedMeaning = "Condition, sign.", quranUsage = "Ashrat (أشراط) are signs. 'Its signs (ashratuha) have come.'", notes = null),
      RootMeaningData(root = "ش-ط-أ", primaryMeaning = "shore, bank", extendedMeaning = "Shore, bank.", quranUsage = "Shati' (شاطئ) is bank. 'On the bank (shati') of the valley.'", notes = null),
      RootMeaningData(root = "ش-ط-ط", primaryMeaning = "to go too far", extendedMeaning = "Going to excess.", quranUsage = "Shatat (شطط) is excess. 'We said excessively (shatatan).'", notes = null),
      RootMeaningData(root = "ش-ع-ل", primaryMeaning = "to kindle, flame", extendedMeaning = "Kindling, flaming.", quranUsage = "Ishta'ala means to kindle. 'My head has kindled (ishta'ala) with gray.'", notes = null),
      RootMeaningData(root = "ش-غ-ف", primaryMeaning = "to infatuate", extendedMeaning = "Infatuating.", quranUsage = "Shaghafa means to infatuate. 'He has infatuated (shaghafaha) her.'", notes = null),
      RootMeaningData(root = "ش-غ-ل", primaryMeaning = "to occupy, busy", extendedMeaning = "Occupying, keeping busy.", quranUsage = "Shughul (شغل) is occupation. 'In occupation (shughul).'", notes = null),
      RootMeaningData(root = "ش-ف-و", primaryMeaning = "edge, brink", extendedMeaning = "Edge, brink.", quranUsage = "Shafa (شفا) is edge. 'On the edge (shafa) of a pit.'", notes = null),
      RootMeaningData(root = "ش-ك-س", primaryMeaning = "quarrelsome, difficult", extendedMeaning = "Quarrelsome partners.", quranUsage = "Mutashakisun are quarrelsome. 'Quarrelsome (mutashakisun) partners.'", notes = null),
      RootMeaningData(root = "ش-م-ت", primaryMeaning = "to gloat", extendedMeaning = "Gloating.", quranUsage = "Tushmit means to make gloat. 'Do not let enemies gloat (tushmit).'", notes = null),
      RootMeaningData(root = "ش-م-خ", primaryMeaning = "high, lofty", extendedMeaning = "High, lofty.", quranUsage = "Shamikh is lofty. 'Lofty (shamikhat) mountains.'", notes = null),
      RootMeaningData(root = "ش-م-ز", primaryMeaning = "to shrink, recoil", extendedMeaning = "Shrinking in disgust.", quranUsage = "Ishma'azzat means to shrink. 'Their hearts shrink (ishma'azzat).'", notes = null),
      RootMeaningData(root = "ش-ن-أ", primaryMeaning = "to hate", extendedMeaning = "Hatred.", quranUsage = "Shana'ana is hatred. 'Let not hatred (shana'anu) make you unjust.'", notes = null),
      RootMeaningData(root = "ش-و-ب", primaryMeaning = "to mix", extendedMeaning = "Mixing.", quranUsage = "Shawb (شوب) is mixture. 'A mixture (shawban) of boiling water.'", notes = null),
      RootMeaningData(root = "ش-و-ظ", primaryMeaning = "flame", extendedMeaning = "Flame without smoke.", quranUsage = "Shuwaz (شواظ) is flame. 'A flame (shuwaz) of fire.'", notes = null),
      RootMeaningData(root = "ش-ي-ب", primaryMeaning = "gray hair, old age", extendedMeaning = "Gray hair, old age.", quranUsage = "Shayb (شيب) is gray hair. 'My head has kindled with gray (shayban).'", notes = null),
      RootMeaningData(root = "ش-ي-د", primaryMeaning = "to plaster, build high", extendedMeaning = "Plastering, building high.", quranUsage = "Mushayyadah is fortified. 'Fortified (mushayyadah) towers.'", notes = null),
      RootMeaningData(root = "ص-ب-أ", primaryMeaning = "Sabians", extendedMeaning = "Sabians (religious group).", quranUsage = "Sabi'un (صابئون) are Sabians.", notes = null),
      RootMeaningData(root = "ص-ب-ع", primaryMeaning = "finger", extendedMeaning = "Finger.", quranUsage = "Asabi' (أصابع) are fingers. 'Their fingers (asabi'ahum) in their ears.'", notes = null),
      RootMeaningData(root = "ص-ب-و", primaryMeaning = "to incline, youth", extendedMeaning = "Inclining to youth.", quranUsage = "Saba means to incline. 'I might incline (asbu) to them.'", notes = null),
      RootMeaningData(root = "ص-خ-خ", primaryMeaning = "deafening blast", extendedMeaning = "Deafening blast.", quranUsage = "Sakhkhah (صاخة) is deafening blast. 'The deafening blast (sakhkhah).'", notes = null),
      RootMeaningData(root = "ص-ر-ع", primaryMeaning = "to knock down", extendedMeaning = "Knocking down.", quranUsage = "Sar'a is felled. 'As if felled (munqa'ir) palm trunks.'", notes = null),
      RootMeaningData(root = "ص-ر-م", primaryMeaning = "to cut, harvest", extendedMeaning = "Cutting, harvesting.", quranUsage = "Sarim (صريم) is harvested. 'Like a garden harvested (sarim).'", notes = null),
      RootMeaningData(root = "ص-ع-ر", primaryMeaning = "to turn cheek", extendedMeaning = "Turning cheek in arrogance.", quranUsage = "Tusa'ir means to turn. 'Do not turn (tusa'ir) your cheek.'", notes = null),
      RootMeaningData(root = "ص-غ-و", primaryMeaning = "to incline", extendedMeaning = "Inclining.", quranUsage = "Saghat means to incline. 'Their hearts inclined (saghat).'", notes = null),
      RootMeaningData(root = "ص-ف-د", primaryMeaning = "to bind, fetter", extendedMeaning = "Binding, fettering.", quranUsage = "Asfad (أصفاد) are chains. 'In chains (asfad).'", notes = null),
      RootMeaningData(root = "ص-ف-ص-ف", primaryMeaning = "level plain", extendedMeaning = "Level plain.", quranUsage = "Safsaf (صفصف) is level. 'A level plain (safsafan).'", notes = null),
      RootMeaningData(root = "ص-ف-ن", primaryMeaning = "standing horse", extendedMeaning = "Horse standing on three legs.", quranUsage = "Safinat (صافنات) are standing horses.", notes = null),
      RootMeaningData(root = "ص-ك-ك", primaryMeaning = "to strike", extendedMeaning = "Striking.", quranUsage = "Sakkat means to strike. 'She struck (sakkat) her face.'", notes = null),
      RootMeaningData(root = "ص-ل-د", primaryMeaning = "smooth rock", extendedMeaning = "Smooth, hard rock.", quranUsage = "Saldan (صلدا) is smooth rock. 'Smooth rock (saldan).'", notes = null),
      RootMeaningData(root = "ص-م-ع", primaryMeaning = "small-eared", extendedMeaning = "Small-eared, monastery.", quranUsage = "Sawami' (صوامع) are monasteries.", notes = null),
      RootMeaningData(root = "ص-ن-و", primaryMeaning = "palm tree offshoots", extendedMeaning = "Palm tree offshoots.", quranUsage = "Sinwan (صنوان) are offshoots. 'Offshoots (sinwan) and single.'", notes = null),
      RootMeaningData(root = "ص-و-ع", primaryMeaning = "measure, cup", extendedMeaning = "Measuring cup.", quranUsage = "Suwa' (صواع) is cup. 'The king's cup (suwa').'", notes = null),
      RootMeaningData(root = "ص-ي-ص", primaryMeaning = "fortress", extendedMeaning = "Fortress.", quranUsage = "Sayasi (صياصي) are fortresses. 'From their fortresses (sayasihim).'", notes = null),
      RootMeaningData(root = "ض-أ-ن", primaryMeaning = "sheep", extendedMeaning = "Sheep.", quranUsage = "Da'n (ضأن) is sheep. 'Of the sheep (da'n) two.'", notes = null),
      RootMeaningData(root = "ض-ب-ح", primaryMeaning = "panting", extendedMeaning = "Panting, snorting.", quranUsage = "Dabh (ضبح) is panting. 'Panting (dabhan).'", notes = null),
      RootMeaningData(root = "ض-د-د", primaryMeaning = "enemy, opponent", extendedMeaning = "Enemy, opponent.", quranUsage = "Diddan (ضدا) is opponent. 'Be opponents (diddan).'", notes = null),
      RootMeaningData(root = "ض-غ-ث", primaryMeaning = "bunch, confused dreams", extendedMeaning = "Bunch, confused dreams.", quranUsage = "Adghath (أضغاث) are confused dreams. 'Confused dreams (adghath).'", notes = null),
      RootMeaningData(root = "ض-غ-ن", primaryMeaning = "grudge, malice", extendedMeaning = "Grudge, malice.", quranUsage = "Adghaan (أضغان) are grudges. 'What is in your hearts of grudges (adghanakum).'", notes = null),
      RootMeaningData(root = "ض-م-ر", primaryMeaning = "lean, thin", extendedMeaning = "Lean (from journey).", quranUsage = "Damir (ضامر) is lean. 'On every lean (damir) camel.'", notes = null),
      RootMeaningData(root = "ض-م-م", primaryMeaning = "to join, embrace", extendedMeaning = "Joining, embracing.", quranUsage = "Idmum means to join. 'Join (udmum) to yourself.'", notes = null),
      RootMeaningData(root = "ض-ن-ك", primaryMeaning = "straitened, hard", extendedMeaning = "Straitened life.", quranUsage = "Dank (ضنك) is straitened. 'A straitened (dankan) life.'", notes = null),
      RootMeaningData(root = "ض-ن-ن", primaryMeaning = "to be stingy", extendedMeaning = "Being stingy.", quranUsage = "Danin (ضنين) is stingy. 'Not stingy (danin).'", notes = null),
      RootMeaningData(root = "ض-ه-أ", primaryMeaning = "barren", extendedMeaning = "Barren woman.", quranUsage = "Dahiya is barren.", notes = null),
      RootMeaningData(root = "ض-ي-ر", primaryMeaning = "harm", extendedMeaning = "Harm.", quranUsage = "Dayr (ضير) is harm. 'No harm (dayr) upon us.'", notes = null),
      RootMeaningData(root = "ض-ي-ز", primaryMeaning = "unjust", extendedMeaning = "Unjust division.", quranUsage = "Diza (ضيزى) is unjust. 'An unjust (diza) division.'", notes = null),
      RootMeaningData(root = "ط-ح-و", primaryMeaning = "to spread out", extendedMeaning = "Spreading out.", quranUsage = "Tahaha means to spread. 'The earth He spread (tahaha).'", notes = null),
      RootMeaningData(root = "ط-ر-و", primaryMeaning = "fresh, tender", extendedMeaning = "Fresh, tender.", quranUsage = "Tariy (طري) is fresh. 'Fresh (tariyyan) meat.'", notes = null),
      RootMeaningData(root = "ط-ع-ن", primaryMeaning = "to stab, criticize", extendedMeaning = "Stabbing, criticizing.", quranUsage = "Ta'ana means to criticize. 'Criticize (ta'anu) your religion.'", notes = null),
      RootMeaningData(root = "ط-ف-أ", primaryMeaning = "to extinguish", extendedMeaning = "Extinguishing.", quranUsage = "Taffa means to extinguish. 'They want to extinguish (yutfi'u).'", notes = null),
      RootMeaningData(root = "ط-ف-ق", primaryMeaning = "to begin", extendedMeaning = "Beginning continuously.", quranUsage = "Tafiqa means to begin. 'They began (tafiqa) patching.'", notes = null),
      RootMeaningData(root = "ط-ل-ح", primaryMeaning = "banana tree", extendedMeaning = "Banana tree.", quranUsage = "Talh (طلح) is banana. 'And banana trees (talh) layered.'", notes = null),
      RootMeaningData(root = "ط-ل-ل", primaryMeaning = "dew, fine rain", extendedMeaning = "Fine rain.", quranUsage = "Tall (طل) is fine rain. 'Fine rain (tall).'", notes = null),
      RootMeaningData(root = "ط-م-ث", primaryMeaning = "to touch", extendedMeaning = "Touching (euphemism for intercourse).", quranUsage = "Yatmith means to touch. 'No human has touched (yatmithhunna) them.'", notes = null),
      RootMeaningData(root = "ط-م-م", primaryMeaning = "to cover, overwhelm", extendedMeaning = "Overwhelming.", quranUsage = "Tammah (طامة) is overwhelming. 'The great overwhelming (tammah).'", notes = null),
      RootMeaningData(root = "ط-و-د", primaryMeaning = "mountain", extendedMeaning = "Mountain.", quranUsage = "Tawd (طود) is mountain. 'Like a mountain (tawd).'", notes = null),
      RootMeaningData(root = "ظ-ع-ن", primaryMeaning = "to travel", extendedMeaning = "Traveling, setting out.", quranUsage = "Za'n (ظعن) is traveling. 'On the day of your travel (za'nikum).'", notes = null),
      RootMeaningData(root = "ظ-م-أ", primaryMeaning = "thirst", extendedMeaning = "Thirst.", quranUsage = "Zama' (ظمأ) is thirst. 'No thirst (zama').'", notes = null),
      RootMeaningData(root = "ع-ب-أ", primaryMeaning = "to care, matter", extendedMeaning = "Caring, giving importance.", quranUsage = "Ya'ba'u means to care. 'What would my Lord care (ya'ba'u)?'", notes = null),
      RootMeaningData(root = "ع-ب-ث", primaryMeaning = "to play, jest", extendedMeaning = "Playing, jesting.", quranUsage = "'Abath (عبث) is play. 'We created you in play ('abathan)?'", notes = null),
      RootMeaningData(root = "ع-ب-س", primaryMeaning = "to frown", extendedMeaning = "Frowning.", quranUsage = "'Abasa means to frown. 'He frowned ('abasa).' Surah 80.", notes = null),
      RootMeaningData(root = "ع-ب-ق-ر", primaryMeaning = "rich carpets", extendedMeaning = "Rich carpets.", quranUsage = "'Abqariy (عبقري) are rich carpets.", notes = null),
      RootMeaningData(root = "ع-ت-ل", primaryMeaning = "cruel, harsh", extendedMeaning = "Cruel, harsh person.", quranUsage = "'Utul (عتل) is cruel. 'Cruel ('utul), moreover base-born.'", notes = null),
      RootMeaningData(root = "ع-ث-ر", primaryMeaning = "to stumble, find", extendedMeaning = "Stumbling upon, finding.", quranUsage = "'Athara means to find. 'If it is found ('uthira) that they deserve.'", notes = null),
      RootMeaningData(root = "ع-ج-ف", primaryMeaning = "lean, thin", extendedMeaning = "Lean, thin (cattle).", quranUsage = "'Ijaf (عجاف) are lean. 'Seven lean ('ijaf) cows.'", notes = null),
      RootMeaningData(root = "ع-د-س", primaryMeaning = "lentils", extendedMeaning = "Lentils.", quranUsage = "'Adas (عدس) is lentils. 'Its lentils ('adas).'", notes = null),
      RootMeaningData(root = "ع-ر-ج-ن", primaryMeaning = "dry palm stalk", extendedMeaning = "Dry, curved palm stalk.", quranUsage = "'Urjun (عرجون) is old palm stalk. 'Like an old palm stalk ('urjun).'", notes = null),
      RootMeaningData(root = "ع-ر-ر", primaryMeaning = "mange, scabies", extendedMeaning = "Skin disease.", quranUsage = "Related to nakedness.", notes = null),
      RootMeaningData(root = "ع-ر-م", primaryMeaning = "dam, flood", extendedMeaning = "Dam, flood.", quranUsage = "'Arim (عرم) is dam. 'The flood of the dam ('arim).'", notes = null),
      RootMeaningData(root = "ع-ر-و", primaryMeaning = "to happen, befall", extendedMeaning = "Happening.", quranUsage = "'Urwah (عروة) is handhold. 'The firmest handhold ('urwah).'", notes = null),
      RootMeaningData(root = "ع-ز-ب", primaryMeaning = "to be absent", extendedMeaning = "Being absent, hidden.", quranUsage = "Ya'zubu means to be absent. 'Not absent (ya'zubu) from Him.'", notes = null),
      RootMeaningData(root = "ع-ز-ر", primaryMeaning = "to help, honor", extendedMeaning = "Helping, honoring.", quranUsage = "'Azzara means to honor. 'Honor ('azzaruhu) and help him.'", notes = null),
      RootMeaningData(root = "ع-ز-و", primaryMeaning = "to ascribe, attribute", extendedMeaning = "Ascribing.", quranUsage = "'Izin are groups. 'In separate groups ('izin).'", notes = null),
      RootMeaningData(root = "ع-س-ع-س", primaryMeaning = "to darken, approach", extendedMeaning = "Darkness approaching.", quranUsage = "'As'asa means to darken. 'When the night darkens ('as'as).'", notes = null),
      RootMeaningData(root = "ع-ض-د", primaryMeaning = "upper arm, support", extendedMeaning = "Upper arm, support.", quranUsage = "'Adud (عضد) is support. 'I did not take them as support ('adudan).'", notes = null),
      RootMeaningData(root = "ع-ض-ض", primaryMeaning = "to bite", extendedMeaning = "Biting.", quranUsage = "'Adda means to bite. 'Biting ('adda) his hands.'", notes = null),
      RootMeaningData(root = "ع-ض-ل", primaryMeaning = "to prevent marriage", extendedMeaning = "Preventing from marriage.", quranUsage = "Ta'duluhunna means to prevent. 'Do not prevent (ta'duluhunna) them.'", notes = null),
      RootMeaningData(root = "ع-ض-و", primaryMeaning = "limb, member", extendedMeaning = "Limb, member.", quranUsage = "'Idin is portions. 'Into portions ('idin).'", notes = null),
      RootMeaningData(root = "ع-ط-ف", primaryMeaning = "to turn, incline", extendedMeaning = "Turning, inclining.", quranUsage = "'Atafa means to turn. 'Turning ('atafa) his side.'", notes = null),
      RootMeaningData(root = "ع-ط-ل", primaryMeaning = "to disable, neglect", extendedMeaning = "Disabling, neglecting.", quranUsage = "'Uttilat means disabled. 'The camels disabled ('uttilat).'", notes = null),
      RootMeaningData(root = "ع-ف-ر", primaryMeaning = "dust", extendedMeaning = "Dust.", quranUsage = "'Afar is dust. Related to dust.", notes = null),
      RootMeaningData(root = "ع-ن-و", primaryMeaning = "to submit, appear", extendedMeaning = "Submitting, appearing.", quranUsage = "'Anat means to submit. 'Faces will submit ('anat).'", notes = null),
      RootMeaningData(root = "ع-ه-ن", primaryMeaning = "colored wool", extendedMeaning = "Colored wool.", quranUsage = "'Ihn (عهن) is wool. 'Like colored wool ('ihn).'", notes = null),
      RootMeaningData(root = "ع-و-ق", primaryMeaning = "to hinder", extendedMeaning = "Hindering.", quranUsage = "Mu'awwiqin are hinderers. 'Those who hinder (mu'awwiqin).'", notes = null),
      RootMeaningData(root = "ع-و-ل", primaryMeaning = "to support, wail", extendedMeaning = "Supporting dependents.", quranUsage = "Ta'ulu means to be unjust. 'Closer to not being unjust (ta'ulu).'", notes = null),
      RootMeaningData(root = "ع-ي-ب", primaryMeaning = "defect, fault", extendedMeaning = "Defect, fault.", quranUsage = "'Ayb is defect. 'I wanted to defect ('a'ibaha) it.'", notes = null),
      RootMeaningData(root = "ع-ي-ر", primaryMeaning = "caravan, donkey", extendedMeaning = "Caravan, donkey.", quranUsage = "'Ir (عير) is caravan. 'Ask the caravan ('ir).'", notes = null),
      RootMeaningData(root = "ع-ي-ل", primaryMeaning = "family, dependents", extendedMeaning = "Family, dependents.", quranUsage = "'A'ala means to have dependents. 'Fearing poverty ('aylah).'", notes = null),
      RootMeaningData(root = "ع-ي-ي", primaryMeaning = "to be unable", extendedMeaning = "Being unable, incapable.", quranUsage = "'Ayiya means to be unable. 'We were not unable ('ayiyna).'", notes = null),
      RootMeaningData(root = "غ-ب-ن", primaryMeaning = "to deceive, cheat", extendedMeaning = "Deceiving, cheating.", quranUsage = "Taghabun (تغابن) is mutual loss/deception. Surah 64.", notes = null),
      RootMeaningData(root = "غ-ث-و", primaryMeaning = "to help, relieve", extendedMeaning = "Helping, relieving.", quranUsage = "Yughithu means to help. Related to ghawth (help).", notes = null),
      RootMeaningData(root = "غ-د-ق", primaryMeaning = "abundant water", extendedMeaning = "Abundant water.", quranUsage = "Ghadaqan (غدقا) is abundant. 'Abundant (ghadaqan) water.'", notes = null),
      RootMeaningData(root = "غ-ر-و", primaryMeaning = "wonder, glue", extendedMeaning = "Wonder.", quranUsage = "La gharwa means no wonder. 'No wonder (gharwa).'", notes = null),
      RootMeaningData(root = "غ-ز-و", primaryMeaning = "to raid, invade", extendedMeaning = "Raiding, invading.", quranUsage = "Ghazw is raid. 'Those who raid (ghuzzan).'", notes = null),
      RootMeaningData(root = "غ-ص-ب", primaryMeaning = "to seize by force", extendedMeaning = "Seizing by force.", quranUsage = "Ghasb is seizing. 'Seizes (ya'khudhu) by force.'", notes = null),
      RootMeaningData(root = "غ-ص-ص", primaryMeaning = "to choke", extendedMeaning = "Choking.", quranUsage = "Ghussah (غصة) is choking. 'Food that chokes (ghussah).'", notes = null),
      RootMeaningData(root = "غ-ط-ش", primaryMeaning = "darkness", extendedMeaning = "Darkness.", quranUsage = "Aghtas means to darken. 'Its night (aghtasha).'", notes = null),
      RootMeaningData(root = "غ-ط-و", primaryMeaning = "to cover", extendedMeaning = "Covering.", quranUsage = "Ghashiya/yughshi means to cover.", notes = null),
      RootMeaningData(root = "غ-ل-ف", primaryMeaning = "uncircumcised, covering", extendedMeaning = "Covering, sheath.", quranUsage = "Ghulf (غلف) are covered. 'Our hearts are covered (ghulf).'", notes = null),
      RootMeaningData(root = "غ-ل-و", primaryMeaning = "to exceed, exaggerate", extendedMeaning = "Exceeding bounds.", quranUsage = "Ghuluww (غلو) is excess. 'Do not exceed (taghlu) in religion.'", notes = null),
      RootMeaningData(root = "غ-م-ز", primaryMeaning = "to wink, signal", extendedMeaning = "Winking, signaling.", quranUsage = "Yataghamazun means to wink. 'They wink (yataghamazun).'", notes = null),
      RootMeaningData(root = "غ-م-ض", primaryMeaning = "to close eyes, overlook", extendedMeaning = "Closing eyes, overlooking.", quranUsage = "Tughmidu means to overlook. 'Unless you overlook (tughmidu).'", notes = null),
      RootMeaningData(root = "غ-و-ص", primaryMeaning = "to dive", extendedMeaning = "Diving.", quranUsage = "Ghawwas is diver. 'Divers (ghawwasin).'", notes = null),
      RootMeaningData(root = "غ-و-ط", primaryMeaning = "depth", extendedMeaning = "Depth.", quranUsage = "Ghawt (غوط) is depth.", notes = null),
      RootMeaningData(root = "غ-و-ل", primaryMeaning = "to destroy", extendedMeaning = "Destroying, headache.", quranUsage = "Ghawl (غول) is headache/intoxication. 'No ghawl (ill effect).'", notes = null),
      RootMeaningData(root = "غ-ي-ض", primaryMeaning = "to decrease, subside", extendedMeaning = "Decreasing, subsiding.", quranUsage = "Ghada means to decrease. 'The water subsided (ghida).'", notes = null),
      RootMeaningData(root = "ف-ت-أ", primaryMeaning = "to cease", extendedMeaning = "Ceasing.", quranUsage = "Tafta'u means to cease. 'You will not cease (tafta'u).'", notes = null),
      RootMeaningData(root = "ف-ت-ر", primaryMeaning = "to slacken", extendedMeaning = "Slackening, weakening.", quranUsage = "Yafturu means to slacken. 'They do not slacken (yafturun).'", notes = null),
      RootMeaningData(root = "ف-ت-ق", primaryMeaning = "to split", extendedMeaning = "Splitting.", quranUsage = "Fataq is split. 'We split (fataqnahuma) them.'", notes = null),
      RootMeaningData(root = "ف-ت-ل", primaryMeaning = "to twist", extendedMeaning = "Twisting.", quranUsage = "Fatil (فتيل) is thread. 'A thread (fatilan).'", notes = null),
      RootMeaningData(root = "ف-ج-ج", primaryMeaning = "mountain pass", extendedMeaning = "Mountain pass, road.", quranUsage = "Fajj (فج) is road. 'From every distant road (fajj).'", notes = null),
      RootMeaningData(root = "ف-ج-و", primaryMeaning = "opening, gap", extendedMeaning = "Opening, gap.", quranUsage = "Fajwah (فجوة) is open space. 'In an open space (fajwah).'", notes = null),
      RootMeaningData(root = "ف-ر-ت", primaryMeaning = "to crush, crumble", extendedMeaning = "Crushing, crumbling.", quranUsage = "Farat is scattered. Related to scattering.", notes = null),
      RootMeaningData(root = "ف-ر-ث", primaryMeaning = "excrement", extendedMeaning = "Excrement in the belly.", quranUsage = "Farth (فرث) is excrement. 'Between excrement (farth) and blood.'", notes = null),
      RootMeaningData(root = "ف-ر-ه", primaryMeaning = "skilled, proud", extendedMeaning = "Skillful, proud.", quranUsage = "Farihin are proud. 'Skillful (farihin).'", notes = null),
      RootMeaningData(root = "ف-ز-ز", primaryMeaning = "to disturb, excite", extendedMeaning = "Disturbing, exciting.", quranUsage = "Istafziz means to disturb. 'Disturb (astafziz) whom you can.'", notes = null),
      RootMeaningData(root = "ف-س-ح", primaryMeaning = "to make room", extendedMeaning = "Making room.", quranUsage = "Tafsahu means to make room. 'Make room (tafsahu).'", notes = null),
      RootMeaningData(root = "ف-ص-ح", primaryMeaning = "to speak clearly", extendedMeaning = "Speaking clearly.", quranUsage = "Afsahu means clearer. 'He is clearer (afsahu) in speech.'", notes = null),
      RootMeaningData(root = "ف-ص-م", primaryMeaning = "to break", extendedMeaning = "Breaking.", quranUsage = "Infisam is breaking. 'No break (infisam).'", notes = null),
      RootMeaningData(root = "ف-ض-ح", primaryMeaning = "to expose, disgrace", extendedMeaning = "Exposing, disgracing.", quranUsage = "Tafdhahuni means to disgrace. 'Do not disgrace (tafdhahuni) me.'", notes = null),
      RootMeaningData(root = "ف-ض-و", primaryMeaning = "to be empty", extendedMeaning = "Being empty.", quranUsage = "Afda means to turn. 'They turn away (afdaw).'", notes = null),
      RootMeaningData(root = "ف-ظ-ظ", primaryMeaning = "harsh, rude", extendedMeaning = "Harsh, rude.", quranUsage = "Fazz (فظ) is harsh. 'If you were harsh (fazzan).'", notes = null),
      RootMeaningData(root = "ف-ق-ع", primaryMeaning = "bright yellow", extendedMeaning = "Bright yellow.", quranUsage = "Faqi' (فاقع) is bright. 'Bright (faqi') yellow.'", notes = null),
      RootMeaningData(root = "ف-ل-ن", primaryMeaning = "so and so", extendedMeaning = "So and so.", quranUsage = "Fulan (فلان) is so and so. 'I had not taken so and so (fulanan).'", notes = null),
      RootMeaningData(root = "ف-ن-د", primaryMeaning = "to weaken, belie", extendedMeaning = "Weakening in mind.", quranUsage = "Tufannidun means to accuse. 'You accuse me (tufannidun).'", notes = null),
      RootMeaningData(root = "ف-ن-ن", primaryMeaning = "varieties, branches", extendedMeaning = "Varieties, branches.", quranUsage = "Afnan (أفنان) are branches. 'With spreading branches (afnan).'", notes = null),
      RootMeaningData(root = "ف-و-ض", primaryMeaning = "to entrust", extendedMeaning = "Entrusting.", quranUsage = "Ufawwidu means to entrust. 'I entrust (ufawwidu) my affair.'", notes = null),
      RootMeaningData(root = "ف-و-م", primaryMeaning = "garlic, wheat", extendedMeaning = "Garlic or wheat.", quranUsage = "Fum (فوم) is garlic. 'Its garlic (fumaha).'", notes = null),
      RootMeaningData(root = "ف-ي-ل", primaryMeaning = "elephant", extendedMeaning = "Elephant.", quranUsage = "Fil (فيل) is elephant. Surah Al-Fil. 'Companions of the elephant (fil).'", notes = null),

      // === FINAL 310 ROOTS FOR 100% COVERAGE ===

      // Roots with frequency 5
      RootMeaningData(root = "و-س-ط", primaryMeaning = "middle, midst", extendedMeaning = "Being in the middle, moderate, best.", quranUsage = "Wasat (وسط) is middle/best. 'A moderate (wasatan) nation.' 'In the midst (wasat) of them.'", notes = null),
      RootMeaningData(root = "و-ز-ع", primaryMeaning = "to restrain, distribute", extendedMeaning = "Restraining, distributing, driving.", quranUsage = "Yūza'ūn means restrained/driven. 'They will be driven (yūza'ūn).'", notes = null),
      RootMeaningData(root = "ه-ل-ل", primaryMeaning = "new moon, to appear", extendedMeaning = "New moon, appearing, shouting.", quranUsage = "Uhilla means raised/dedicated. 'What has been dedicated (uhilla) to other than Allah.'", notes = null),
      RootMeaningData(root = "ه-ز-ز", primaryMeaning = "to shake, move", extendedMeaning = "Shaking, moving.", quranUsage = "Huzzi means shake. 'Shake (huzzi) toward you the trunk.'", notes = null),
      RootMeaningData(root = "ن-ك-ل", primaryMeaning = "to punish, fetter", extendedMeaning = "Punishing, fettering, making an example.", quranUsage = "Nakal (نكال) is punishment/warning. 'A punishment (nakalan) from Allah.'", notes = null),
      RootMeaningData(root = "ن-ق-ذ", primaryMeaning = "to save, rescue", extendedMeaning = "Saving, rescuing.", quranUsage = "Anqadha means to save. 'He saved (anqadhakum) you from it.'", notes = null),
      RootMeaningData(root = "ن-ف-د", primaryMeaning = "to be exhausted", extendedMeaning = "Being exhausted, running out.", quranUsage = "Nafida means to be exhausted. 'The sea would be exhausted (nafida).'", notes = null),
      RootMeaningData(root = "ن-ش-ز", primaryMeaning = "to rise, rebel", extendedMeaning = "Rising, rebelling, disobedience.", quranUsage = "Nushūz (نشوز) is rebellion/disobedience. 'Those from whom you fear rebellion (nushūz).'", notes = null),
      RootMeaningData(root = "ن-س-ف", primaryMeaning = "to scatter, demolish", extendedMeaning = "Scattering, demolishing.", quranUsage = "Yansifuhu means to scatter. 'He will scatter (yansifuhu) it.'", notes = null),
      RootMeaningData(root = "م-ي-د", primaryMeaning = "to sway, shake", extendedMeaning = "Swaying, shaking.", quranUsage = "Tamīda means to sway. 'Lest it sway (tamīda) with you.'", notes = null),
      RootMeaningData(root = "م-ص-ر", primaryMeaning = "Egypt, city", extendedMeaning = "Egypt, a city.", quranUsage = "Misr (مصر) is Egypt. 'Go down to Egypt (misr).'", notes = null),
      RootMeaningData(root = "م-ر-د", primaryMeaning = "to rebel, be insolent", extendedMeaning = "Rebellion, insolence.", quranUsage = "Mārid (مارد) is rebellious. 'A rebellious (mārid) devil.'", notes = null),
      RootMeaningData(root = "ل-و-ي", primaryMeaning = "to twist, turn", extendedMeaning = "Twisting, turning.", quranUsage = "Yalwūna means to twist. 'They twist (yalwūna) their tongues.'", notes = null),
      RootMeaningData(root = "ل-ز-م", primaryMeaning = "to cling, be necessary", extendedMeaning = "Clinging, being necessary.", quranUsage = "Alzama means to make necessary. 'We have attached (alzamnāhu) to him.'", notes = null),
      RootMeaningData(root = "ك-س-ف", primaryMeaning = "to eclipse", extendedMeaning = "Eclipse, darkening.", quranUsage = "Inkasafat means eclipsed. 'When the moon is eclipsed (inkasafat).' (Also kasf: fragments)", notes = null),
      RootMeaningData(root = "ق-ف-و", primaryMeaning = "to follow, track", extendedMeaning = "Following, tracking.", quranUsage = "Taqfu means to follow. 'Do not follow (taqfu) what you have no knowledge of.'", notes = null),
      RootMeaningData(root = "ق-ط-ر", primaryMeaning = "to drip, region", extendedMeaning = "Dripping, region, side.", quranUsage = "Qutr (قطر) is region/molten metal. 'From the regions (aqtār) of the heavens.'", notes = null),
      RootMeaningData(root = "ق-ص-و", primaryMeaning = "furthest, extreme", extendedMeaning = "Furthest, extreme.", quranUsage = "Quswā (قصوى) is furthest. 'The furthest (quswā) side.'", notes = null),
      RootMeaningData(root = "ق-ر-ف", primaryMeaning = "to commit, earn", extendedMeaning = "Committing, earning (usually sins).", quranUsage = "Iqtarafa means to commit. 'What they committed (iqtarafū).'", notes = null),
      RootMeaningData(root = "ق-ر-ع", primaryMeaning = "to knock, strike", extendedMeaning = "Knocking, striking.", quranUsage = "Qāri'ah (قارعة) is striking calamity. Surah Al-Qāri'ah. 'The Striking Hour (qāri'ah).'", notes = null),
      RootMeaningData(root = "ق-د-د", primaryMeaning = "to cut, stature", extendedMeaning = "Cutting, form, stature.", quranUsage = "Qidd (قد) is cut/form. 'Cut (qudda) from behind.'", notes = null),
      RootMeaningData(root = "ق-ت-ر", primaryMeaning = "to be stingy, dust", extendedMeaning = "Being stingy, dust.", quranUsage = "Yaqturū means to be stingy. Qatara (قترة) is dust. 'Dust (qatara) will cover them.'", notes = null),
      RootMeaningData(root = "ف-و-ج", primaryMeaning = "group, crowd", extendedMeaning = "Group, crowd, troop.", quranUsage = "Fawj (فوج) is group. 'In crowds (afwājan).' Surah An-Nasr.", notes = null),
      RootMeaningData(root = "ف-و-ت", primaryMeaning = "to escape, pass", extendedMeaning = "Escaping, passing, missing.", quranUsage = "Yafūtu means to escape. 'Nothing escapes (yafūtu) Him.'", notes = null),
      RootMeaningData(root = "غ-و-ث", primaryMeaning = "to help, rescue", extendedMeaning = "Helping, rescuing.", quranUsage = "Istaghāthū means to seek help. 'If they seek help (yastaghīthū).' Ghawth is aid.", notes = null),
      RootMeaningData(root = "ع-ن-ت", primaryMeaning = "hardship, difficulty", extendedMeaning = "Hardship, difficulty.", quranUsage = "'Anat (عنت) is hardship. 'Lest you fall into hardship ('anat).'", notes = null),
      RootMeaningData(root = "ع-ص-ب", primaryMeaning = "group, band", extendedMeaning = "Group, band, nerve.", quranUsage = "'Usbah (عصبة) is a group. 'A group ('usbah) of them.'", notes = null),
      RootMeaningData(root = "ع-ث-و", primaryMeaning = "to cause corruption", extendedMeaning = "Causing corruption, mischief.", quranUsage = "Ya'thaw means to cause mischief. 'Do not cause corruption (ta'thaw).'", notes = null),
      RootMeaningData(root = "ع-ت-ب", primaryMeaning = "to blame, threshold", extendedMeaning = "Blaming, threshold.", quranUsage = "'Utbā is blamed/threshold. 'Ataba (عتب) is to blame.'", notes = null),
      RootMeaningData(root = "ط-و-ي", primaryMeaning = "to fold, roll up", extendedMeaning = "Folding, rolling up.", quranUsage = "Tatwī means to roll up. 'We will roll up (natwī) the heaven.'", notes = null),
      RootMeaningData(root = "ط-م-س", primaryMeaning = "to obliterate, efface", extendedMeaning = "Obliterating, effacing.", quranUsage = "Tams means to obliterate. 'Obliterate (atims) their wealth.'", notes = null),
      RootMeaningData(root = "ط-ر-د", primaryMeaning = "to drive away, expel", extendedMeaning = "Driving away, expelling.", quranUsage = "Tatrud means to drive away. 'Do not drive away (tatrud) those who call upon their Lord.'", notes = null),
      RootMeaningData(root = "ص-ن-م", primaryMeaning = "idol", extendedMeaning = "Idol, statue.", quranUsage = "Sanam (صنم) is idol. 'The idols (asnām).' Ibrahim's prayer against idols.", notes = null),
      RootMeaningData(root = "ص-د-ف", primaryMeaning = "to turn away", extendedMeaning = "Turning away.", quranUsage = "Asdafa means to turn away. 'He who turns away (asdafa).'", notes = null),
      RootMeaningData(root = "ص-د-ع", primaryMeaning = "to split, proclaim openly", extendedMeaning = "Splitting, proclaiming openly.", quranUsage = "Isda' means to proclaim. 'Proclaim (isda') what you are commanded.'", notes = null),
      RootMeaningData(root = "ص-ب-ب", primaryMeaning = "to pour", extendedMeaning = "Pouring.", quranUsage = "Sabba means to pour. 'We poured (sababnā) water.' Sabbān is pouring.", notes = null),
      RootMeaningData(root = "ش-ه-ب", primaryMeaning = "flame, shooting star", extendedMeaning = "Flame, shooting star.", quranUsage = "Shihāb (شهاب) is shooting star/flame. 'A piercing flame (shihāb).'", notes = null),
      RootMeaningData(root = "ش-ط-ر", primaryMeaning = "half, direction", extendedMeaning = "Half, direction, side.", quranUsage = "Shatr (شطر) is direction. 'Turn your face toward (shatra) the Sacred Mosque.'", notes = null),
      RootMeaningData(root = "ش-ر-ح", primaryMeaning = "to open, expand", extendedMeaning = "Opening, expanding.", quranUsage = "Sharaha means to open/expand. 'Did We not expand (nashrah) your breast?'", notes = null),
      RootMeaningData(root = "س-ب-ط", primaryMeaning = "tribe, grandson", extendedMeaning = "Tribe, grandson.", quranUsage = "Asbāt (أسباط) are tribes/grandsons. 'The tribes (asbāt) of Israel.'", notes = null),
      RootMeaningData(root = "ز-ه-ق", primaryMeaning = "to perish, vanish", extendedMeaning = "Perishing, vanishing.", quranUsage = "Zahaq means to perish. 'Falsehood is bound to perish (zahūqan).'", notes = null),
      RootMeaningData(root = "ذ-م-م", primaryMeaning = "to blame, covenant", extendedMeaning = "Blaming, covenant, protection.", quranUsage = "Dhimmah (ذمة) is covenant/protection. 'Neither kinship (dhimmah) nor covenant.'", notes = null),
      RootMeaningData(root = "د-ه-ن", primaryMeaning = "oil, grease", extendedMeaning = "Oil, grease, flattery.", quranUsage = "Duhn (دهن) is oil. 'Oil (duhn) for eating.' Also: 'They wish you to compromise (tudhinu).'", notes = null),
      RootMeaningData(root = "د-ر-أ", primaryMeaning = "to ward off, repel", extendedMeaning = "Warding off, repelling.", quranUsage = "Yadra'ūna means to ward off. 'They ward off (yadra'ūna) evil with good.'", notes = null),
      RootMeaningData(root = "خ-ي-ب", primaryMeaning = "to fail, be disappointed", extendedMeaning = "Failing, disappointment.", quranUsage = "Khāba means to fail. 'He has failed (khāba) who carries injustice.'", notes = null),
      RootMeaningData(root = "خ-و-ي", primaryMeaning = "to be empty, collapse", extendedMeaning = "Being empty, collapsing.", quranUsage = "Khāwiya means collapsed/empty. 'Its roofs collapsed (khāwiya).'", notes = null),
      RootMeaningData(root = "خ-ط-و", primaryMeaning = "step, footstep", extendedMeaning = "Step, footstep.", quranUsage = "Khutuwāt (خطوات) are steps. 'Do not follow the footsteps (khutuwāt) of Satan.'", notes = null),
      RootMeaningData(root = "خ-ر-ص", primaryMeaning = "to conjecture, lie", extendedMeaning = "Conjecturing, lying.", quranUsage = "Kharrāsūn are liars. 'Destroyed are the liars (kharrāsūn).'", notes = null),
      RootMeaningData(root = "ح-ي-ص", primaryMeaning = "to escape, turn aside", extendedMeaning = "Escaping, turning aside.", quranUsage = "Mahīs (محيص) is escape. 'There is no escape (mahīs).'", notes = null),
      RootMeaningData(root = "ح-ص-ب", primaryMeaning = "pebbles, to stone", extendedMeaning = "Pebbles, stoning.", quranUsage = "Hāsib (حاصب) is stoning wind. 'A storm of stones (hāsiban).'", notes = null),
      RootMeaningData(root = "ح-ر-ص", primaryMeaning = "to be eager, greedy", extendedMeaning = "Eagerness, greed.", quranUsage = "Harīs (حريص) is eager. 'Eager (harīsan) for you.'", notes = null),
      RootMeaningData(root = "أ-س-ف", primaryMeaning = "to grieve, anger", extendedMeaning = "Grieving, anger.", quranUsage = "Asifa means to grieve. 'Grieved (asifan).' Āsafūnā means angered us.", notes = null),

      // Roots with frequency 4
      RootMeaningData(root = "و-ف-ق", primaryMeaning = "to succeed, agree", extendedMeaning = "Succeeding, agreeing.", quranUsage = "Tawfīq (توفيق) is success. 'My success (tawfīqī) is only through Allah.'", notes = null),
      RootMeaningData(root = "و-د-ع", primaryMeaning = "to leave, put down", extendedMeaning = "Leaving, putting down.", quranUsage = "Wadda'a means to leave. 'Your Lord has not left (wadda'aka) you.'", notes = null),
      RootMeaningData(root = "ه-ي-أ", primaryMeaning = "to prepare, make ready", extendedMeaning = "Preparing, making ready.", quranUsage = "Hayyi' means to prepare. 'Prepare (hayyi') for us.'", notes = null),
      RootMeaningData(root = "ه-ن-أ", primaryMeaning = "pleasant, enjoyable", extendedMeaning = "Pleasant, enjoyable.", quranUsage = "Hanī'an (هنيئا) is pleasant/wholesome. 'Eat it pleasantly (hanī'an).'", notes = null),
      RootMeaningData(root = "ه-ا-ت", primaryMeaning = "to bring, give", extendedMeaning = "Bringing, giving.", quranUsage = "Hātū means bring. 'Bring (hātū) your proof.'", notes = null),
      RootMeaningData(root = "ن-ق-ر", primaryMeaning = "to peck, examine", extendedMeaning = "Pecking, examining.", quranUsage = "Naqīr (نقير) is speck. 'Not even a speck (naqīran).' Also: nāqūr (trumpet).", notes = null),
      RootMeaningData(root = "ن-ف-ل", primaryMeaning = "extra, spoils", extendedMeaning = "Extra, spoils of war.", quranUsage = "Anfāl (أنفال) are spoils. Surah Al-Anfāl. Nāfilah is extra prayer.", notes = null),
      RootMeaningData(root = "ن-ع-ج", primaryMeaning = "ewe, female sheep", extendedMeaning = "Ewe, female sheep.", quranUsage = "Na'jah (نعجة) is ewe. 'Ninety-nine ewes (na'jah).'", notes = null),
      RootMeaningData(root = "ن-ص-ي", primaryMeaning = "forelock", extendedMeaning = "Forelock, front of head.", quranUsage = "Nāsiya (ناصية) is forelock. 'A lying, sinful forelock (nāsiya).'", notes = null),
      RootMeaningData(root = "ن-س-ل", primaryMeaning = "offspring, to hurry", extendedMeaning = "Offspring, hurrying.", quranUsage = "Nasl (نسل) is offspring. Yansilūn means they hasten. 'They hasten (yansilūn).'", notes = null),
      RootMeaningData(root = "ن-س-خ", primaryMeaning = "to abrogate, copy", extendedMeaning = "Abrogating, copying.", quranUsage = "Nansakh means to abrogate. 'What We abrogate (nansakh) of a verse.'", notes = null),
      RootMeaningData(root = "ن-ح-ت", primaryMeaning = "to carve, hew", extendedMeaning = "Carving, hewing.", quranUsage = "Tanhitūn means to carve. 'You carve (tanhitūn) houses from mountains.'", notes = null),
      RootMeaningData(root = "م-ي-ز", primaryMeaning = "to distinguish, separate", extendedMeaning = "Distinguishing, separating.", quranUsage = "Yamīzu means to distinguish. 'Until He distinguishes (yamīza) the evil from the good.'", notes = null),
      RootMeaningData(root = "م-ه-ن", primaryMeaning = "contemptible, lowly", extendedMeaning = "Contemptible, lowly.", quranUsage = "Mahīn (مهين) is contemptible. 'From water contemptible (mahīn).'", notes = null),
      RootMeaningData(root = "م-ز-ق", primaryMeaning = "to tear, rend", extendedMeaning = "Tearing, rending.", quranUsage = "Mazzaqnā means to tear apart. 'We tore them (mazzaqnāhum) apart.'", notes = null),
      RootMeaningData(root = "ل-م-ز", primaryMeaning = "to criticize, mock", extendedMeaning = "Criticizing, mocking.", quranUsage = "Yalmizūna means to criticize. 'Those who criticize (yalmizūna).' Lumazah is slanderer.", notes = null),
      RootMeaningData(root = "ك-و-ب", primaryMeaning = "cup, goblet", extendedMeaning = "Cup, goblet.", quranUsage = "Akwāb (أكواب) are cups. 'With cups (akwāb) and jugs.'", notes = null),
      RootMeaningData(root = "ك-ر-ب", primaryMeaning = "distress, anguish", extendedMeaning = "Distress, anguish.", quranUsage = "Karb (كرب) is distress. 'We saved him from the distress (karb).'", notes = null),
      RootMeaningData(root = "ق-ن-ط-ر", primaryMeaning = "heaps of wealth", extendedMeaning = "Heaps of wealth, quintals.", quranUsage = "Qanātīr (قناطير) are heaps. 'Heaps (qanātīr) of gold and silver.'", notes = null),
      RootMeaningData(root = "ق-ل-د", primaryMeaning = "necklace, imitate", extendedMeaning = "Necklace, imitation.", quranUsage = "Qalā'id (قلائد) are necklaces/garlands. 'The garlanded (qalā'id) animals.'", notes = null),
      RootMeaningData(root = "ف-ش-ل", primaryMeaning = "to fail, weaken", extendedMeaning = "Failing, weakening.", quranUsage = "Tafshalū means to fail. 'Lest you fail (tafshalū).'", notes = null),
      RootMeaningData(root = "غ-و-ر", primaryMeaning = "to sink, depth", extendedMeaning = "Sinking, depth.", quranUsage = "Ghawran (غورا) is sinking/deep. 'Its water becomes sunken (ghawran).'", notes = null),
      RootMeaningData(root = "غ-م-ر", primaryMeaning = "to cover, immerse", extendedMeaning = "Covering, immersing.", quranUsage = "Ghamrah (غمرة) is covering/flood. 'In their flood (ghamratihim) of ignorance.'", notes = null),
      RootMeaningData(root = "غ-ض-ض", primaryMeaning = "to lower, reduce", extendedMeaning = "Lowering, reducing.", quranUsage = "Yaghuddu means to lower. 'Lower (ughdudd) your voice.' 'Lower (yaghuddu) their gaze.'", notes = null),
      RootMeaningData(root = "غ-س-ق", primaryMeaning = "darkness, dusk", extendedMeaning = "Darkness, dusk.", quranUsage = "Ghasaq (غسق) is darkness. 'The darkness (ghasaq) of night.'", notes = null),
      RootMeaningData(root = "ع-و-ر", primaryMeaning = "nakedness, shame", extendedMeaning = "Nakedness, shame, defect.", quranUsage = "'Awrah (عورة) is nakedness/vulnerable. 'Our houses are exposed ('awrah).'", notes = null),
      RootMeaningData(root = "ع-ق-م", primaryMeaning = "barren, sterile", extendedMeaning = "Barren, sterile.", quranUsage = "'Aqīm (عقيم) is barren. 'A barren ('aqīm) wind.' 'I am barren ('aqim).'", notes = null),
      RootMeaningData(root = "ع-ج-م", primaryMeaning = "non-Arab, foreign", extendedMeaning = "Non-Arab, foreign.", quranUsage = "A'jamī (أعجمي) is non-Arabic. 'A foreign (a'jamī) Quran?'", notes = null),
      RootMeaningData(root = "ط-و-ق", primaryMeaning = "collar, ability", extendedMeaning = "Collar, ability, to encircle.", quranUsage = "Tawq (طوق) is collar. 'Collared (yutawwaqūna) with what they withheld.' Yutīqūna: able.", notes = null),
      RootMeaningData(root = "ط-ف-ل", primaryMeaning = "child, infant", extendedMeaning = "Child, infant.", quranUsage = "Tifl (طفل) is child. 'Or children (tifl) not aware.'", notes = null),
      RootMeaningData(root = "ط-ب-ق", primaryMeaning = "layer, level", extendedMeaning = "Layer, level.", quranUsage = "Tabaq (طبق) is layer. 'In layers (tabaqan) upon layers.'", notes = null),
      RootMeaningData(root = "ص-ر-ح", primaryMeaning = "palace, clear", extendedMeaning = "Palace, clear.", quranUsage = "Sarh (صرح) is palace. 'A palace (sarhan) lofty.'", notes = null),
      RootMeaningData(root = "ش-و-ر", primaryMeaning = "to consult", extendedMeaning = "Consulting.", quranUsage = "Shūrā (شورى) is consultation. Surah Ash-Shūrā. 'Consult (shāwirhum) them.'", notes = null),
      RootMeaningData(root = "ش-أ-ن", primaryMeaning = "affair, matter", extendedMeaning = "Affair, matter, concern.", quranUsage = "Sha'n (شأن) is affair. 'He is upon a matter (sha'n).' 'Every person has a concern (sha'n).'", notes = null),
      RootMeaningData(root = "س-و-ل", primaryMeaning = "to entice, adorn", extendedMeaning = "Enticing, making seem fair.", quranUsage = "Sawwala means to entice. 'Your souls enticed (sawwalat) you.'", notes = null),
      RootMeaningData(root = "س-م-ن", primaryMeaning = "fat, plump", extendedMeaning = "Fat, plump.", quranUsage = "Simān (سمان) are fat. 'Seven fat (simān) cows.'", notes = null),
      RootMeaningData(root = "س-م-م", primaryMeaning = "poison, hole", extendedMeaning = "Poison, hole.", quranUsage = "Samm (سم) is hole/eye of needle. 'Through the eye (samm) of a needle.'", notes = null),
      RootMeaningData(root = "س-م-ر", primaryMeaning = "to converse at night", extendedMeaning = "Conversing at night.", quranUsage = "Sāmiran means conversing. 'Conversing (sāmiran) by night.'", notes = null),
      RootMeaningData(root = "س-ل-ح", primaryMeaning = "weapon, arms", extendedMeaning = "Weapon, arms.", quranUsage = "Silāh (سلاح) is weapon. 'Take their weapons (aslihatahum).'", notes = null),
      RootMeaningData(root = "س-ف-ح", primaryMeaning = "to shed, pour", extendedMeaning = "Shedding, pouring.", quranUsage = "Musāfihīn are fornicators. 'Not as fornicators (musāfihīn).' Safaha: shed blood.", notes = null),
      RootMeaningData(root = "س-ر-ب", primaryMeaning = "to flow, flock", extendedMeaning = "Flowing, flock.", quranUsage = "Sāribun means going forth. 'Going forth (sāribun) by day.'", notes = null),
      RootMeaningData(root = "س-ح-ت", primaryMeaning = "unlawful gain", extendedMeaning = "Unlawful gain, bribery.", quranUsage = "Suht (سحت) is unlawful. 'Consumers of the unlawful (suht).'", notes = null),
      RootMeaningData(root = "س-ج-ل", primaryMeaning = "record, scroll", extendedMeaning = "Record, scroll.", quranUsage = "Sijill (سجل) is record/scroll. 'Like a rolled scroll (sijill).'", notes = null),
      RootMeaningData(root = "ز-و-ل", primaryMeaning = "to cease, move", extendedMeaning = "Ceasing, moving.", quranUsage = "Tazūla means to cease. 'Lest they cease (tazūlā).'", notes = null),
      RootMeaningData(root = "ز-خ-ر-ف", primaryMeaning = "adornment, gold", extendedMeaning = "Adornment, gold.", quranUsage = "Zukhruf (زخرف) is adornment/gold. Surah Az-Zukhruf. 'Adorned (zukhruf) speech.'", notes = null),
      RootMeaningData(root = "ر-ك-ن", primaryMeaning = "to lean, incline", extendedMeaning = "Leaning, inclining.", quranUsage = "Tarkanu means to incline. 'Do not incline (tarkanū) to those who wrong.'", notes = null),
      RootMeaningData(root = "ر-ق-ي", primaryMeaning = "to ascend, spell", extendedMeaning = "Ascending, incantation.", quranUsage = "Tarqā means to ascend. 'You ascend (tarqā) in the sky.' Ruqyah: spell.", notes = null),
      RootMeaningData(root = "ر-ذ-ل", primaryMeaning = "lowly, vile", extendedMeaning = "Lowly, vile.", quranUsage = "Arādhil (أراذل) are lowly ones. 'The lowly (arādhilunā) among us.'", notes = null),
      RootMeaningData(root = "ر-ح-ب", primaryMeaning = "spacious, welcome", extendedMeaning = "Spacious, welcome.", quranUsage = "Rahuba means to be spacious. 'Despite its vastness (raḥubat).' Marhaban: welcome.", notes = null),
      RootMeaningData(root = "ر-ت-ل", primaryMeaning = "to recite slowly", extendedMeaning = "Reciting slowly, measured recitation.", quranUsage = "Rattil means to recite slowly. 'Recite (rattil) the Quran slowly.'", notes = null),
      RootMeaningData(root = "د-ل-و", primaryMeaning = "bucket", extendedMeaning = "Bucket.", quranUsage = "Dalw (دلو) is bucket. 'He let down his bucket (dalwahu).'", notes = null),
      RootMeaningData(root = "د-ر-ر", primaryMeaning = "to flow, pearl", extendedMeaning = "Flowing, pearl.", quranUsage = "Durrī (دري) is brilliant. 'A brilliant (durriyyun) star.' Darr: continuous flowing.", notes = null),
      RootMeaningData(root = "د-خ-ر", primaryMeaning = "to humiliate", extendedMeaning = "Humiliating.", quranUsage = "Dākhirūn are humiliated. 'They will enter humiliated (dākhirīna).'", notes = null),
      RootMeaningData(root = "د-ح-ض", primaryMeaning = "to slip, refute", extendedMeaning = "Slipping, refuting.", quranUsage = "Dahd means refutation. 'To refute (yudḥiḍū) the truth.' Dāḥiḍah: slipping.", notes = null),
      RootMeaningData(root = "د-ح-ر", primaryMeaning = "to drive away", extendedMeaning = "Driving away.", quranUsage = "Madhūr means driven away. 'Driven away (madhūran).'", notes = null),
      RootMeaningData(root = "خ-ص-ص", primaryMeaning = "to specify, need", extendedMeaning = "Specifying, need.", quranUsage = "Khaṣāṣah (خصاصة) is need/poverty. 'Even if they have need (khaṣāṣah).'", notes = null),
      RootMeaningData(root = "خ-س-أ", primaryMeaning = "to drive away, despised", extendedMeaning = "Driving away, despised.", quranUsage = "Ikhsa'ū means be despised. 'Be despised (ikhsa'ū) in it.'", notes = null),
      RootMeaningData(root = "خ-ر-ق", primaryMeaning = "to pierce, tear", extendedMeaning = "Piercing, tearing.", quranUsage = "Takhriqu means to pierce. 'You will never pierce (takhriqa) the earth.'", notes = null),
      RootMeaningData(root = "ح-ي-ض", primaryMeaning = "menstruation", extendedMeaning = "Menstruation.", quranUsage = "Maḥīḍ (محيض) is menstruation. 'About menstruation (maḥīḍ).'", notes = null),
      RootMeaningData(root = "ح-م-أ", primaryMeaning = "mud, dark", extendedMeaning = "Mud, dark.", quranUsage = "Ḥama' (حمأ) is mud. 'Black mud (ḥama') altered.'", notes = null),
      RootMeaningData(root = "ب-و-ل", primaryMeaning = "urine, mind", extendedMeaning = "Urine, mind, test.", quranUsage = "Balā' (بلاء) is test. 'A great trial (balā').' Yablū: to test.", notes = null),
      RootMeaningData(root = "أ-م-د", primaryMeaning = "period, extent", extendedMeaning = "Period, extent.", quranUsage = "Amad (أمد) is period. 'The period (amad) was prolonged.'", notes = null),

      // Roots with frequency 3
      RootMeaningData(root = "و-ص-د", primaryMeaning = "to close, shut", extendedMeaning = "Closing, shutting.", quranUsage = "Mu'ṣadah means closed. 'It is closed (mu'ṣadah) upon them.'", notes = null),
      RootMeaningData(root = "و-ج-س", primaryMeaning = "to feel, sense", extendedMeaning = "Feeling, sensing fear.", quranUsage = "Awjasa means to feel. 'He felt (awjasa) fear.'", notes = null),
      RootMeaningData(root = "و-ث-ن", primaryMeaning = "idol", extendedMeaning = "Idol.", quranUsage = "Wathan (وثن) is idol. 'The idols (awthān).'", notes = null),
      RootMeaningData(root = "و-ت-د", primaryMeaning = "peg, stake", extendedMeaning = "Peg, stake.", quranUsage = "Awtād (أوتاد) are stakes. 'Pharaoh of the stakes (awtād).'", notes = null),
      RootMeaningData(root = "ه-م-ز", primaryMeaning = "to slander, goad", extendedMeaning = "Slandering, goading.", quranUsage = "Humazah (همزة) is slanderer. Surah Al-Humazah. 'Every slanderer (humazah).'", notes = null),
      RootMeaningData(root = "ه-ط-ع", primaryMeaning = "to hasten, crane neck", extendedMeaning = "Hastening, craning neck.", quranUsage = "Muhṭi'īn means hastening with necks craned. 'Racing with heads raised (muhṭi'īna).'", notes = null),
      RootMeaningData(root = "ن-ك-ف", primaryMeaning = "to disdain", extendedMeaning = "Disdaining.", quranUsage = "Yastankif means to disdain. 'Would never disdain (yastankifa).'", notes = null),
      RootMeaningData(root = "ن-ك-س", primaryMeaning = "to reverse, turn upside down", extendedMeaning = "Reversing, turning upside down.", quranUsage = "Nukisū means reversed. 'Then they were reversed (nukisū).'", notes = null),
      RootMeaningData(root = "ن-ق-ب", primaryMeaning = "to pierce, explore", extendedMeaning = "Piercing, exploring.", quranUsage = "Naqqabū means they explored. 'They explored (naqqabū) in the lands.'", notes = null),
      RootMeaningData(root = "ن-ف-ذ", primaryMeaning = "to penetrate, pass through", extendedMeaning = "Penetrating, passing through.", quranUsage = "Tanfudhū means to pass through. 'If you can pass through (tanfudhū).'", notes = null),
      RootMeaningData(root = "ن-ض-د", primaryMeaning = "to arrange, pile up", extendedMeaning = "Arranging, piling up.", quranUsage = "Manḍūd means piled up. 'Bananas piled up (manḍūd).'", notes = null),
      RootMeaningData(root = "ن-ث-ر", primaryMeaning = "to scatter", extendedMeaning = "Scattering.", quranUsage = "Intatharat means scattered. 'When the stars are scattered (intatharat).'", notes = null),
      RootMeaningData(root = "ن-أ-ي", primaryMeaning = "to be distant", extendedMeaning = "Being distant.", quranUsage = "Yan'awna means to distance. 'They distance (yan'awna) from it.'", notes = null),
      RootMeaningData(root = "م-و-ر", primaryMeaning = "to move, sway", extendedMeaning = "Moving, swaying.", quranUsage = "Tamūru means to sway. 'The earth will sway (tamūru).'", notes = null),
      RootMeaningData(root = "م-ر-ح", primaryMeaning = "to be joyful, arrogant", extendedMeaning = "Joyfulness, arrogance.", quranUsage = "Maraḥan is arrogant. 'Do not walk arrogantly (maraḥan).'", notes = null),
      RootMeaningData(root = "م-ح-و", primaryMeaning = "to erase, wipe out", extendedMeaning = "Erasing, wiping out.", quranUsage = "Yamḥū means to erase. 'Allah erases (yamḥū) what He wills.'", notes = null),
      RootMeaningData(root = "م-ت-ن", primaryMeaning = "strong, firm", extendedMeaning = "Strong, firm.", quranUsage = "Matīn (متين) is firm. 'The Possessor of Power, the Firm (matīn).'", notes = null),
      RootMeaningData(root = "ل-ه-ب", primaryMeaning = "flame", extendedMeaning = "Flame.", quranUsage = "Lahab (لهب) is flame. Surah Al-Masad. 'Father of flame (lahab).'", notes = null),
      RootMeaningData(root = "ل-ق-ف", primaryMeaning = "to swallow, snatch", extendedMeaning = "Swallowing, snatching.", quranUsage = "Talqaf means to swallow. 'It will swallow (talqaf) what they made.'", notes = null),
      RootMeaningData(root = "ل-ف-و", primaryMeaning = "to turn aside", extendedMeaning = "Turning aside.", quranUsage = "Talaqqā means to receive. 'He received (talaqqā) from his Lord words.'", notes = null),
      RootMeaningData(root = "ل-ف-ف", primaryMeaning = "to wrap", extendedMeaning = "Wrapping.", quranUsage = "Iltaffat means wrapped. 'When the legs are wrapped (iltaffat).'", notes = null),
      RootMeaningData(root = "ل-ف-ت", primaryMeaning = "to turn, distract", extendedMeaning = "Turning, distracting.", quranUsage = "Talattafat means turned. Talfit: distraction.", notes = null),
      RootMeaningData(root = "ل-ذ-ذ", primaryMeaning = "pleasure, delight", extendedMeaning = "Pleasure, delight.", quranUsage = "Ladhdhah (لذة) is pleasure. 'A pleasure (ladhdhatan) for the drinkers.'", notes = null),
      RootMeaningData(root = "ل-ج-أ", primaryMeaning = "to seek refuge", extendedMeaning = "Seeking refuge.", quranUsage = "Malja' (ملجأ) is refuge. 'No refuge (malja').'", notes = null),
      RootMeaningData(root = "ك-و-ر", primaryMeaning = "to wrap, coil", extendedMeaning = "Wrapping, coiling.", quranUsage = "Kuwwirat means wrapped. 'When the sun is wrapped up (kuwwirat).'", notes = null),
      RootMeaningData(root = "ك-ب-ت", primaryMeaning = "to suppress, humiliate", extendedMeaning = "Suppressing, humiliating.", quranUsage = "Kubitu means suppressed. 'They were suppressed (kubitū).'", notes = null),
      RootMeaningData(root = "ق-ر-د", primaryMeaning = "monkey, ape", extendedMeaning = "Monkey, ape.", quranUsage = "Qiradah (قردة) is apes. 'Be apes (qiradatan) despised.'", notes = null),
      RootMeaningData(root = "ق-ر-ح", primaryMeaning = "wound, ulcer", extendedMeaning = "Wound, ulcer.", quranUsage = "Qarḥ (قرح) is wound. 'If a wound (qarḥ) has touched you.'", notes = null),
      RootMeaningData(root = "ق-ب-س", primaryMeaning = "to take fire", extendedMeaning = "Taking fire, brand.", quranUsage = "Qabas (قبس) is firebrand. 'Or I find a firebrand (qabas).'", notes = null),
      RootMeaningData(root = "س-و-غ", primaryMeaning = "to be easy to swallow", extendedMeaning = "Being easy to swallow.", quranUsage = "Yusīghuhu means can swallow. 'He can hardly swallow (yusīghuhu) it.'", notes = null),

      // Roots with frequency 2
      RootMeaningData(root = "و-ط-ر", primaryMeaning = "need, desire", extendedMeaning = "Need, desire.", quranUsage = "Waṭar (وطر) is need. 'Zayd had fulfilled his need (waṭar).'", notes = null),
      RootMeaningData(root = "و-ص-ب", primaryMeaning = "perpetual, fatigue", extendedMeaning = "Perpetual, fatigue.", quranUsage = "Wāṣib (واصب) is perpetual. 'His is the religion perpetual (wāṣiban).'", notes = null),
      RootMeaningData(root = "و-س-م", primaryMeaning = "to mark, brand", extendedMeaning = "Marking, branding.", quranUsage = "Musawwamah (مسومة) is marked. 'Marked (musawwamatan) horses.'", notes = null),
      RootMeaningData(root = "و-س-ل", primaryMeaning = "means, approach", extendedMeaning = "Means, approach.", quranUsage = "Wasīlah (وسيلة) is means. 'Seek means (wasīlah) to Him.'", notes = null),
      RootMeaningData(root = "و-س-ق", primaryMeaning = "to load, gather", extendedMeaning = "Loading, gathering.", quranUsage = "Wasaq means gathered. 'And the night and what it gathers (wasaq).'", notes = null),
      RootMeaningData(root = "و-د-ق", primaryMeaning = "rain", extendedMeaning = "Rain.", quranUsage = "Wadq (ودق) is rain. 'You see the rain (wadq) coming forth.'", notes = null),
      RootMeaningData(root = "و-ج-ف", primaryMeaning = "to hurry, gallop", extendedMeaning = "Hurrying, galloping.", quranUsage = "Awjaftum means you spurred. 'You did not spur (awjaftum) any horse.'", notes = null),
      RootMeaningData(root = "و-ب-ق", primaryMeaning = "to perish, destroy", extendedMeaning = "Perishing, destroying.", quranUsage = "Mawbiq (موبق) is place of destruction. 'Between them is a barrier (mawbiqan).'", notes = null),
      RootMeaningData(root = "ه-ي-م", primaryMeaning = "to wander, love madly", extendedMeaning = "Wandering, passionate love.", quranUsage = "Yahīmūn means they wander. 'In every valley they wander (yahīmūn).'", notes = null),
      RootMeaningData(root = "ه-و-ر", primaryMeaning = "to collapse, fall", extendedMeaning = "Collapsing, falling.", quranUsage = "Inhāra means collapsed. 'So it collapsed (inhāra).'", notes = null),
      RootMeaningData(root = "ه-م-ن", primaryMeaning = "to watch over, dominate", extendedMeaning = "Watching over, dominating.", quranUsage = "Muhaymin (مهيمن) is guardian. 'A guardian (muhayminan) over it.'", notes = null),
      RootMeaningData(root = "ه-ل-م", primaryMeaning = "to come, bring", extendedMeaning = "Coming, bringing.", quranUsage = "Halumma means come. 'Come (halumma) to us.'", notes = null),
      RootMeaningData(root = "ه-ض-م", primaryMeaning = "to oppress, digest", extendedMeaning = "Oppressing, digesting.", quranUsage = "Haḍm (هضم) is oppression. 'He will not fear oppression (haḍman).'", notes = null),
      RootMeaningData(root = "ه-ش-م", primaryMeaning = "to crush, break", extendedMeaning = "Crushing, breaking.", quranUsage = "Hashīm (هشيم) is crushed. 'Crushed (hashīman) dry.'", notes = null),
      RootMeaningData(root = "ه-ر-ع", primaryMeaning = "to hasten", extendedMeaning = "Hastening.", quranUsage = "Yuhra'ūna means hastening. 'His people hastening (yuhra'ūna) to him.'", notes = null),
      RootMeaningData(root = "ه-ب-و", primaryMeaning = "dust particles", extendedMeaning = "Dust particles.", quranUsage = "Habā' (هباء) is scattered dust. 'Scattered dust (habā'an).'", notes = null),
      RootMeaningData(root = "ن-ك-ص", primaryMeaning = "to recoil, retreat", extendedMeaning = "Recoiling, retreating.", quranUsage = "Nakasa means to recoil. 'He recoiled (nakasa) on his heels.'", notes = null),
      RootMeaningData(root = "ن-ك-ب", primaryMeaning = "to turn aside, calamity", extendedMeaning = "Turning aside, calamity.", quranUsage = "Nākibūn means turning aside. 'From the path are turning aside (nākibūn).'", notes = null),
      RootMeaningData(root = "ن-ف-ش", primaryMeaning = "to card wool, scatter", extendedMeaning = "Carding wool, scattering.", quranUsage = "Manfūsh (منفوش) is carded. 'Like carded (manfūsh) wool.'", notes = null),
      RootMeaningData(root = "ن-ع-س", primaryMeaning = "to drowse, slumber", extendedMeaning = "Drowsing, slumber.", quranUsage = "Nu'ās (نعاس) is slumber. 'When He covered you with slumber (nu'āsan).'", notes = null),
      RootMeaningData(root = "ن-ص-ت", primaryMeaning = "to listen silently", extendedMeaning = "Listening silently.", quranUsage = "Anṣitū means listen silently. 'Listen to it and be silent (anṣitū).'", notes = null),
      RootMeaningData(root = "ن-ش-ط", primaryMeaning = "to untie, active", extendedMeaning = "Untying, being active.", quranUsage = "Nāshiṭāt are those that draw out. 'Those that draw out (nāshiṭāt).'", notes = null),
      RootMeaningData(root = "ن-س-أ", primaryMeaning = "to postpone, delay", extendedMeaning = "Postponing, delaying.", quranUsage = "Nasī' (نسيء) is postponement. 'Postponement (nasī') is an increase in disbelief.'", notes = null),
      RootMeaningData(root = "ن-ز-ف", primaryMeaning = "to drain, intoxicate", extendedMeaning = "Draining, intoxication.", quranUsage = "Yunzafūna means intoxicated. 'They will not be intoxicated (yunzafūna).'", notes = null),
      RootMeaningData(root = "ن-ب-ع", primaryMeaning = "to gush forth", extendedMeaning = "Gushing forth.", quranUsage = "Yanba'u means to gush. 'From which twelve springs gushed (inbajasa/yanba'u).'", notes = null),
      RootMeaningData(root = "م-ل-ق", primaryMeaning = "to flatter, poverty", extendedMeaning = "Flattery, poverty.", quranUsage = "Imlāq (إملاق) is poverty. 'Out of fear of poverty (imlāq).'", notes = null),
      RootMeaningData(root = "م-خ-ر", primaryMeaning = "to plow through", extendedMeaning = "Plowing through (water).", quranUsage = "Mawākhir (مواخر) are plowing ships. 'Ships plowing (mawākhir) through it.'", notes = null),
      RootMeaningData(root = "م-ح-ق", primaryMeaning = "to destroy, wipe out", extendedMeaning = "Destroying, wiping out.", quranUsage = "Yamḥaq means to destroy. 'Allah destroys (yamḥaq) usury.'", notes = null),
      RootMeaningData(root = "م-ح-ص", primaryMeaning = "to purify, test", extendedMeaning = "Purifying, testing.", quranUsage = "Yumḥaṣu means to purify. 'That Allah may purify (yumḥiṣa) the believers.'", notes = null),
      RootMeaningData(root = "ل-ه-ث", primaryMeaning = "to pant", extendedMeaning = "Panting.", quranUsage = "Yalhath means to pant. 'He pants (yalhath).'", notes = null),
      RootMeaningData(root = "ل-م-م", primaryMeaning = "minor sins, to gather", extendedMeaning = "Minor sins, gathering.", quranUsage = "Lamam (لمم) is minor sins. 'Except the small faults (lamam).'", notes = null),
      RootMeaningData(root = "ل-م-ح", primaryMeaning = "to glance", extendedMeaning = "Glancing.", quranUsage = "Lamḥ (لمح) is glance. 'Like a glance (lamḥ) of sight.'", notes = null),
      RootMeaningData(root = "ل-ق-ط", primaryMeaning = "to pick up, find", extendedMeaning = "Picking up, finding.", quranUsage = "Yaltaqiṭhu means to pick up. 'Some travelers will pick him up (yaltaqiṭhu).'", notes = null),
      RootMeaningData(root = "ل-غ-ب", primaryMeaning = "fatigue", extendedMeaning = "Fatigue.", quranUsage = "Lughūb (لغوب) is fatigue. 'No fatigue (lughūb) touches us.'", notes = null),
      RootMeaningData(root = "ل-د-د", primaryMeaning = "fierce in dispute", extendedMeaning = "Fierce in dispute.", quranUsage = "Aladd (ألد) is fierce. 'The fiercest (aladda) of opponents.'", notes = null),
      RootMeaningData(root = "ل-ب-د", primaryMeaning = "to cling, crowd", extendedMeaning = "Clinging, crowding.", quranUsage = "Libad (لبدا) is crowded. 'Almost crowding (libadan) upon him.'", notes = null),
      RootMeaningData(root = "ك-ي-ن", primaryMeaning = "manner, state", extendedMeaning = "Manner, state (defective verb).", quranUsage = "Kayna is a defective form. Related to state of being.", notes = null),
      RootMeaningData(root = "ك-ه-ن", primaryMeaning = "to divine, soothsay", extendedMeaning = "Divining, soothsaying.", quranUsage = "Kāhin (كاهن) is soothsayer. 'Nor the word of a soothsayer (kāhin).'", notes = null),
      RootMeaningData(root = "ك-ه-ل", primaryMeaning = "middle-aged", extendedMeaning = "Middle-aged.", quranUsage = "Kahl (كهل) is middle-aged. 'In middle age (kahlan).'", notes = null),
      RootMeaningData(root = "ك-م-ه", primaryMeaning = "blind", extendedMeaning = "Blind.", quranUsage = "Akmah (أكمه) is born blind. 'The blind (akmah) and the leper.'", notes = null),
      RootMeaningData(root = "ك-م-م", primaryMeaning = "to muzzle, cover", extendedMeaning = "Muzzling, covering.", quranUsage = "Akmām (أكمام) are sheaths/spathes. 'From its sheaths (akmāmihā).'", notes = null),
      RootMeaningData(root = "ك-ل-و", primaryMeaning = "to guard, protect", extendedMeaning = "Guarding, protecting.", quranUsage = "Kalā'an means guardian. Related to protection.", notes = null),
      RootMeaningData(root = "ك-س-ل", primaryMeaning = "to be lazy", extendedMeaning = "Being lazy.", quranUsage = "Kusālā (كسالى) are lazy. 'They come to prayer lazy (kusālā).'", notes = null),
      RootMeaningData(root = "ك-ر-س", primaryMeaning = "throne, seat", extendedMeaning = "Throne, seat.", quranUsage = "Kursī (كرسي) is throne/seat. 'His throne (kursiyyuhu) extends over the heavens.'", notes = null),
      RootMeaningData(root = "ك-د-ح", primaryMeaning = "to toil, strive", extendedMeaning = "Toiling, striving.", quranUsage = "Kādih (كادح) is toiling. 'You are toiling (kādiḥun) toward your Lord.'", notes = null),
      RootMeaningData(root = "ك-ب-ب", primaryMeaning = "to throw down", extendedMeaning = "Throwing down.", quranUsage = "Kubkibū means thrown down. 'They will be thrown (kubkibū) into it.'", notes = null),
      RootMeaningData(root = "ق-ي-ل", primaryMeaning = "midday rest", extendedMeaning = "Midday rest.", quranUsage = "Maqīl (مقيل) is resting place. 'Better in resting place (maqīlan).'", notes = null),
      RootMeaningData(root = "ق-ي-ض", primaryMeaning = "to assign, destine", extendedMeaning = "Assigning, destining.", quranUsage = "Qayyaḍnā means We assigned. 'We assigned (qayyaḍnā) to them companions.'", notes = null),
      RootMeaningData(root = "ق-و-ع", primaryMeaning = "bottom, seated", extendedMeaning = "Bottom, seated.", quranUsage = "Qā'idīn (قاعدين) are sitting. Related to sitting/staying behind.", notes = null),
      RootMeaningData(root = "ق-و-ت", primaryMeaning = "sustenance, provision", extendedMeaning = "Sustenance, provision.", quranUsage = "Aqwāt (أقوات) are provisions. 'Its provisions (aqwātahā).'", notes = null),
      RootMeaningData(root = "ق-ن-ع", primaryMeaning = "to be content, humble", extendedMeaning = "Being content, humble.", quranUsage = "Muqni' (مقنع) is humble/raised. 'Heads raised (muqni'ī).' Qāni' is content.", notes = null),
      RootMeaningData(root = "ق-ل-ي", primaryMeaning = "to roast, fry", extendedMeaning = "Roasting, frying.", quranUsage = "Qalā is to roast. Related to cooking.", notes = null),
      RootMeaningData(root = "ق-س-ط-س", primaryMeaning = "scales, balance", extendedMeaning = "Scales, balance.", quranUsage = "Qisṭās (قسطاس) is scales. 'Weigh with the straight balance (qisṭās).'", notes = null),
      RootMeaningData(root = "ق-ر-ط-س", primaryMeaning = "paper, parchment", extendedMeaning = "Paper, parchment.", quranUsage = "Qirṭās (قرطاس) is paper. 'A scripture on paper (qirṭās).'", notes = null),
      RootMeaningData(root = "ق-د-و", primaryMeaning = "to guide, example", extendedMeaning = "Guiding, example.", quranUsage = "Iqtadih means follow. 'Follow (iqtadih) their guidance.'", notes = null),
      RootMeaningData(root = "ق-ح-م", primaryMeaning = "to plunge, steep path", extendedMeaning = "Plunging, steep path.", quranUsage = "Iqtaḥama means to assault. ''Aqabah (عقبة) is steep path.'", notes = null),
      RootMeaningData(root = "ص-د-ي", primaryMeaning = "echo, thirst", extendedMeaning = "Echo, thirst.", quranUsage = "Ṣadā (صدى) is echo. Related to sound returning.", notes = null),

      // Roots with frequency 1
      RootMeaningData(root = "و-ه-ي", primaryMeaning = "to be weak", extendedMeaning = "Being weak.", quranUsage = "Wāhiyah (واهية) is weak/torn. 'Like a torn (wāhiyah) tent.'", notes = null),
      RootMeaningData(root = "و-ه-ج", primaryMeaning = "to burn, glow", extendedMeaning = "Burning, glowing.", quranUsage = "Wahhāj (وهاج) is blazing. 'A blazing (wahhājan) lamp.'", notes = null),
      RootMeaningData(root = "و-ن-ي", primaryMeaning = "to weaken, flag", extendedMeaning = "Weakening, flagging.", quranUsage = "Taniyā means to weaken. 'Do not weaken (taniyā).'", notes = null),
      RootMeaningData(root = "و-ك-ز", primaryMeaning = "to strike, punch", extendedMeaning = "Striking, punching.", quranUsage = "Wakaz means to strike. 'He struck (wakazahu) him.'", notes = null),
      RootMeaningData(root = "و-ك-د", primaryMeaning = "to confirm, stress", extendedMeaning = "Confirming, stressing.", quranUsage = "Tawkīd (توكيد) is emphasis. Related to affirming.", notes = null),
      RootMeaningData(root = "و-ق-ذ", primaryMeaning = "to strike fatally", extendedMeaning = "Striking fatally.", quranUsage = "Mawqūdhah (موقوذة) is beaten to death. 'That beaten to death (mawqūdhah).'", notes = null),
      RootMeaningData(root = "و-ق-ب", primaryMeaning = "to set, darkness", extendedMeaning = "Setting, darkness.", quranUsage = "Ghāsiq (غاسق) waqab is night when it settles. 'When it becomes dark (waqab).'", notes = null),
      RootMeaningData(root = "و-ف-ض", primaryMeaning = "to hasten", extendedMeaning = "Hastening.", quranUsage = "Yūfiḍūna means they hasten. 'They hasten (yūfiḍūna).'", notes = null),
      RootMeaningData(root = "و-ف-د", primaryMeaning = "delegation", extendedMeaning = "Delegation.", quranUsage = "Wafd (وفد) is delegation. 'As a delegation (wafdan).'", notes = null),
      RootMeaningData(root = "و-ط-ن", primaryMeaning = "homeland", extendedMeaning = "Homeland.", quranUsage = "Mawāṭin (مواطن) are places. 'In many places (mawāṭin).'", notes = null),
      RootMeaningData(root = "و-ض-ن", primaryMeaning = "to inlay, arrange", extendedMeaning = "Inlaying, arranging.", quranUsage = "Mawḍūnah (موضونة) is inlaid. 'Inlaid (mawḍūnah) couches.'", notes = null),
      RootMeaningData(root = "و-ش-ي", primaryMeaning = "to embroider", extendedMeaning = "Embroidering.", quranUsage = "Wāshiyah (واشية) is embroidered. Related to decoration.", notes = null),
      RootMeaningData(root = "و-س-ن", primaryMeaning = "to be drowsy", extendedMeaning = "Being drowsy.", quranUsage = "Sinah (سنة) is drowsiness. 'Neither drowsiness (sinah) nor sleep.'", notes = null),
      RootMeaningData(root = "و-ت-ن", primaryMeaning = "jugular vein", extendedMeaning = "Jugular vein.", quranUsage = "Watīn (وتين) is life-artery. 'Cut from him the artery (watīn).'", notes = null),
      RootMeaningData(root = "و-ب-ر", primaryMeaning = "camel hair", extendedMeaning = "Camel hair.", quranUsage = "Awbār (أوبار) is camel hair. 'From their wool and fur (awbārihā).'", notes = null),
      RootMeaningData(root = "و-أ-ل", primaryMeaning = "to flee for refuge", extendedMeaning = "Fleeing for refuge.", quranUsage = "Maw'il (موئل) is refuge. 'No refuge (maw'ilan).'", notes = null),
      RootMeaningData(root = "و-أ-د", primaryMeaning = "to bury alive", extendedMeaning = "Burying alive.", quranUsage = "Wu'idat means buried. 'When the girl buried alive (wu'idat) is asked.'", notes = null),
      RootMeaningData(root = "ه-ي-ل", primaryMeaning = "to pour", extendedMeaning = "Pouring.", quranUsage = "Mahīl (مهيل) is poured. 'A heap poured (mahīlan).'", notes = null),
      RootMeaningData(root = "ه-ي-ت", primaryMeaning = "to invite", extendedMeaning = "Inviting.", quranUsage = "Hayta means come. 'Come (hayta) to you.'", notes = null),
      RootMeaningData(root = "ه-م-ر", primaryMeaning = "to pour down", extendedMeaning = "Pouring down.", quranUsage = "Munhamir (منهمر) is pouring. 'Water pouring (munhamir).'", notes = null),
      RootMeaningData(root = "ه-م-د", primaryMeaning = "to be still, extinguished", extendedMeaning = "Being still, extinguished.", quranUsage = "Hāmidah (هامدة) is lifeless. 'You see the earth lifeless (hāmidatan).'", notes = null),
      RootMeaningData(root = "ه-ش-ش", primaryMeaning = "to beat down leaves", extendedMeaning = "Beating down leaves.", quranUsage = "Ahushsha means to beat down. 'I beat down (ahushsha) leaves.'", notes = null),
      RootMeaningData(root = "ه-ز-ل", primaryMeaning = "to joke, jest", extendedMeaning = "Joking, jesting.", quranUsage = "Hazl (هزل) is jest. 'It is not a jest (hazl).'", notes = null),
      RootMeaningData(root = "ه-ر-ب", primaryMeaning = "to flee", extendedMeaning = "Fleeing.", quranUsage = "Harab (هرب) is fleeing. Related to escape.", notes = null),
      RootMeaningData(root = "ه-د-د", primaryMeaning = "to demolish, threaten", extendedMeaning = "Demolishing, threatening.", quranUsage = "Yahaddu means to collapse. 'About to collapse (yahaddu).'", notes = null),
      RootMeaningData(root = "ه-ج-ع", primaryMeaning = "to sleep at night", extendedMeaning = "Sleeping at night.", quranUsage = "Hāji'ūn (هاجعون) are sleeping. Related to night rest.", notes = null),
      RootMeaningData(root = "ه-ج-د", primaryMeaning = "to stay awake, pray at night", extendedMeaning = "Staying awake for prayer.", quranUsage = "Tahajjud (تهجد) is night prayer. 'Pray tahajjud (tahajjad).'", notes = null),
      RootMeaningData(root = "ه-ا-ء", primaryMeaning = "to give, grant", extendedMeaning = "Giving, granting.", quranUsage = "Hā' is here/take. Related to presenting.", notes = null),
      RootMeaningData(root = "ن-و-ن", primaryMeaning = "fish, letter noon", extendedMeaning = "Fish, letter noon.", quranUsage = "Nūn (نون) is fish/letter. Surah Nūn. 'Companion of the fish (nūn).'", notes = null),
      RootMeaningData(root = "ن-و-ص", primaryMeaning = "to escape, flee", extendedMeaning = "Escaping, fleeing.", quranUsage = "Manāṣ (مناص) is escape. 'No time for escape (manāṣ).'", notes = null),
      RootMeaningData(root = "ن-و-ش", primaryMeaning = "to seize, catch", extendedMeaning = "Seizing, catching.", quranUsage = "Tanāwush (تناوش) is seizing. 'How can they seize (tanāwush) from afar?'", notes = null),
      RootMeaningData(root = "ن-و-أ", primaryMeaning = "to be heavy, burden", extendedMeaning = "Being heavy, burden.", quranUsage = "Tanū'u means to burden. 'Its keys would burden (tanū'u).'", notes = null),
      RootMeaningData(root = "ن-ه-ج", primaryMeaning = "to pant, clear path", extendedMeaning = "Panting, clear path.", quranUsage = "Minhāj (منهاج) is path. 'A law and a path (minhājan).'", notes = null),
      RootMeaningData(root = "ن-م-م", primaryMeaning = "to slander, gossip", extendedMeaning = "Slandering, gossiping.", quranUsage = "Nammām (نمام) is slanderer. 'A spreader of slander (nammām).'", notes = null),
      RootMeaningData(root = "ن-م-ر-ق", primaryMeaning = "cushion", extendedMeaning = "Cushion.", quranUsage = "Namāriq (نمارق) are cushions. 'Cushions (namāriq) lined up.'", notes = null),
      RootMeaningData(root = "ن-ك-د", primaryMeaning = "to be barren, unproductive", extendedMeaning = "Being barren, unproductive.", quranUsage = "Nakidan (نكدا) is barren. 'It comes forth barren (nakidan).'", notes = null),
      RootMeaningData(root = "ن-ق-ع", primaryMeaning = "to soak, pool", extendedMeaning = "Soaking, pool.", quranUsage = "Naq' (نقع) is stirring up dust. 'Stirring up (naq'an) thereby dust.'", notes = null),
      RootMeaningData(root = "ن-ف-ي", primaryMeaning = "to banish, exile", extendedMeaning = "Banishing, exiling.", quranUsage = "Yunfaw means banished. 'Or be banished (yunfaw).'", notes = null),
      RootMeaningData(root = "ن-ف-ح", primaryMeaning = "to blow, waft", extendedMeaning = "Blowing, wafting.", quranUsage = "Nafḥah (نفحة) is breath. 'If a breath (nafḥatun) touches them.'", notes = null),
      RootMeaningData(root = "ن-ف-ث", primaryMeaning = "to blow, spit", extendedMeaning = "Blowing, spitting.", quranUsage = "Naffāthāt (نفاثات) are those who blow. 'Those who blow (naffāthāt) on knots.'", notes = null),
      RootMeaningData(root = "ن-غ-ض", primaryMeaning = "to shake head", extendedMeaning = "Shaking head.", quranUsage = "Yunghiḍūna means they shake. 'They shake (yunghiḍūna) their heads.'", notes = null),
      RootMeaningData(root = "ن-ع-ل", primaryMeaning = "sandal, shoe", extendedMeaning = "Sandal, shoe.", quranUsage = "Na'layka (نعليك) is your sandals. 'Remove your sandals (na'layk).'", notes = null),
      RootMeaningData(root = "ن-ط-ح", primaryMeaning = "to gore, butt", extendedMeaning = "Goring, butting.", quranUsage = "Naṭīḥah (نطيحة) is gored. 'That gored (naṭīḥah).'", notes = null),
      RootMeaningData(root = "ن-ض-خ", primaryMeaning = "to gush", extendedMeaning = "Gushing.", quranUsage = "Naḍḍākhatān are gushing. 'Two gushing (naḍḍākhatān) springs.'", notes = null),
      RootMeaningData(root = "ن-ض-ج", primaryMeaning = "to be cooked, ripe", extendedMeaning = "Being cooked, ripe.", quranUsage = "Naḍijat means is roasted. 'Their skins are roasted (naḍijat).'", notes = null),
      RootMeaningData(root = "ن-س-ر", primaryMeaning = "eagle, vulture", extendedMeaning = "Eagle, vulture.", quranUsage = "Nasr (نسر) is Nasr (idol). 'And Yaghūth and Ya'ūq and Nasr.'", notes = null),
      RootMeaningData(root = "ن-خ-ر", primaryMeaning = "to snort, decay", extendedMeaning = "Snorting, decaying.", quranUsage = "Nākhirah (ناخرة) is decayed. 'Decayed (nākhirah) bones.'", notes = null),
      RootMeaningData(root = "ن-ج-د", primaryMeaning = "highland, path", extendedMeaning = "Highland, path.", quranUsage = "Najdayn (نجدين) are two ways. 'The two ways (najdayn).'", notes = null),
      RootMeaningData(root = "ن-ت-ق", primaryMeaning = "to shake, raise", extendedMeaning = "Shaking, raising.", quranUsage = "Nataqnā means We raised. 'We raised (nataqnā) the mountain.'", notes = null),
      RootMeaningData(root = "ن-ب-ط", primaryMeaning = "to draw out water", extendedMeaning = "Drawing out water.", quranUsage = "Yastanbiṭūna means to extract. 'Those who extract (yastanbiṭūnahu) it.'", notes = null),
      RootMeaningData(root = "ن-ب-ز", primaryMeaning = "to call names", extendedMeaning = "Calling names.", quranUsage = "Tanābazū means call names. 'Do not call names (tanābazū).'", notes = null),
      RootMeaningData(root = "م-ي-ر", primaryMeaning = "provisions", extendedMeaning = "Provisions.", quranUsage = "Namīru means we get provisions. 'We get provisions (namīru).'", notes = null),
      RootMeaningData(root = "م-ك-و", primaryMeaning = "to whistle", extendedMeaning = "Whistling.", quranUsage = "Mukā'an (مكاء) is whistling. 'Whistling (mukā'an) and clapping.'", notes = null),
      RootMeaningData(root = "م-ع-ي", primaryMeaning = "entrails", extendedMeaning = "Entrails.", quranUsage = "Am'ā' (أمعاء) are intestines. 'Cuts up their intestines (am'ā'ahum).'", notes = null),
      RootMeaningData(root = "م-ط-و", primaryMeaning = "to stretch", extendedMeaning = "Stretching.", quranUsage = "Yatamaṭṭā means to stretch. 'Then he went to his family strutting (yatamaṭṭā).'", notes = null),
      RootMeaningData(root = "م-ش-ج", primaryMeaning = "mixed", extendedMeaning = "Mixed.", quranUsage = "Amshāj (أمشاج) is mixed. 'A drop mixed (amshāj).'", notes = null),
      RootMeaningData(root = "م-س-و", primaryMeaning = "to wipe", extendedMeaning = "Wiping.", quranUsage = "Imsaḥū means wipe. 'Wipe (imsaḥū) your heads.'", notes = null),
      RootMeaningData(root = "م-س-د", primaryMeaning = "twisted fiber", extendedMeaning = "Twisted fiber, rope.", quranUsage = "Masad (مسد) is rope. Surah Al-Masad. 'A rope (masad) of palm fiber.'", notes = null),
      RootMeaningData(root = "م-س-خ", primaryMeaning = "to transform", extendedMeaning = "Transforming.", quranUsage = "Masakhnāhum means We transformed. 'We transformed (masakhnāhum) them.'", notes = null),
      RootMeaningData(root = "م-ر-و", primaryMeaning = "flint stone", extendedMeaning = "Flint stone.", quranUsage = "Marwah (مروة) is Marwah. 'Ṣafā and Marwah.'", notes = null),
      RootMeaningData(root = "م-خ-ض", primaryMeaning = "to churn, labor", extendedMeaning = "Churning, labor pains.", quranUsage = "Makhāḍ (مخاض) is labor. 'The labor pains (makhāḍ) drove her.'", notes = null),
      RootMeaningData(root = "م-ح-ل", primaryMeaning = "to be barren, scheming", extendedMeaning = "Being barren, scheming.", quranUsage = "Maḥl (محل) is scheming. 'Severe in scheming (maḥl).'", notes = null),
      RootMeaningData(root = "م-ج-س", primaryMeaning = "Magians", extendedMeaning = "Magians.", quranUsage = "Majūs (مجوس) are Magians. 'And the Magians (majūs).'", notes = null),
      RootMeaningData(root = "ل-ي-ت", primaryMeaning = "would that", extendedMeaning = "Would that.", quranUsage = "Layta (ليت) is would that. 'Would that (layta) I had!'", notes = null),
      RootMeaningData(root = "ل-و-ذ", primaryMeaning = "to cling, take shelter", extendedMeaning = "Clinging, taking shelter.", quranUsage = "Yatalawwadhūna means slinking away. 'Slinking away (yatalawwadhūna).'", notes = null),
      RootMeaningData(root = "ل-و-ت", primaryMeaning = "Lot", extendedMeaning = "Prophet Lot.", quranUsage = "Lūṭ (لوط) is Lot. Story of Prophet Lot.", notes = null),
      RootMeaningData(root = "ل-ه-م", primaryMeaning = "to swallow, inspire", extendedMeaning = "Swallowing, inspiring.", quranUsage = "Alhamahā means He inspired it. 'He inspired it (alhamahā).'", notes = null),
      RootMeaningData(root = "ل-ق-م", primaryMeaning = "morsel", extendedMeaning = "Morsel.", quranUsage = "Luqmān (لقمان) is Luqman. Surah Luqman.", notes = null),
      RootMeaningData(root = "ل-ق-ح", primaryMeaning = "to pollinate, impregnate", extendedMeaning = "Pollinating, impregnating.", quranUsage = "Lawāqiḥ (لواقح) are fertilizing. 'Winds fertilizing (lawāqiḥ).'", notes = null),
      RootMeaningData(root = "ل-ق-ب", primaryMeaning = "nickname, title", extendedMeaning = "Nickname, title.", quranUsage = "Alqāb (ألقاب) are nicknames. 'Do not call by nicknames (alqāb).'", notes = null),
      RootMeaningData(root = "ل-ف-ح", primaryMeaning = "to burn, scorch", extendedMeaning = "Burning, scorching.", quranUsage = "Talfaḥu means to burn. 'The Fire will burn (talfaḥu) their faces.'", notes = null),
      RootMeaningData(root = "ل-ظ-ي", primaryMeaning = "blazing flame", extendedMeaning = "Blazing flame.", quranUsage = "Laẓā (لظى) is blazing fire. 'It is the Flame (laẓā).'", notes = null),
      RootMeaningData(root = "ل-ز-ب", primaryMeaning = "to stick, cling", extendedMeaning = "Sticking, clinging.", quranUsage = "Lāzib (لازب) is sticky. 'From sticky (lāzib) clay.'", notes = null),
      RootMeaningData(root = "ل-ح-ي", primaryMeaning = "beard, jawbone", extendedMeaning = "Beard, jawbone.", quranUsage = "Liḥyah (لحية) is beard. 'Do not pull my beard (liḥyatī).'", notes = null),
      RootMeaningData(root = "ل-ح-ن", primaryMeaning = "tone, dialect", extendedMeaning = "Tone, dialect.", quranUsage = "Laḥn (لحن) is tone. 'You will know them by their tone (laḥn).'", notes = null),
      RootMeaningData(root = "ل-ح-ف", primaryMeaning = "to wrap, cover", extendedMeaning = "Wrapping, covering.", quranUsage = "Ilḥāf (إلحاف) is persistence. 'They do not ask with persistence (ilḥāfan).'", notes = null),
      RootMeaningData(root = "ك-و-ي", primaryMeaning = "to brand, cauterize", extendedMeaning = "Branding, cauterizing.", quranUsage = "Tukwā means to brand. 'Their foreheads will be branded (tukwā).'", notes = null),
      RootMeaningData(root = "ك-ن-س", primaryMeaning = "to hide, retreat", extendedMeaning = "Hiding, retreating.", quranUsage = "Kunnas (كنس) are retreating. 'The retreating (kunnas) stars.'", notes = null),
      RootMeaningData(root = "ك-ن-د", primaryMeaning = "ungrateful", extendedMeaning = "Ungrateful.", quranUsage = "Kanūd (كنود) is ungrateful. 'Man is ungrateful (kanūd).'", notes = null),
      RootMeaningData(root = "ك-ل-ح", primaryMeaning = "to frown, grim", extendedMeaning = "Frowning, grim.", quranUsage = "Kāliḥūn (كالحون) are frowning. 'They will be frowning (kāliḥūn).'", notes = null),
      RootMeaningData(root = "ك-ل-أ", primaryMeaning = "to guard, pasture", extendedMeaning = "Guarding, pasture.", quranUsage = "Kala' (كلأ) is herbage. 'And herbage (kala').'", notes = null),
      RootMeaningData(root = "ك-ف-ت", primaryMeaning = "to gather, contain", extendedMeaning = "Gathering, containing.", quranUsage = "Kifāt (كفات) is container. 'A container (kifātan).'", notes = null),
      RootMeaningData(root = "ك-ف-أ", primaryMeaning = "equal, equivalent", extendedMeaning = "Equal, equivalent.", quranUsage = "Kufuwan (كفوا) is equivalent. 'None equivalent (kufuwan) to Him.'", notes = null),
      RootMeaningData(root = "ك-ش-ط", primaryMeaning = "to strip off", extendedMeaning = "Stripping off.", quranUsage = "Kushiṭat means stripped. 'When the sky is stripped (kushiṭat).'", notes = null),
      RootMeaningData(root = "ك-س-د", primaryMeaning = "to be stagnant, unsold", extendedMeaning = "Being stagnant, unsold.", quranUsage = "Takhshaw kasādahā means fearing stagnation. 'You fear will stagnate (kasādahā).'", notes = null),
      RootMeaningData(root = "ك-د-ي", primaryMeaning = "to be hard, stingy", extendedMeaning = "Being hard, stingy.", quranUsage = "Akdā means gave little. 'And gave little (akdā).'", notes = null),
      RootMeaningData(root = "ك-ث-ب", primaryMeaning = "heap, dune", extendedMeaning = "Heap, dune.", quranUsage = "Kathīb (كثيب) is sand dune. 'A heap (kathīban) poured.'", notes = null),
      RootMeaningData(root = "ك-ب-ك-ب", primaryMeaning = "to throw down", extendedMeaning = "Throwing down repeatedly.", quranUsage = "Kubkibū means thrown down. 'They will be thrown (kubkibū) into it.'", notes = null),
      RootMeaningData(root = "ك-ب-د", primaryMeaning = "liver, hardship", extendedMeaning = "Liver, hardship.", quranUsage = "Kabad (كبد) is hardship. 'In hardship (kabad).'", notes = null),
      RootMeaningData(root = "ق-و-س", primaryMeaning = "bow, arc", extendedMeaning = "Bow, arc.", quranUsage = "Qawsayn (قوسين) is two bows. 'Two bow-lengths (qawsayn).'", notes = null),
      RootMeaningData(root = "ق-و-ب", primaryMeaning = "hollow, shell", extendedMeaning = "Hollow, shell.", quranUsage = "Qiṭmīr (قطمير) is shell. Related to thin covering.", notes = null),
      RootMeaningData(root = "ق-ن-ي", primaryMeaning = "to acquire, possess", extendedMeaning = "Acquiring, possessing.", quranUsage = "Aqnā means He enriched. 'He enriched (aqnā) and gave property.'", notes = null),
      RootMeaningData(root = "ق-ن-و", primaryMeaning = "to acquire, date-stalks", extendedMeaning = "Acquiring, date-stalks.", quranUsage = "Qinwān (قنوان) are date-stalks. 'Clusters (qinwān) of dates.'", notes = null),
      RootMeaningData(root = "ق-م-ع", primaryMeaning = "to suppress, subdue", extendedMeaning = "Suppressing, subduing.", quranUsage = "Maqāmi' (مقامع) are hammers. 'Hammers (maqāmi') of iron.'", notes = null),
      RootMeaningData(root = "ق-م-ط-ر", primaryMeaning = "frowning, dusty", extendedMeaning = "Frowning, dusty.", quranUsage = "Qamṭarīr (قمطرير) is distressful. 'A distressful (qamṭarīran) day.'", notes = null),
      RootMeaningData(root = "ق-م-ح", primaryMeaning = "wheat, raise head", extendedMeaning = "Wheat, raising head.", quranUsage = "Muqmaḥūn means raised heads. 'Heads raised (muqmaḥūn).'", notes = null),
      RootMeaningData(root = "ق-ل-ع", primaryMeaning = "to uproot, remove", extendedMeaning = "Uprooting, removing.", quranUsage = "Aqla'at means removed. 'When the sky clears (aqla'at).' Related to clearing.", notes = null),
      RootMeaningData(root = "ق-ط-م-ر", primaryMeaning = "thin membrane", extendedMeaning = "Thin membrane.", quranUsage = "Qiṭmīr (قطمير) is date-stone membrane. 'Not even a membrane (qiṭmīran).'", notes = null),
      RootMeaningData(root = "ق-ط-ط", primaryMeaning = "to cut, drop", extendedMeaning = "Cutting, dropping.", quranUsage = "Taquṭṭu means to drop. Related to cutting off.", notes = null),
      RootMeaningData(root = "ق-ض-ض", primaryMeaning = "to break, crumble", extendedMeaning = "Breaking, crumbling.", quranUsage = "Inqaḍḍa means to collapse. 'About to collapse (yanqaḍḍ).'", notes = null),
      RootMeaningData(root = "ق-ض-ب", primaryMeaning = "fodder, cut", extendedMeaning = "Fodder, cut.", quranUsage = "Qaḍb (قضب) is fodder. 'And fodder (qaḍban).'", notes = null),
      RootMeaningData(root = "ق-ص-م", primaryMeaning = "to break, destroy", extendedMeaning = "Breaking, destroying.", quranUsage = "Qaṣamnā means We destroyed. 'How many We destroyed (qaṣamnā).'", notes = null),
      RootMeaningData(root = "ق-ص-ف", primaryMeaning = "to break off", extendedMeaning = "Breaking off.", quranUsage = "Qāṣif (قاصف) is breaking. 'A breaking (qāṣifan) wind.'", notes = null),
      RootMeaningData(root = "ق-ش-ع-ر", primaryMeaning = "to shudder", extendedMeaning = "Shuddering.", quranUsage = "Taqsha'irru means to shudder. 'Their skins shudder (taqsha'irru).'", notes = null),
      RootMeaningData(root = "ق-س-س", primaryMeaning = "priest", extendedMeaning = "Priest.", quranUsage = "Qissīsīn (قسيسين) are priests. 'Priests (qissīsīna) and monks.'", notes = null),
      RootMeaningData(root = "ق-س-ر", primaryMeaning = "to compel, force", extendedMeaning = "Compelling, forcing.", quranUsage = "Qaswarah (قسورة) is lion/hunters. 'Fleeing from a lion (qaswarah).'", notes = null),
      RootMeaningData(root = "ق-ر-ش", primaryMeaning = "Quraysh", extendedMeaning = "Quraysh tribe.", quranUsage = "Quraysh (قريش) is Quraysh. Surah Quraysh. 'For the accustomed security of Quraysh.'", notes = null),
      RootMeaningData(root = "ق-د-ح", primaryMeaning = "to strike fire, cup", extendedMeaning = "Striking fire, cup.", quranUsage = "Qadaḥ (قدح) is cup. Qādihāt: strike fire. 'Those that strike sparks (qādihāt).'", notes = null),
      RootMeaningData(root = "ق-ث-أ", primaryMeaning = "cucumber", extendedMeaning = "Cucumber.", quranUsage = "Qithā' (قثاء) is cucumber. 'Its cucumbers (qithā'ihā).'", notes = null)
    )
